...
var App = function(props) {
	...
	haxe_Log.trace(Reflect.fields(this.state),{ fileName : "src/App.hx", lineNumber : 174, className : "App", methodName : "new"});
	haxe_Log.trace(App.config,{ fileName : "src/App.hx", lineNumber : 175, className : "App", methodName : "new"});
	haxe_Log.trace(App.devIP,{ fileName : "src/App.hx", lineNumber : 176, className : "App", methodName : "new"});
	...
	haxe_Log.trace(this.state.userState,{ fileName : "src/App.hx", lineNumber : 199, className : "App", methodName : "new"});
	if(!(this.state.userState.dbUser.id == null || this.state.userState.dbUser.jwt == "")) {
		var p = this.load();
		p.then(function(dbData) {
			haxe_Log.trace(haxe_ds_StringMap.keysIterator(dbData.dataErrors.h).hasNext(),{ fileName : "src/App.hx", lineNumber : 205, className : "App", methodName : "new"});
...
App.startHistoryListener = function(store,history) {
	...
	return history.listen(function(location,action) {
		haxe_Log.trace(location.pathname,{ fileName : "src/App.hx", lineNumber : 158, className : "App", methodName : "startHistoryListener"});
		store.dispatch(redux_Action.map(action_AppAction.Status(action_StatusAction.Update({ path : location.pathname}))));
...
App.prototype = $extend(React_Component.prototype,{
	...
	,initStore: function(history) {
		...
		haxe_Log.trace(Reflect.fields(userStore),{ fileName : "src/App.hx", lineNumber : 95, className : "App", methodName : "initStore"});
		...
		haxe_Log.trace(rootReducer,{ fileName : "src/App.hx", lineNumber : 110, className : "App", methodName : "initStore"});
	...
	,loadFromLocalStorage: function() {
		try {
			...
			haxe_Log.trace(e,{ fileName : "src/App.hx", lineNumber : 129, className : "App", methodName : "loadFromLocalStorage"});
			return { };
		}
	}
	,saveToLocalStorage: function() {
		try {
			...
			var e = haxe_Exception.caught(_g).unwrap();
			haxe_Log.trace(e,{ fileName : "src/App.hx", lineNumber : 141, className : "App", methodName : "saveToLocalStorage"});
		}
	}
	,load: function() {
	...
	,render: function() {
		haxe_Log.trace(this.state.userState,{ fileName : "src/App.hx", lineNumber : 273, className : "App", methodName : "render"});
...
var action_LocationAction = $hxEnums["action.LocationAction"] = { __ename__ : "action.LocationAction", __constructs__ : ["Pop","Push","Replace","Go","Back","Forward","InitHistory","LocationChange"]
	,Pop: ($_=function(url,state) { return {_hx_index:0,url:url,state:state,__enum__:"action.LocationAction",toString:$estr}; },$_.__params__ = ["url","state"],$_)
	,Push: ($_=function(url,state) { return {_hx_index:1,url:url,state:state,__enum__:"action.LocationAction",toString:$estr}; },$_.__params__ = ["url","state"],$_)
	,Replace: ($_=function(url,state) { return {_hx_index:2,url:url,state:state,__enum__:"action.LocationAction",toString:$estr}; },$_.__params__ = ["url","state"],$_)
	,Go: ($_=function(to) { return {_hx_index:3,to:to,__enum__:"action.LocationAction",toString:$estr}; },$_.__params__ = ["to"],$_)
	,Back: {_hx_index:4,__enum__:"action.LocationAction",toString:$estr}
	,Forward: {_hx_index:5,__enum__:"action.LocationAction",toString:$estr}
	,InitHistory: ($_=function(history) { return {_hx_index:6,history:history,__enum__:"action.LocationAction",toString:$estr}; },$_.__params__ = ["history"],$_)
	,LocationChange: ($_=function(location) { return {_hx_index:7,location:location,__enum__:"action.LocationAction",toString:$estr}; },$_.__params__ = ["location"],$_)
};
...
var action_UserAction = $hxEnums["action.UserAction"] = { __ename__ : "action.UserAction", __constructs__ : ["LoginChange","LoginComplete","LoginError","LoginExpired","LogOut","LogOutComplete","LoginRequired"]
	...
	,LoginExpired: ($_=function(state) { return {_hx_index:3,state:state,__enum__:"action.UserAction",toString:$estr}; },$_.__params__ = ["state"],$_)
	,LogOut: ($_=function(state) { return {_hx_index:4,state:state,__enum__:"action.UserAction",toString:$estr}; },$_.__params__ = ["state"],$_)
	,LogOutComplete: ($_=function(state) { return {_hx_index:5,state:state,__enum__:"action.UserAction",toString:$estr}; },$_.__params__ = ["state"],$_)
	,LoginRequired: ($_=function(state) { return {_hx_index:6,state:state,__enum__:"action.UserAction",toString:$estr}; },$_.__params__ = ["state"],$_)
};
...
action_async_CRUD.read = function(param) {
	return redux_thunk_Thunk.Action(function(dispatch,getState) {
		haxe_Log.trace(param,{ fileName : "src/action/async/CRUD.hx", lineNumber : 44, className : "action.async.CRUD", methodName : "read"});
		return new Promise(function(resolve,reject) {
			if(!param.dbUser.online) {
				...
				haxe_Log.trace("LoginError",{ fileName : "src/action/async/CRUD.hx", lineNumber : 53, className : "action.async.CRUD", methodName : "read"});
			...
			var bl = loader_BinaryLoader.dbQuery("" + Std.string(App.config.api),param,function(data) {
				haxe_Log.trace(data.dataInfo == null ? "null" : haxe_ds_StringMap.stringify(data.dataInfo.h),{ fileName : "src/action/async/CRUD.hx", lineNumber : 62, className : "action.async.CRUD", methodName : "read"});
				haxe_Log.trace(data.dataRows.length,{ fileName : "src/action/async/CRUD.hx", lineNumber : 63, className : "action.async.CRUD", methodName : "read"});
				if(data.dataRows.length > 0) {
					if(!haxe_ds_StringMap.keysIterator(data.dataErrors.h).hasNext()) {
						var tmp = data.dataRows[0];
						haxe_Log.trace(tmp == null ? "null" : haxe_ds_StringMap.stringify(tmp.h),{ fileName : "src/action/async/CRUD.hx", lineNumber : 68, className : "action.async.CRUD", methodName : "read"});
						...
						dispatch(redux_Action.map(action_AppAction.Status(action_StatusAction.Update({ cssClass : "error", text : "" + data.dataErrors.h[param.action]}))));
						resolve(data);
					}
				} else {
					dispatch(redux_Action.map(action_AppAction.Status(action_StatusAction.Update({ cssClass : "warn", text : "Keine Daten für " + Std.string(param.filter.toString()) + " gefunden"}))));
				}
			});
		});
	});
...
action_async_CRUD.update = function(param) {
	haxe_Log.trace(param.action,{ fileName : "src/action/async/CRUD.hx", lineNumber : 100, className : "action.async.CRUD", methodName : "update"});
	return redux_thunk_Thunk.Action(function(dispatch,getState) {
		haxe_Log.trace(param,{ fileName : "src/action/async/CRUD.hx", lineNumber : 102, className : "action.async.CRUD", methodName : "update"});
		var dbData = shared_DbDataTools.create();
		return new Promise(function(resolve,reject) {
			if(!param.dbUser.online) {
				dispatch(redux_Action.map(action_AppAction.User(action_UserAction.LoginError({ dbUser : param.dbUser, lastError : "Du musst dich neu anmelden!"}))));
				haxe_Log.trace("LoginError",{ fileName : "src/action/async/CRUD.hx", lineNumber : 116, className : "action.async.CRUD", methodName : "update"});
				resolve(null);
			}
			var bL = loader_BinaryLoader.dbQuery("" + Std.string(App.config.api),param,function(data) {
				haxe_Log.trace(data,{ fileName : "src/action/async/CRUD.hx", lineNumber : 125, className : "action.async.CRUD", methodName : "update"});
				if(data.dataErrors != null) {
					haxe_Log.trace(data.dataErrors == null ? "null" : haxe_ds_StringMap.stringify(data.dataErrors.h),{ fileName : "src/action/async/CRUD.hx", lineNumber : 127, className : "action.async.CRUD", methodName : "update"});
				}
				if(data.dataInfo != null && Object.prototype.hasOwnProperty.call(data.dataInfo.h,"dataSource")) {
					haxe_Log.trace(new haxe_Unserializer(data.dataInfo.h["dataSource"]).unserialize(),{ fileName : "src/action/async/CRUD.hx", lineNumber : 129, className : "action.async.CRUD", methodName : "update"});
				}
			...
			haxe_Log.trace(bL,{ fileName : "src/action/async/CRUD.hx", lineNumber : 147, className : "action.async.CRUD", methodName : "update"});
		});
	});
};
...
action_async_LiveDataAccess.select = function(props) {
	return redux_thunk_Thunk.Action(function(dispatch,getState) {
		...
		case "Contacts":
			...
			sData = action_async_LiveDataAccess.selectType(props.id,props.data,sData,props.selectType);
			haxe_Log.trace("" + tableRoot[2] + "/" + view_shared_io_FormApi.params(shared_Utils.keysList(sData.keys())),{ fileName : "src/action/async/LiveDataAccess.hx", lineNumber : 87, className : "action.async.LiveDataAccess", methodName : "select"});
			haxe_Log.trace(sData,{ fileName : "src/action/async/LiveDataAccess.hx", lineNumber : 88, className : "action.async.LiveDataAccess", methodName : "select"});
			var aState1 = aState.locationStore.history;
			var tmp = "" + tableRoot[2] + "#" + view_shared_io_FormApi.params(shared_Utils.keysList(sData.keys()));
		...
		case "Deals":
			...
			sData = action_async_LiveDataAccess.selectType(props.id,props.data,sData,props.selectType);
			haxe_Log.trace(sData,{ fileName : "src/action/async/LiveDataAccess.hx", lineNumber : 97, className : "action.async.LiveDataAccess", methodName : "select"});
			haxe_Log.trace("" + tableRoot[2] + "/" + view_shared_io_FormApi.params(shared_Utils.keysList(sData.keys())),{ fileName : "src/action/async/LiveDataAccess.hx", lineNumber : 98, className : "action.async.LiveDataAccess", methodName : "select"});
			var aState1 = aState.locationStore.history;
			var tmp = "" + tableRoot[2] + "#" + view_shared_io_FormApi.params(shared_Utils.keysList(sData.keys()));
			var tmp1 = "" + tableRoot[2] + "#" + view_shared_io_FormApi.params(shared_Utils.keysList(sData.keys()));
			aState1.push(tmp,{ activeContactUrl : tmp1});
...
action_async_LiveDataAccess.selectType = function(id,data,sData,sT) {
	...
	case "UnselectAll":
		...
		return sData;
	default:
		haxe_Log.trace(data,{ fileName : "src/action/async/LiveDataAccess.hx", lineNumber : 126, className : "action.async.LiveDataAccess", methodName : "selectType"});
		sData = new haxe_ds_IntMap();
		sData.h[id] = data.h[id];
		return sData;
	}
...
action_async_LivePBXSync.syncAll = function(props) {
	haxe_Log.trace("" + props.table + " " + props.maxImport + " " + props.limit + " " + props.offset,{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 41, className : "action.async.LivePBXSync", methodName : "syncAll"});
	return redux_Action.map(redux_thunk_Thunk.Action(function(dispatch,getState) {
		var aState = getState();
		haxe_Log.trace(props.offset,{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 44, className : "action.async.LivePBXSync", methodName : "syncAll"});
		if(!props.userState.dbUser.online) {
			return dispatch(redux_Action.map(action_AppAction.User(action_UserAction.LoginError({ dbUser : props.userState.dbUser, lastError : "Du musst dich neu anmelden!"}))));
		}
		haxe_Log.trace("creating BinaryLoader " + Std.string(App.config.api),{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 55, className : "action.async.LivePBXSync", methodName : "syncAll"});
		var bl = loader_BinaryLoader.dbQuery("" + Std.string(App.config.api),{ dbUser : props.userState.dbUser, classPath : props.classPath, action : props.action, extDB : true, limit : props.limit, offset : props.offset, table : props.table, filter : props.filter, maxImport : props.maxImport == null ? 1000 : props.maxImport, devIP : App.devIP},function(data) {
			haxe_Log.trace(data.dataInfo == null ? "null" : haxe_ds_StringMap.stringify(data.dataInfo.h),{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 72, className : "action.async.LivePBXSync", methodName : "syncAll"});
			haxe_Log.trace(data.dataRows.length,{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 73, className : "action.async.LivePBXSync", methodName : "syncAll"});
			if(haxe_ds_StringMap.keysIterator(data.dataErrors.h).hasNext()) {
			...
			haxe_Log.trace(data.dataInfo == null ? "null" : haxe_ds_StringMap.stringify(data.dataInfo.h),{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 84, className : "action.async.LivePBXSync", methodName : "syncAll"});
			...
			haxe_Log.trace("" + props.offset + " < " + props.maxImport,{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 101, className : "action.async.LivePBXSync", methodName : "syncAll"});
			if(props.offset < props.maxImport) {
				haxe_Log.trace("next loop:" + Std.string(props),{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 104, className : "action.async.LivePBXSync", methodName : "syncAll"});
				dispatch(action_async_LivePBXSync.syncAll(props));
				return;
			}
		});
		return null;
...
action_async_LivePBXSync.importBookingRequests = function(props) {
	return redux_thunk_Thunk.Action(function(dispatch,getState) {
		var aState = getState();
		haxe_Log.trace(props.offset,{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 119, className : "action.async.LivePBXSync", methodName : "importBookingRequests"});
		if(!props.userState.dbUser.online) {
			return dispatch(redux_Action.map(action_AppAction.User(action_UserAction.LoginError({ dbUser : props.userState.dbUser, lastError : "Du musst dich neu anmelden!"}))));
		}
		haxe_Log.trace("creating BinaryLoader " + Std.string(App.config.api),{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 128, className : "action.async.LivePBXSync", methodName : "importBookingRequests"});
		var bl = loader_BinaryLoader.create("" + Std.string(App.config.api),{ id : props.userState.dbUser.id, jwt : props.userState.dbUser.jwt, classPath : props.classPath, action : props.action, extDB : true, limit : props.limit, offset : props.offset, filter : props.filter, firstBatch : props.offset == 0, maxImport : props.maxImport == null ? 1000 : props.maxImport, devIP : App.devIP},function(data) {
			haxe_Log.trace(data,{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 146, className : "action.async.LivePBXSync", methodName : "importBookingRequests"});
			haxe_Log.trace(data.dataRows.length,{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 147, className : "action.async.LivePBXSync", methodName : "importBookingRequests"});
			if(haxe_ds_StringMap.keysIterator(data.dataErrors.h).hasNext()) {
				dispatch(redux_Action.map(action_AppAction.Status(action_StatusAction.Update({ cssClass : "error", text : haxe_ds_StringMap.valueIterator(data.dataErrors.h).next()}))));
				return;
			}
			haxe_Log.trace(data.dataInfo == null ? "null" : haxe_ds_StringMap.stringify(data.dataInfo.h),{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 157, className : "action.async.LivePBXSync", methodName : "importBookingRequests"});
			if(data.dataInfo.h["offset"] == null) {
			...
			haxe_Log.trace("" + props.offset + " < " + props.maxImport,{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 174, className : "action.async.LivePBXSync", methodName : "importBookingRequests"});
			if(props.offset < props.maxImport) {
				haxe_Log.trace("next loop:" + Std.string(props),{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 177, className : "action.async.LivePBXSync", methodName : "importBookingRequests"});
				dispatch(action_async_LivePBXSync.syncAll(props));
				return;
			}
		});
...
action_async_LivePBXSync.mergeContacts = function(props) {
	haxe_Log.trace("" + props.maxImport + " " + props.limit + " " + props.offset,{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 191, className : "action.async.LivePBXSync", methodName : "mergeContacts"});
	return redux_thunk_Thunk.Action(function(dispatch,getState) {
		var aState = getState();
		haxe_Log.trace(props,{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 194, className : "action.async.LivePBXSync", methodName : "mergeContacts"});
		if(!props.userState.dbUser.online) {
			return dispatch(redux_Action.map(action_AppAction.User(action_UserAction.LoginError({ dbUser : props.userState.dbUser, lastError : "Du musst dich neu anmelden!"}))));
		}
		haxe_Log.trace("creating BinaryLoader " + Std.string(App.config.api),{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 203, className : "action.async.LivePBXSync", methodName : "mergeContacts"});
		var bl = loader_BinaryLoader.create("" + Std.string(App.config.api),{ dbUser : props.userState.dbUser, id : props.userState.dbUser.id, jwt : props.userState.dbUser.jwt, classPath : props.classPath, action : props.action, extDB : true, limit : props.limit, offset : props.offset, filter : props.filter, firstBatch : props.offset == 0, maxImport : props.maxImport == null ? 1000 : props.maxImport, devIP : App.devIP},function(data) {
			haxe_Log.trace(data,{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 222, className : "action.async.LivePBXSync", methodName : "mergeContacts"});
			haxe_Log.trace(data.dataRows.length,{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 223, className : "action.async.LivePBXSync", methodName : "mergeContacts"});
			if(haxe_ds_StringMap.keysIterator(data.dataErrors.h).hasNext()) {
				dispatch(redux_Action.map(action_AppAction.Status(action_StatusAction.Update({ cssClass : "error", text : haxe_ds_StringMap.valueIterator(data.dataErrors.h).next()}))));
				return;
			}
			haxe_Log.trace(data.dataInfo == null ? "null" : haxe_ds_StringMap.stringify(data.dataInfo.h),{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 233, className : "action.async.LivePBXSync", methodName : "mergeContacts"});
			if(data.dataInfo.h["offset"] == null) {
			...
			haxe_Log.trace("" + props.offset + " < " + props.maxImport,{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 250, className : "action.async.LivePBXSync", methodName : "mergeContacts"});
			if(props.offset < props.maxImport) {
				haxe_Log.trace("next loop:" + Std.string(props),{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 253, className : "action.async.LivePBXSync", methodName : "mergeContacts"});
				dispatch(action_async_LivePBXSync.syncAll(props));
				return;
			}
		});
...
action_async_LivePBXSync.importAll = function(props) {
	haxe_Log.trace("" + props.table + " " + props.maxImport + " " + props.limit + " " + props.offset,{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 267, className : "action.async.LivePBXSync", methodName : "importAll"});
	return redux_Action.map(redux_thunk_Thunk.Action(function(dispatch,getState) {
		var aState = getState();
		haxe_Log.trace(props.offset,{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 270, className : "action.async.LivePBXSync", methodName : "importAll"});
		if(!props.userState.dbUser.online) {
			return dispatch(redux_Action.map(action_AppAction.User(action_UserAction.LoginError({ dbUser : props.userState.dbUser, lastError : "Du musst dich neu anmelden!"}))));
		}
		haxe_Log.trace("creating BinaryLoader " + Std.string(App.config.api),{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 281, className : "action.async.LivePBXSync", methodName : "importAll"});
		var bl = loader_BinaryLoader.dbQuery("" + Std.string(App.config.api),{ dbUser : props.userState.dbUser, classPath : props.classPath, action : props.action, extDB : true, limit : props.limit, offset : props.offset, onlyNew : props.onlyNew, table : props.table, filter : props.filter, maxImport : props.maxImport == null ? 1000 : props.maxImport, devIP : App.devIP},function(data) {
			haxe_Log.trace(data.dataInfo == null ? "null" : haxe_ds_StringMap.stringify(data.dataInfo.h),{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 299, className : "action.async.LivePBXSync", methodName : "importAll"});
			if(haxe_ds_StringMap.keysIterator(data.dataErrors.h).hasNext()) {
				dispatch(redux_Action.map(action_AppAction.Status(action_StatusAction.Update({ cssClass : "error", text : haxe_ds_StringMap.valueIterator(data.dataErrors.h).next()}))));
				return;
			}
			haxe_Log.trace(data.dataInfo == null ? "null" : haxe_ds_StringMap.stringify(data.dataInfo.h),{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 310, className : "action.async.LivePBXSync", methodName : "importAll"});
			...
			haxe_Log.trace("got:" + Std.parseInt(666),{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 319, className : "action.async.LivePBXSync", methodName : "importAll"});
			...
			if(data.dataInfo.h["got"] > 0) {
				...
				haxe_Log.trace("next loop:" + Std.string(props),{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 339, className : "action.async.LivePBXSync", methodName : "importAll"});
				dispatch(action_async_LivePBXSync.importAll(props));
				return;
			}
			haxe_Log.trace(data.dataInfo.h["got"] > 0 && data.dataInfo.h["last_import_cid"] != data.dataInfo.h["max_client_id"] ? "loop" : "no",{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 342, className : "action.async.LivePBXSync", methodName : "importAll"});
		});
		return null;
	}));
};
action_async_LivePBXSync.importDeals = function(props) {
	haxe_Log.trace("" + props.maxImport + " " + props.limit + " " + props.offset,{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 353, className : "action.async.LivePBXSync", methodName : "importDeals"});
	return redux_thunk_Thunk.Action(function(dispatch,getState) {
		var aState = getState();
		haxe_Log.trace(props,{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 356, className : "action.async.LivePBXSync", methodName : "importDeals"});
		if(!props.userState.dbUser.online) {
			return dispatch(redux_Action.map(action_AppAction.User(action_UserAction.LoginError({ dbUser : props.userState.dbUser, lastError : "Du musst dich neu anmelden!"}))));
		}
		haxe_Log.trace("creating BinaryLoader " + Std.string(App.config.api),{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 365, className : "action.async.LivePBXSync", methodName : "importDeals"});
		var bl = loader_BinaryLoader.create("" + Std.string(App.config.api),{ dbUser : props.userState.dbUser, id : props.userState.dbUser.id, jwt : props.userState.dbUser.jwt, classPath : props.classPath, action : props.action, extDB : true, limit : props.limit, offset : props.offset, onlyNew : props.onlyNew, filter : props.filter, firstBatch : props.offset == 0, maxImport : props.maxImport == null ? 1000 : props.maxImport, devIP : App.devIP},function(data) {
			...
			haxe_Log.trace(data.dataInfo == null ? "null" : haxe_ds_StringMap.stringify(data.dataInfo.h),{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 396, className : "action.async.LivePBXSync", methodName : "importDeals"});
			if(data.dataInfo.h["missing"] > 0 && data.dataInfo.h["got"] != data.dataInfo.h["missing"]) {
				dispatch(redux_Action.map(action_AppAction.Status(action_StatusAction.Update({ cssClass : "error", text : "Fehler " + Std.string(data.dataInfo.h["got"]) + " von " + Std.string(data.dataInfo.h["missing"]) + " Aktualisiert"}))));
				return;
			}
			haxe_Log.trace("got:" + Std.parseInt(666),{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 405, className : "action.async.LivePBXSync", methodName : "importDeals"});
			if(data.dataInfo.h["got"] > 0 && data.dataInfo.h["last_import_cid"] == data.dataInfo.h["max_client_id"]) {
				dispatch(redux_Action.map(action_AppAction.Status(action_StatusAction.Update({ cssClass : " ", text : "" + Std.string(data.dataInfo.h["got"]) + " von " + Std.string(data.dataInfo.h["missing"]) + " aktualisiert"}))));
				return;
			}
			if(data.dataInfo.h["got"] > 0) {
				...
				haxe_Log.trace("next loop:" + Std.string(props),{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 425, className : "action.async.LivePBXSync", methodName : "importDeals"});
				dispatch(action_async_LivePBXSync.importAll(props));
				return;
			}
			haxe_Log.trace(data.dataInfo.h["got"] > 0 && data.dataInfo.h["last_import_cid"] != data.dataInfo.h["max_client_id"] ? "loop" : "no",{ fileName : "src/action/async/LivePBXSync.hx", lineNumber : 428, className : "action.async.LivePBXSync", methodName : "importDeals"});
		});
		return null;
	});
};
...
action_async_UserAccess.changePassword = function(userState) {
	haxe_Log.trace(userState,{ fileName : "src/action/async/UserAccess.hx", lineNumber : 32, className : "action.async.UserAccess", methodName : "changePassword"});
	return redux_thunk_Thunk.Action(function(dispatch,getState) {
		...
		var aState = getState();
		haxe_Log.trace("" + aState.locationStore.redirectAfterLogin,{ fileName : "src/action/async/UserAccess.hx", lineNumber : 40, className : "action.async.UserAccess", methodName : "changePassword"});
		loader_BinaryLoader.create("" + Std.string(App.config.api),{ id : userState.dbUser.id, jwt : userState.dbUser.jwt, classPath : "auth.User", action : "changePassword", new_pass : userState.dbUser.new_pass, original_path : aState.locationStore.redirectAfterLogin, password : userState.dbUser.password, user_name : userState.dbUser.user_name, devIP : App.devIP},function(data) {
			haxe_Log.trace(Reflect.fields(data),{ fileName : "src/action/async/UserAccess.hx", lineNumber : 57, className : "action.async.UserAccess", methodName : "changePassword"});
			haxe_Log.trace(data,{ fileName : "src/action/async/UserAccess.hx", lineNumber : 58, className : "action.async.UserAccess", methodName : "changePassword"});
			if(haxe_ds_StringMap.keysIterator(data.dataErrors.h).hasNext()) {
				haxe_Log.trace(haxe_ds_StringMap.stringify(data.dataErrors.h),{ fileName : "src/action/async/UserAccess.hx", lineNumber : 61, className : "action.async.UserAccess", methodName : "changePassword"});
				var tmp = haxe_ds_StringMap.valueIterator(data.dataErrors.h);
				userState.lastError = tmp.next();
			...
			if(data.dataInfo.h["online"]) {
				haxe_Log.trace(aState.userState,{ fileName : "src/action/async/UserAccess.hx", lineNumber : 72, className : "action.async.UserAccess", methodName : "changePassword"});
				...
				haxe_Log.trace(data.dataErrors == null ? "null" : haxe_ds_StringMap.stringify(data.dataErrors.h),{ fileName : "src/action/async/UserAccess.hx", lineNumber : 87, className : "action.async.UserAccess", methodName : "changePassword"});
			}
		});
		return null;
	});
...
action_async_UserAccess.resetPassword = function(userState) {
	return redux_thunk_Thunk.Action(function(dispatch,getState) {
		...
		haxe_Log.trace(Reflect.fields(appState),{ fileName : "src/action/async/UserAccess.hx", lineNumber : 103, className : "action.async.UserAccess", methodName : "resetPassword"});
		haxe_Log.trace("" + appState.locationStore.redirectAfterLogin,{ fileName : "src/action/async/UserAccess.hx", lineNumber : 104, className : "action.async.UserAccess", methodName : "resetPassword"});
		loader_BinaryLoader.create("" + Std.string(App.config.api),{ user_name : userState.dbUser.user_name, mandator : userState.dbUser.mandator, classPath : "auth.User", action : "resetPassword", original_path : appState.locationStore.redirectAfterLogin, devIP : App.devIP},function(data) {
			haxe_Log.trace(Reflect.fields(data),{ fileName : "src/action/async/UserAccess.hx", lineNumber : 118, className : "action.async.UserAccess", methodName : "resetPassword"});
			haxe_Log.trace(data,{ fileName : "src/action/async/UserAccess.hx", lineNumber : 119, className : "action.async.UserAccess", methodName : "resetPassword"});
			if(haxe_ds_StringMap.keysIterator(data.dataErrors.h).hasNext()) {
				haxe_Log.trace(haxe_ds_StringMap.stringify(data.dataErrors.h),{ fileName : "src/action/async/UserAccess.hx", lineNumber : 122, className : "action.async.UserAccess", methodName : "resetPassword"});
			...
			if(data.dataInfo.h["resetPassword"] == "OK") {
				haxe_Log.trace(appState.userState.dbUser,{ fileName : "src/action/async/UserAccess.hx", lineNumber : 127, className : "action.async.UserAccess", methodName : "resetPassword"});
				...
				haxe_Log.trace(data.dataErrors == null ? "null" : haxe_ds_StringMap.stringify(data.dataErrors.h),{ fileName : "src/action/async/UserAccess.hx", lineNumber : 133, className : "action.async.UserAccess", methodName : "resetPassword"});
			}
		});
		return null;
	});
...
action_async_UserAccess.jwtCheck = function(data) {
	if(haxe_ds_StringMap.keysIterator(data.dataErrors.h).hasNext()) {
		return redux_thunk_Thunk.Action(function(dispatch,getState) {
			haxe_Log.trace(data.dataErrors == null ? "null" : haxe_ds_StringMap.stringify(data.dataErrors.h),{ fileName : "src/action/async/UserAccess.hx", lineNumber : 146, className : "action.async.UserAccess", methodName : "jwtCheck"});
...
action_async_UserAccess.doLogin = function(userState,requests) {
	return redux_thunk_Thunk.Action(function(dispatch,getState) {
		...
		haxe_Log.trace(userState,{ fileName : "src/action/async/UserAccess.hx", lineNumber : 159, className : "action.async.UserAccess", methodName : "doLogin"});
		...
		haxe_Log.trace(App.maxLoginAttempts,{ fileName : "src/action/async/UserAccess.hx", lineNumber : 164, className : "action.async.UserAccess", methodName : "doLogin"});
		var bL = null;
		...
		if(App.maxLoginAttempts-- > 0) {
			...
			bL = loader_BinaryLoader.dbQuery(bL1,{ dbUser : userState1, classPath : "auth.User", action : bL2, relations : _g, devIP : App.devIP},function(data) {
				haxe_Log.trace(data,{ fileName : "src/action/async/UserAccess.hx", lineNumber : 190, className : "action.async.UserAccess", methodName : "doLogin"});
				if(haxe_ds_StringMap.keysIterator(data.dataErrors.h).hasNext()) {
					if(App.maxLoginAttempts-- > 0) {
				...
				haxe_Log.trace(db_DbUser,{ fileName : "src/action/async/UserAccess.hx", lineNumber : 196, className : "action.async.UserAccess", methodName : "doLogin"});
				...
				while(_g.hasNext()) {
					...
					var k = _g1.key;
					var v = _g1.value;
					haxe_Log.trace("" + k + " => " + Std.string(v),{ fileName : "src/action/async/UserAccess.hx", lineNumber : 201, className : "action.async.UserAccess", methodName : "doLogin"});
					switch(k) {
				...
				haxe_Log.trace(js_Cookie.get("userState.dbUserState.dbUser.jwt"),{ fileName : "src/action/async/UserAccess.hx", lineNumber : 219, className : "action.async.UserAccess", methodName : "doLogin"});
				userState.dbUser.online = true;
				haxe_Log.trace(userState,{ fileName : "src/action/async/UserAccess.hx", lineNumber : 223, className : "action.async.UserAccess", methodName : "doLogin"});
...
action_async_UserAccess.loginReq = function(userState,requests) {
	return redux_thunk_Thunk.Action(function(dispatch,getState) {
		haxe_Log.trace(userState,{ fileName : "src/action/async/UserAccess.hx", lineNumber : 239, className : "action.async.UserAccess", methodName : "loginReq"});
		haxe_Log.trace(getState().userState.dbUser,{ fileName : "src/action/async/UserAccess.hx", lineNumber : 240, className : "action.async.UserAccess", methodName : "loginReq"});
...
action_async_UserAccess.logOut = function() {
	return redux_thunk_Thunk.Action(function(dispatch,getState) {
		haxe_Log.trace(getState().userState,{ fileName : "src/action/async/UserAccess.hx", lineNumber : 254, className : "action.async.UserAccess", methodName : "logOut"});
		...
		var userState1 = userState.dbUser;
		var _g = new haxe_ds_StringMap();
		var value = new db_DbRelation({ filter : { id : userState.dbUser.id}});
		_g.h["users"] = value;
		bL = loader_BinaryLoader.dbQuery(bL1,{ classPath : "auth.User", action : "logout", dbUser : userState1, relations : _g, devIP : App.devIP},function(data) {
			if(haxe_ds_StringMap.keysIterator(data.dataErrors.h).hasNext()) {
				haxe_Log.trace(data.dataErrors == null ? "null" : haxe_ds_StringMap.stringify(data.dataErrors.h),{ fileName : "src/action/async/UserAccess.hx", lineNumber : 275, className : "action.async.UserAccess", methodName : "logOut"});
				return;
			} else {
				userState.dbUser.online = false;
				js_Cookie.set("userState.dbUser.jwt","",31556926);
				js_Cookie.set("userState.dbUser.id",null,null,"/");
				haxe_Log.trace(js_Cookie.get("userState.dbUserState.dbUser.jwt"),{ fileName : "src/action/async/UserAccess.hx", lineNumber : 283, className : "action.async.UserAccess", methodName : "logOut"});
...
action_async_UserAccess.verify = function() {
	return redux_thunk_Thunk.Action(function(dispatch,getState) {
		return new Promise(function(resolve,reject) {
			var state = getState();
			haxe_Log.trace(state.userState.dbUser,{ fileName : "src/action/async/UserAccess.hx", lineNumber : 297, className : "action.async.UserAccess", methodName : "verify"});
			...
			var bL1 = loader_BinaryLoader.dbQuery(bL,{ dbUser : state1, classPath : "auth.User", action : "verify", relations : _g, devIP : App.devIP},function(data) {
				haxe_Log.trace(data,{ fileName : "src/action/async/UserAccess.hx", lineNumber : 321, className : "action.async.UserAccess", methodName : "verify"});
				if(Object.prototype.hasOwnProperty.call(data.dataInfo.h,"verify") && data.dataInfo.h["verify"] == "OK") {
					resolve(data);
					return;
				}
				haxe_Log.trace(Lambda.empty(data.dataErrors),{ fileName : "src/action/async/UserAccess.hx", lineNumber : 325, className : "action.async.UserAccess", methodName : "verify"});
				if(!Lambda.empty(data.dataErrors)) {
					haxe_Log.trace(data.dataErrors == null ? "null" : haxe_ds_StringMap.stringify(data.dataErrors.h),{ fileName : "src/action/async/UserAccess.hx", lineNumber : 328, className : "action.async.UserAccess", methodName : "verify"});
					resolve(data);
					return;
				}
				var uData = data.dataRows[0];
				haxe_Log.trace(data.dataInfo == null ? "null" : haxe_ds_StringMap.stringify(data.dataInfo.h),{ fileName : "src/action/async/UserAccess.hx", lineNumber : 340, className : "action.async.UserAccess", methodName : "verify"});
				...
				haxe_Log.trace(state.userState.dbUser.jwt,{ fileName : "src/action/async/UserAccess.hx", lineNumber : 355, className : "action.async.UserAccess", methodName : "verify"});
...
db_DbQuery.prototype = {
	...
	,serialize: function(__ctx) {
		...
		if(a == null) {
			...
			var _g = [];
			var k = haxe_ds_StringMap.keysIterator(a.h);
			while(k.hasNext()) {
				var k1 = k.next();
				_g.push(k1);
			}
...
db_DbUser.prototype = {
	...
	,getSerializeSchema: function() {
		...
		schema.fieldsTypes.push(hxbit_PropTypeDesc.PInt);
		schema.fieldsNames.push("editing");
		schema.fieldsTypes.push(hxbit_PropTypeDesc.PString);
...
loader_BinaryLoader.dbQuery = function(url,dbQP,onLoaded) {
	haxe_Log.trace(dbQP,{ fileName : "src/loader/BinaryLoader.hx", lineNumber : 39, className : "loader.BinaryLoader", methodName : "dbQuery"});
	var s = new hxbit_Serializer();
	var bl = new loader_BinaryLoader(url);
	var dbQuery = new db_DbQuery(dbQP);
	var b = s.serialize(dbQuery);
	haxe_Log.trace("b.length:" + b.length,{ fileName : "src/loader/BinaryLoader.hx", lineNumber : 48, className : "loader.BinaryLoader", methodName : "dbQuery"});
	var blen = b.length;
	var _g = 0;
	var _g1 = blen;
	while(_g < _g1) {
	...
	haxe_Log.trace(bl.param,{ fileName : "src/loader/BinaryLoader.hx", lineNumber : 56, className : "loader.BinaryLoader", methodName : "dbQuery"});
	bl.cB = onLoaded;
	bl.load();
	return bl.xhr;
};
loader_BinaryLoader.prototype = {
	...
	,onLoaded: function(bytes) {
		haxe_Log.trace(bytes.length,{ fileName : "src/loader/BinaryLoader.hx", lineNumber : 79, className : "loader.BinaryLoader", methodName : "onLoaded"});
	...
	,onError: function(msg) {
		me_cunity_debug_Out.dumpStack(haxe_CallStack.callStack(),{ fileName : "src/loader/BinaryLoader.hx", lineNumber : 89, className : "loader.BinaryLoader", methodName : "onError"});
		haxe_Log.trace(msg,{ fileName : "src/loader/BinaryLoader.hx", lineNumber : 90, className : "loader.BinaryLoader", methodName : "onError"});
		throw haxe_Exception.thrown(msg);
	}
	,load: function() {
		var _gthis = this;
		...
		this.xhr.onerror = function(e) {
			haxe_Log.trace(e,{ fileName : "src/loader/BinaryLoader.hx", lineNumber : 102, className : "loader.BinaryLoader", methodName : "load"});
			haxe_Log.trace(e.type,{ fileName : "src/loader/BinaryLoader.hx", lineNumber : 103, className : "loader.BinaryLoader", methodName : "load"});
		};
		this.xhr.withCredentials = true;
		this.xhr.onload = function(e) {
			haxe_Log.trace(_gthis.xhr.status,{ fileName : "src/loader/BinaryLoader.hx", lineNumber : 107, className : "loader.BinaryLoader", methodName : "load"});
			if(_gthis.xhr.status != 200) {
				_gthis.onError(_gthis.xhr.statusText);
				return;
			}
			haxe_Log.trace(_gthis.xhr.response.length,{ fileName : "src/loader/BinaryLoader.hx", lineNumber : 112, className : "loader.BinaryLoader", methodName : "load"});
...
me_cunity_debug_Out.log2 = function(v,i) {
	...
	http.onData = function(data) {
		if(data != "OK") {
			haxe_Log.trace(data,{ fileName : "me/cunity/debug/Out.hx", lineNumber : 211, className : "me.cunity.debug.Out", methodName : "log2"});
		}
	};
	http.request(true);
};
...
me_cunity_debug_Out._dumpObjectTree = function(root,parent,recursive,i) {
	...
	try {
		...
		while(_g < fields.length) {
			var f = fields[_g];
			++_g;
			haxe_Log.trace(f,{ fileName : "me/cunity/debug/Out.hx", lineNumber : 317, className : "me.cunity.debug.Out", methodName : "_dumpObjectTree", customParams : [i]});
			if(recursive) {
		...
		haxe_Log.trace(ex,{ fileName : "me/cunity/debug/Out.hx", lineNumber : 342, className : "me.cunity.debug.Out", methodName : "_dumpObjectTree"});
	}
};
...
me_cunity_debug_Out.dumpStack = function(sA,i) {
	...
	haxe_Log.trace(b.b,{ fileName : "me/cunity/debug/Out.hx", lineNumber : 412, className : "me.cunity.debug.Out", methodName : "dumpStack", customParams : [i]});
};
...
model_ORM.prototype = {
	...
	,load: function(data) {
		...
		haxe_Log.trace(this.id + ":" + Std.string(data.h["id"]),{ fileName : "src/model/ORM.hx", lineNumber : 72, className : "model.ORM", methodName : "load"});
		return this;
	}
	,allModified: function() {
		...
		while(_g < _g1.length) {
			...
			haxe_Log.trace(nv + (" => " + model_ORM.dsep + " : " + dType + "::") + dType.indexOf("numeric"),{ fileName : "src/model/ORM.hx", lineNumber : 83, className : "model.ORM", methodName : "allModified"});
			var value;
			var _hx_tmp;
			var _hx_tmp1;
			switch(dType) {
			case "bigint[]":
				...
				break;
			case "date":
				_hx_tmp = dType.indexOf("timestamp");
				value = _hx_tmp == 0 ? nv == null ? "" : nv : nv == null ? "" : nv;
				break;
			default:
				_hx_tmp = dType.indexOf("timestamp");
				if(_hx_tmp == 0) {
					...
					_hx_tmp1 = dType.indexOf("numeric");
					if(_hx_tmp1 == 0) {
						nv = nv.split(" ")[0];
						var dvals = nv.split(model_ORM.dsep);
						haxe_Log.trace(dvals,{ fileName : "src/model/ORM.hx", lineNumber : 95, className : "model.ORM", methodName : "allModified"});
...
model_Account.prototype = $extend(model_ORM.prototype,{
	...
	,creditor: null
	,set_creditor: function(creditor) {
		if(this.initialized("creditor")) {
	...
	,set_last_locktime: function(last_locktime) {
		if(this.initialized("last_locktime")) {
	...
	,__properties__: {set_last_locktime:"set_last_locktime",set_edited_by:"set_edited_by",set_creation_date:"set_creation_date",set_state:"set_state",set_sign_date:"set_sign_date",set_creditor:"set_creditor",set_iban:"set_iban",set_blz:"set_blz",set_account:"set_account",set_bic:"set_bic",set_bank_name:"set_bank_name",set_contact:"set_contact"}
});
...
model_Contact.prototype = $extend(model_ORM.prototype,{
	...
	,__properties__: {set_owner:"set_owner",set_last_locktime:"set_last_locktime",set_merged:"set_merged",set_edited_by:"set_edited_by",set_comments:"set_comments",set_email:"set_email",set_mobile:"set_mobile",set_date_of_birth:"set_date_of_birth",set_gender:"set_gender",set_country_code:"set_country_code",set_postal_code:"set_postal_code",set_city:"set_city",set_address_2:"set_address_2",set_address:"set_address",set_last_name:"set_last_name",set_first_name:"set_first_name",set_title_pro:"set_title_pro",set_title:"set_title",set_fax:"set_fax",set_phone_number:"set_phone_number",set_phone_code:"set_phone_code",set_co_field:"set_co_field",set_company_name:"set_company_name",set_use_email:"set_use_email",set_state:"set_state",set_creation_date:"set_creation_date",set_mandator:"set_mandator"}
});
var model_Deal = function(data) {
	model_ORM.call(this,data);
	this.propertyNames = "id,contact,creation_date,account,target_account,start_day,start_date,cycle,amount,product,agent,project,status,pay_method,end_date,end_reason,repeat_date,edited_by,mandator,old_active,cycle_start_date,last_locktime".split(",");
};
...
model_Deal.prototype = $extend(model_ORM.prototype,{
	...
	,start_day: null
	,set_start_day: function(start_day) {
		if(this.initialized("start_day")) {
			this.modified("start_day");
		}
...
var model_imports_ReDebitModel = function() { };
$hxClasses["model.imports.ReDebitModel"] = model_imports_ReDebitModel;
model_imports_ReDebitModel.__name__ = "model.imports.ReDebitModel";
...
var react_DateControl = function(props) {
	haxe_Log.trace(props.value,{ fileName : "lib/react/DateControl.hx", lineNumber : 29, className : "react.DateControl", methodName : "new"});
...
react_DateControl.prototype = $extend(React_PureComponent.prototype,{
	...
	,componentDidMount: function() {
		...
		haxe_Log.trace("" + val + " =>" + Std.string(this.props.value) + "<<",{ fileName : "lib/react/DateControl.hx", lineNumber : 43, className : "react.DateControl", methodName : "componentDidMount"});
		...
		haxe_Log.trace("fpInstance.input.value:" + Std.string(this.fpInstance.input.value),{ fileName : "lib/react/DateControl.hx", lineNumber : 58, className : "react.DateControl", methodName : "componentDidMount"});
	}
	,onOpen: function(e) {
		haxe_Log.trace(e,{ fileName : "lib/react/DateControl.hx", lineNumber : 62, className : "react.DateControl", methodName : "onOpen"});
	}
	,onChange: function(_) {
		if(this.props.comp != null) {
			this.props.comp.baseForm.doChange(this.props.name,this.fpInstance.input.value);
		}
	}
	,onClose: function(sDates,val,me) {
		haxe_Log.trace(val,{ fileName : "lib/react/DateControl.hx", lineNumber : 74, className : "react.DateControl", methodName : "onClose"});
		if(this.tip != null) {
			this.tip.clear();
		}
	}
	,onReady: function(sDates,val,me) {
		haxe_Log.trace("" + Std.string(sDates) + " " + val + " ",{ fileName : "lib/react/DateControl.hx", lineNumber : 83, className : "react.DateControl", methodName : "onReady"});
	}
	,render: function() {
		if(this.props == null) {
			haxe_Log.trace(null,{ fileName : "lib/react/DateControl.hx", lineNumber : 91, className : "react.DateControl", methodName : "render"});
			return null;
		}
...
react_DateTimeControl.parseTimestampz = function(tz) {
	...
	b[1] -= 1;
	b[6] = 0;
	haxe_Log.trace(b.join("-"),{ fileName : "lib/react/DateTimeControl.hx", lineNumber : 132, className : "react.DateTimeControl", methodName : "parseTimestampz"});
	b.pop();
	haxe_Log.trace(Reflect.field(DateTools,"makeUtc"),{ fileName : "lib/react/DateTimeControl.hx", lineNumber : 134, className : "react.DateTimeControl", methodName : "parseTimestampz"});
...
react_DateTimeControl.prototype = $extend(React_PureComponent.prototype,{
	...
	,componentDidMount: function() {
		...
		haxe_Log.trace("" + Std.string(this.props.value) + " " + Std.string(val) + " " + this.props.options.dateFormat,{ fileName : "lib/react/DateTimeControl.hx", lineNumber : 40, className : "react.DateTimeControl", methodName : "componentDidMount"});
		...
		if(!this.props.disabled) {
			var tmp = this.props.value == null ? "" : this.fpInstance.formatDate(new Date(this.props.value),this.fpInstance.config.altFormat);
			altInput.value = tmp;
			haxe_Log.trace(this.fpInstance.input.value,{ fileName : "lib/react/DateTimeControl.hx", lineNumber : 60, className : "react.DateTimeControl", methodName : "componentDidMount"});
			...
			altInput.addEventListener("blur",function(ev) {
				...
				var val = altInput.value;
				var pd = _gthis.fpInstance.parseDate(val,_gthis.fpInstance.config.altFormat);
				haxe_Log.trace("" + val + " === " + pd.toString(),{ fileName : "lib/react/DateTimeControl.hx", lineNumber : 114, className : "react.DateTimeControl", methodName : "componentDidMount"});
				var fD = _gthis.fpInstance.formatDate(pd,_gthis.fpInstance.config.altFormat);
				haxe_Log.trace("" + val + "==" + fD,{ fileName : "lib/react/DateTimeControl.hx", lineNumber : 116, className : "react.DateTimeControl", methodName : "componentDidMount"});
				if(val == fD) {
					_gthis.fpInstance.setDate(val,true,_gthis.fpInstance.config.altFormat);
					if(_gthis.tip != null) {
						_gthis.tip.clear();
	...
	,onReady: function(sDates,val,me) {
		haxe_Log.trace("" + Std.string(sDates) + " " + val + " ",{ fileName : "lib/react/DateTimeControl.hx", lineNumber : 170, className : "react.DateTimeControl", methodName : "onReady"});
	}
	,render: function() {
		if(this.props == null) {
			haxe_Log.trace(null,{ fileName : "lib/react/DateTimeControl.hx", lineNumber : 178, className : "react.DateTimeControl", methodName : "render"});
			return null;
		}
		haxe_Log.trace("" + this.props.name + ":" + Std.string(this.props.value),{ fileName : "lib/react/DateTimeControl.hx", lineNumber : 181, className : "react.DateTimeControl", methodName : "render"});
				...
				if(v1 == null) {
					...
					while(_g2 < keys1.length) {
						...
						if(k3 == null) {
							...
							var b1 = haxe_io_Bytes.ofString(k3);
							var v3 = b1.length + 1;
							if(v3 >= 0 && v3 < 128) {
		...
		if(a == null) {
			...
			while(_g < a.length) {
				...
				if(v == null) {
					...
					var _g1 = [];
					var k = haxe_ds_StringMap.keysIterator(v.h);
					while(k.hasNext()) {
						var k1 = k.next();
						_g1.push(k1);
					}
...
shared_DateFormat.parseTimestampz = function(tz) {
	...
	b[1] -= 1;
	b[6] = 0;
	haxe_Log.trace(b.join("-"),{ fileName : "src/shared/DateFormat.hx", lineNumber : 69, className : "shared.DateFormat", methodName : "parseTimestampz"});
	b.pop();
...
shared_Utils.keyMax = function(d,key) {
	...
	haxe_Log.trace(Type.typeof(d[0]),{ fileName : "src/shared/Utils.hx", lineNumber : 137, className : "shared.Utils", methodName : "keyMax"});
	var _g = 0;
	while(_g < d.length) {
		var el = d[_g];
		++_g;
...
var store_AppStore = function(uStore) {
	...
	haxe_Log.trace(this.store,{ fileName : "src/store/AppStore.hx", lineNumber : 79, className : "store.AppStore", methodName : "new"});
};
...
store_AppStore.prototype = {
	...
	,reduce: function(state,action) {
		haxe_Log.trace(Reflect.fields(state),{ fileName : "src/store/AppStore.hx", lineNumber : 84, className : "store.AppStore", methodName : "reduce"});
		haxe_Log.trace(action,{ fileName : "src/store/AppStore.hx", lineNumber : 85, className : "store.AppStore", methodName : "reduce"});
		switch(action._hx_index) {
		case 0:
		...
		case 3:
			...
			haxe_Log.trace(dataAction,{ fileName : "src/store/AppStore.hx", lineNumber : 91, className : "store.AppStore", methodName : "reduce"});
			if(dataAction._hx_index == 3) {
				var data = dataAction.data;
				haxe_Log.trace(data.dataRows,{ fileName : "src/store/AppStore.hx", lineNumber : 95, className : "store.AppStore", methodName : "reduce"});
	...
	,middleware: function(action,next) {
		...
		haxe_Log.trace(tmp + $hxEnums[e.__enum__].__constructs__[e._hx_index],{ fileName : "src/store/AppStore.hx", lineNumber : 125, className : "store.AppStore", methodName : "middleware"});
		haxe_Log.trace(Type.enumParameters(action),{ fileName : "src/store/AppStore.hx", lineNumber : 126, className : "store.AppStore", methodName : "middleware"});
		var _this = Type.enumParameters(action);
		var result = new Array(_this.length);
		var _g = 0;
		var _g1 = _this.length;
		while(_g < _g1) {
			var i = _g++;
			var p = _this[i];
			haxe_Log.trace(p,{ fileName : "src/store/AppStore.hx", lineNumber : 128, className : "store.AppStore", methodName : "middleware"});
			result[i] = p;
		}
		switch(action._hx_index) {
		case 5:
		...
		case 7:
			var action1 = action.action;
			this.store.dispatch(redux_Action.map(action1));
			return next();
		default:
			return next();
		}
...
store_DataStore.prototype = {
	...
	,middleware: function(action,next) {
		haxe_Log.trace($hxEnums[action.__enum__].__constructs__[action._hx_index],{ fileName : "src/store/DataStore.hx", lineNumber : 100, className : "store.DataStore", methodName : "middleware"});
		switch(action._hx_index) {
		case 0:
		...
		case 9:
			var data = action.dataAccess;
			return this.store.dispatch(action_async_LivePBXSync.syncAll(data));
		default:
			return next();
		}
	}
...
var store_LocationStore = function(history) {
	...
	if(StringTools.startsWith($global.location.pathname,"/ChangePassword") == true) {
		...
		if(this._trace) {
			haxe_Log.trace(args == null ? "null" : haxe_ds_StringMap.stringify(args.h),{ fileName : "src/store/LocationStore.hx", lineNumber : 37, className : "store.LocationStore", methodName : "new"});
		}
		tmp1 = args.h["opath"];
	} else {
	...
	haxe_Log.trace(this.initState,{ fileName : "src/store/LocationStore.hx", lineNumber : 42, className : "store.LocationStore", methodName : "new"});
};
...
store_LocationStore.prototype = {
	...
	,reduce: function(state,action) {
		if(this._trace) {
			haxe_Log.trace(state.history.location,{ fileName : "src/store/LocationStore.hx", lineNumber : 47, className : "store.LocationStore", methodName : "reduce"});
		}
		if(this.store != null) {
			if(this._trace) {
				haxe_Log.trace(Reflect.fields(this.store),{ fileName : "src/store/LocationStore.hx", lineNumber : 49, className : "store.LocationStore", methodName : "reduce"});
			}
		}
		switch(action._hx_index) {
		case 6:
			...
			if(this._trace) {
				haxe_Log.trace(state,{ fileName : "src/store/LocationStore.hx", lineNumber : 53, className : "store.LocationStore", methodName : "reduce"});
			}
			return react_ReactUtil.copy(state,{ history : history});
		case 7:
			var location = action.location;
			if(this._trace) {
				haxe_Log.trace(location.pathname,{ fileName : "src/store/LocationStore.hx", lineNumber : 58, className : "store.LocationStore", methodName : "reduce"});
			}
	...
	,middleware: function(action,next) {
		if(this._trace) {
			haxe_Log.trace(action,{ fileName : "src/store/LocationStore.hx", lineNumber : 67, className : "store.LocationStore", methodName : "middleware"});
		}
		if(this._trace) {
			haxe_Log.trace(Reflect.fields(this.store.getState()),{ fileName : "src/store/LocationStore.hx", lineNumber : 68, className : "store.LocationStore", methodName : "middleware"});
		}
...
var store_StatusStore = function() {
	...
	haxe_Log.trace(this.initState,{ fileName : "src/store/StatusStore.hx", lineNumber : 21, className : "store.StatusStore", methodName : "new"});
};
...
store_StatusStore.prototype = {
	initState: null
	,reduce: function(state,action) {
		haxe_Log.trace(state,{ fileName : "src/store/StatusStore.hx", lineNumber : 25, className : "store.StatusStore", methodName : "reduce"});
		var status = action.status;
		haxe_Log.trace(status,{ fileName : "src/store/StatusStore.hx", lineNumber : 29, className : "store.StatusStore", methodName : "reduce"});
...
var store_UserStore = function() {
	...
	haxe_Log.trace(this.initState,{ fileName : "src/store/UserStore.hx", lineNumber : 72, className : "store.UserStore", methodName : "new"});
	haxe_Log.trace(this.store,{ fileName : "src/store/UserStore.hx", lineNumber : 73, className : "store.UserStore", methodName : "new"});
};
...
store_UserStore.prototype = {
	...
	,store: null
	,reduce: function(state,action) {
		haxe_Log.trace(action,{ fileName : "src/store/UserStore.hx", lineNumber : 78, className : "store.UserStore", methodName : "reduce"});
		switch(action._hx_index) {
		case 0:
			var uState = action.state;
			haxe_Log.trace(uState,{ fileName : "src/store/UserStore.hx", lineNumber : 82, className : "store.UserStore", methodName : "reduce"});
			return react_ReactUtil.copy(state,uState);
		case 1:
			var uState = action.state;
			haxe_Log.trace(uState,{ fileName : "src/store/UserStore.hx", lineNumber : 94, className : "store.UserStore", methodName : "reduce"});
			return react_ReactUtil.copy(state,uState);
		case 2:
			var err = action.state;
			haxe_Log.trace(err,{ fileName : "src/store/UserStore.hx", lineNumber : 85, className : "store.UserStore", methodName : "reduce"});
			return react_ReactUtil.copy(state,err);
		case 3:
			var uState = action.state;
			haxe_Log.trace(uState,{ fileName : "src/store/UserStore.hx", lineNumber : 89, className : "store.UserStore", methodName : "reduce"});
			return react_ReactUtil.copy(state,uState);
		case 4:
			var uState = action.state;
			haxe_Log.trace(uState,{ fileName : "src/store/UserStore.hx", lineNumber : 100, className : "store.UserStore", methodName : "reduce"});
			return react_ReactUtil.copy(state,uState);
		case 5:
			var uState = action.state;
			haxe_Log.trace(uState,{ fileName : "src/store/UserStore.hx", lineNumber : 97, className : "store.UserStore", methodName : "reduce"});
			return react_ReactUtil.copy(state,uState);
		case 6:
			var uState = action.state;
			haxe_Log.trace(uState,{ fileName : "src/store/UserStore.hx", lineNumber : 82, className : "store.UserStore", methodName : "reduce"});
...
tink_core_Future.ofJsPromise = function(promise) {
	return tink_core_Future.irreversible(function(cb) {
		promise.then(function(a) {
			...
			cb(tink_core_Outcome.Failure(tink_core_TypedError.withData(null,e.message,e,{ fileName : "tink/core/Future.hx", lineNumber : 130, className : "tink.core._Future.Future_Impl_", methodName : "ofJsPromise"})));
		});
	});
};
tink_core_Future.fromNoise = function(l) {
	return l;
};
...
tink_core__$Lazy_LazyFunc.prototype = {
	...
	,compute: function() {
		if(this.busy) {
			throw haxe_Exception.thrown(new tink_core_TypedError(null,"circular lazyness",{ fileName : "tink/core/Lazy.hx", lineNumber : 86, className : "tink.core._Lazy.LazyFunc", methodName : "compute"}));
		}
		var _g = this.f;
		if(_g != null) {
			var v = _g;
...
tink_core_Promise.fromNoise = function(l) {
	return l;
};
...
tink_core__$Signal_Disposed.prototype = {
	get_disposed: function() {
		return true;
	}
	,dispose: function() {
...
view_Accounting.prototype = $extend(React_Component.prototype,{
	...
	,componentDidCatch: function(error,info) {
		haxe_Log.trace(error,{ fileName : "src/view/Accounting.hx", lineNumber : 64, className : "view.Accounting", methodName : "componentDidCatch"});
	}
	,render: function() {
		...
		var tmp8 = React.createElement(tmp3,Object.assign({ },tmp4,{ to : { key : tmp5, hash : tmp6, pathname : "/Accounting/Accounts", search : "", state : tmp7}}),"Konten");
		var tmp3 = React.createElement(react_ReactType.fromComp(view_shared_TabLink),Object.assign({ },this.props,{ to : "/Accounting/Imports"}),"Imports");
		...
		var tmp3 = React.createElement(react_ReactType.fromComp(react_router_Route),Object.assign({ },this.props,{ path : "/Accounting/Accounts/:section?/:action?/:id?", component : react_ReactType.fromComp(view_data_Accounts)}));
...
var view_DashBoard = function(props) {
	...
	if(props.match.url == "/DashBoard") {
		...
		haxe_Log.trace("pushed2: /DashBoard/Settings",{ fileName : "src/view/DashBoard.hx", lineNumber : 58, className : "view.DashBoard", methodName : "new"});
	}
};
...
view_DashBoard.prototype = $extend(React_Component.prototype,{
	...
	,componentDidCatch: function(error,info) {
		...
		haxe_Log.trace(error,{ fileName : "src/view/DashBoard.hx", lineNumber : 74, className : "view.DashBoard", methodName : "componentDidCatch"});
		haxe_Log.trace(info,{ fileName : "src/view/DashBoard.hx", lineNumber : 75, className : "view.DashBoard", methodName : "componentDidCatch"});
	}
	,componentWillUnmount: function() {
		haxe_Log.trace("leaving...",{ fileName : "src/view/DashBoard.hx", lineNumber : 80, className : "view.DashBoard", methodName : "componentWillUnmount"});
	}
	,render: function() {
		...
		haxe_Log.trace(Reflect.fields(this.props),{ fileName : "src/view/DashBoard.hx", lineNumber : 121, className : "view.DashBoard", methodName : "render"});
		haxe_Log.trace(Reflect.fields(this.state),{ fileName : "src/view/DashBoard.hx", lineNumber : 122, className : "view.DashBoard", methodName : "render"});
		var tmp = react_ReactType.fromComp(React_Fragment);
		var tmp1 = react_ReactType.fromString("div");
		var tmp2 = react_ReactType.fromComp(bulma_$components_Tabs);
...
view_Data.prototype = $extend(React_Component.prototype,{
	...
	,render: function() {
		...
		var tmp7 = shared_Utils.extend(this.props.location.state,{ contact : this.props.location.hash});
		var tmp8 = React.createElement(tmp4,Object.assign({ },tmp5,{ to : { key : tmp6, hash : "", pathname : "/Data/Deals", search : "", state : tmp7}}),"Abschlüsse");
		var tmp4 = react_ReactType.fromComp(view_shared_TabLink);
		var tmp5 = this.props;
		var tmp6 = this.props.location.key;
...
var view_LoginForm = function(props) {
	haxe_Log.trace(Reflect.fields(props),{ fileName : "src/view/LoginForm.hx", lineNumber : 53, className : "view.LoginForm", methodName : "new"});
	React_Component.call(this,props);
	haxe_Log.trace(props,{ fileName : "src/view/LoginForm.hx", lineNumber : 55, className : "view.LoginForm", methodName : "new"});
	this.submitValue = "";
...
view_LoginForm.mapDispatchToProps = function(dispatch) {
	haxe_Log.trace("ok",{ fileName : "src/view/LoginForm.hx", lineNumber : 61, className : "view.LoginForm", methodName : "mapDispatchToProps"});
...
view_LoginForm.mapStateToProps = function() {
	return function(aState) {
		var uState = aState.userState;
		haxe_Log.trace(aState.locationStore.redirectAfterLogin,{ fileName : "src/view/LoginForm.hx", lineNumber : 105, className : "view.LoginForm", methodName : "mapStateToProps"});
		haxe_Log.trace(uState,{ fileName : "src/view/LoginForm.hx", lineNumber : 106, className : "view.LoginForm", methodName : "mapStateToProps"});
		if(uState.loginTask == "ChangePassword") {
			var rAL = aState.locationStore.redirectAfterLogin;
			haxe_Log.trace(rAL,{ fileName : "src/view/LoginForm.hx", lineNumber : 110, className : "view.LoginForm", methodName : "mapStateToProps"});
			var param = shared_Utils.argList(rAL,["action","jwt","user_name","opath"]);
			haxe_Log.trace(param == null ? "null" : haxe_ds_StringMap.stringify(param.h),{ fileName : "src/view/LoginForm.hx", lineNumber : 114, className : "view.LoginForm", methodName : "mapStateToProps"});
...
view_LoginForm.prototype = $extend(React_Component.prototype,{
	submitValue: null
	,shouldComponentUpdate: function(nextProps,nextState) {
		haxe_Log.trace("propsChanged:" + Std.string(nextProps != this.props) + " stateChanged:" + Std.string(nextState != this.state),{ fileName : "src/view/LoginForm.hx", lineNumber : 74, className : "view.LoginForm", methodName : "shouldComponentUpdate"});
	...
	,componentDidMount: function() {
		...
		var img = new Image();
		img.onload = function() {
			haxe_Log.trace(_gthis.state,{ fileName : "src/view/LoginForm.hx", lineNumber : 92, className : "view.LoginForm", methodName : "componentDidMount"});
			haxe_Timer.delay(function() {
				_gthis.setState({ waiting : false});
			},500);
			haxe_Log.trace("ok",{ fileName : "src/view/LoginForm.hx", lineNumber : 94, className : "view.LoginForm", methodName : "componentDidMount"});
		};
		img.src = "img/schutzengelwerk-logo.png";
		haxe_Log.trace(this.props.redirectAfterLogin,{ fileName : "src/view/LoginForm.hx", lineNumber : 97, className : "view.LoginForm", methodName : "componentDidMount"});
	}
	,handleChange: function(e) {
		var s = { dbUser : this.props.userState.dbUser};
		var t = e.target;
		haxe_Log.trace(t.name,{ fileName : "src/view/LoginForm.hx", lineNumber : 132, className : "view.LoginForm", methodName : "handleChange"});
		haxe_Log.trace(t.value,{ fileName : "src/view/LoginForm.hx", lineNumber : 133, className : "view.LoginForm", methodName : "handleChange"});
		...
		haxe_Log.trace(this.state,{ fileName : "src/view/LoginForm.hx", lineNumber : 147, className : "view.LoginForm", methodName : "handleChange"});
	}
	,handleSubmit: function(e) {
		e.preventDefault();
		haxe_Log.trace(this.props,{ fileName : "src/view/LoginForm.hx", lineNumber : 153, className : "view.LoginForm", methodName : "handleSubmit"});
		haxe_Log.trace(this.state,{ fileName : "src/view/LoginForm.hx", lineNumber : 154, className : "view.LoginForm", methodName : "handleSubmit"});
		haxe_Log.trace(this.submitValue,{ fileName : "src/view/LoginForm.hx", lineNumber : 155, className : "view.LoginForm", methodName : "handleSubmit"});
		...
		if(_g == null) {
			...
			case "ChangePassword":
				...
				break;
			case "ResetPassword":
				haxe_Log.trace("Reset Password requested",{ fileName : "src/view/LoginForm.hx", lineNumber : 166, className : "view.LoginForm", methodName : "handleSubmit"});
				haxe_Log.trace(this.props,{ fileName : "src/view/LoginForm.hx", lineNumber : 167, className : "view.LoginForm", methodName : "handleSubmit"});
	...
	,resetPassword: function(_) {
		haxe_Log.trace("OK",{ fileName : "src/view/LoginForm.hx", lineNumber : 193, className : "view.LoginForm", methodName : "resetPassword"});
	}
	,renderForm: function() {
		var _gthis = this;
		haxe_Log.trace(this.props.redirectAfterLogin,{ fileName : "src/view/LoginForm.hx", lineNumber : 199, className : "view.LoginForm", methodName : "renderForm"});
		haxe_Log.trace(this.props.userState.dbUser,{ fileName : "src/view/LoginForm.hx", lineNumber : 200, className : "view.LoginForm", methodName : "renderForm"});
		...
		var tmp2 = react_ReactType.fromString("div");
		var tmp3 = { className : "formField", style : { display : this.props.userState.loginTask == "ResetPassword" ? "flex" : "none"}, onClick : function() {
	...
	,render: function() {
		haxe_Log.trace(Reflect.fields(this.props),{ fileName : "src/view/LoginForm.hx", lineNumber : 315, className : "view.LoginForm", methodName : "render"});
		haxe_Log.trace(this.props.userState.lastError,{ fileName : "src/view/LoginForm.hx", lineNumber : 316, className : "view.LoginForm", methodName : "render"});
		haxe_Log.trace(this.state.waiting,{ fileName : "src/view/LoginForm.hx", lineNumber : 317, className : "view.LoginForm", methodName : "render"});
	...
	,errorStyle: function(name) {
		...
		case "new_pass_confirm":
			eStyle = this.props.userState.new_pass != this.props.userState.new_pass_confirm ? "error " : "";
			break;
		case "password":
			var res = this.props.userState.lastError == "password" ? "error " : "";
			haxe_Log.trace(res,{ fileName : "src/view/LoginForm.hx", lineNumber : 359, className : "view.LoginForm", methodName : "errorStyle"});
			eStyle = res;
			break;
		case "user_name":
			eStyle = this.props.userState.lastError == "user_name" ? "error " : "";
			break;
		default:
			eStyle = "";
		}
		haxe_Log.trace(eStyle,{ fileName : "src/view/LoginForm.hx", lineNumber : 371, className : "view.LoginForm", methodName : "errorStyle"});
		return eStyle;
	}
...
var view_StatusBar = function(props,context) {
	...
	haxe_Log.trace("ok",{ fileName : "src/view/StatusBar.hx", lineNumber : 64, className : "view.StatusBar", methodName : "new"});
	React_Component.call(this,props);
};
...
view_StatusBar.prototype = $extend(React_Component.prototype,{
	...
	,componentDidMount: function() {
		...
		var d = new Date();
		var s = d.getSeconds();
		haxe_Log.trace("start delay at " + s + " set timer start in " + (60 - s) + " seconds",{ fileName : "src/view/StatusBar.hx", lineNumber : 79, className : "view.StatusBar", methodName : "componentDidMount"});
		haxe_Timer.delay(function() {
			if(!_gthis.mounted) {
				haxe_Log.trace("not mounted - will do nothing",{ fileName : "src/view/StatusBar.hx", lineNumber : 84, className : "view.StatusBar", methodName : "componentDidMount"});
				return;
			}
			haxe_Log.trace("timer start at " + new Date().getSeconds(),{ fileName : "src/view/StatusBar.hx", lineNumber : 87, className : "view.StatusBar", methodName : "componentDidMount"});
...
view_UiView.prototype = $extend(React_Component.prototype,{
	...
	,render: function() {
		if(this.props.userState.dbUser != null) {
			haxe_Log.trace(this.props.userState.dbUser.id,{ fileName : "src/view/UiView.hx", lineNumber : 143, className : "view.UiView", methodName : "render"});
		}
		if(this.state.hasError || this.props.userState.dbUser == null) {
		...
		haxe_Log.trace("" + this.props.userState.dbUser.jwt + " " + Std.string(this.props.userState.dbUser.online),{ fileName : "src/view/UiView.hx", lineNumber : 159, className : "view.UiView", methodName : "render"});
		if(this.props.userState.dbUser.jwt == null || this.props.userState.dbUser.jwt == "" || !this.props.userState.dbUser.online || this.props.userState.dbUser.change_pass_required) {
			haxe_Log.trace(this.props.userState.dbUser,{ fileName : "src/view/UiView.hx", lineNumber : 163, className : "view.UiView", methodName : "render"});
			...
			haxe_Log.trace("render Router " + App.store.getState().locationStore.history.location.pathname,{ fileName : "src/view/UiView.hx", lineNumber : 170, className : "view.UiView", methodName : "render"});
			haxe_Log.trace(App.store.getState().locationStore.history == this.browserHistory,{ fileName : "src/view/UiView.hx", lineNumber : 172, className : "view.UiView", methodName : "render"});
			if(this.browserHistory.location.pathname != App.store.getState().locationStore.redirectAfterLogin) {
				haxe_Log.trace("Redirect to: " + App.store.getState().locationStore.redirectAfterLogin,{ fileName : "src/view/UiView.hx", lineNumber : 175, className : "view.UiView", methodName : "render"});
	...
	,renderRedirect: function(p) {
		haxe_Log.trace(App.store.getState().locationStore.redirectAfterLogin,{ fileName : "src/view/UiView.hx", lineNumber : 240, className : "view.UiView", methodName : "renderRedirect"});
...
var view_shared_io_FormApi = function(rc,sM) {
	...
	if(rc.props != null) {
		...
		haxe_Log.trace(sM,{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 90, className : "view.shared.io.FormApi", methodName : "new"});
		haxe_Log.trace(this.sM,{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 91, className : "view.shared.io.FormApi", methodName : "new"});
	}
	haxe_Log.trace(Reflect.fields(sM),{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 95, className : "view.shared.io.FormApi", methodName : "new"});
};
...
view_shared_io_FormApi.renderSelectOptions = function(fel) {
	...
	while(_g < opts.length) {
		var opt = opts[_g];
		++_g;
		rOpts.push(React.createElement(react_ReactType.fromString("option"),{ key : shared_Utils.genKey(k++,{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 482, className : "view.shared.io.FormApi", methodName : "renderSelectOptions"})},opt));
	}
	return rOpts;
};
...
view_shared_io_FormApi.localDate = function(d) {
	...
	haxe_Log.trace(d,{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 655, className : "view.shared.io.FormApi", methodName : "localDate"});
	haxe_Log.trace(Date.parse(d),{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 656, className : "view.shared.io.FormApi", methodName : "localDate"});
...
view_shared_io_FormApi.prototype = {
	...
	,doAction: function(defaultAction) {
		if(this.comp.props.match != null && (this.comp.props.match.params.action != null || defaultAction != null)) {
			...
			haxe_Log.trace("going 2 call " + c.__name__ + " " + action,{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 105, className : "view.shared.io.FormApi", methodName : "doAction"});
	...
	,createStateValues: function(data,view) {
		...
		haxe_Log.trace(haxe_ds_StringMap.keysIterator(data.h),{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 118, className : "view.shared.io.FormApi", methodName : "createStateValues"});
		haxe_Log.trace(haxe_ds_StringMap.keysIterator(view.h),{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 119, className : "view.shared.io.FormApi", methodName : "createStateValues"});
		var k = haxe_ds_StringMap.keysIterator(data.h);
		while(k.hasNext()) {
			var k1 = k.next();
			if(Object.prototype.hasOwnProperty.call(view.h,k1)) {
				var v = data.h[k1];
				vState.h[k1] = v;
			}
		}
		haxe_Log.trace(vState == null ? "null" : haxe_ds_StringMap.stringify(vState.h),{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 128, className : "view.shared.io.FormApi", methodName : "createStateValues"});
		return vState;
	}
	...
	,itemHandler: function(e) {
		...
		haxe_Log.trace(action,{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 174, className : "view.shared.io.FormApi", methodName : "itemHandler"});
		haxe_Log.trace(Reflect.field(this._me,"callMethod"),{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 175, className : "view.shared.io.FormApi", methodName : "itemHandler"});
	...
	,callMethod: function(method,e) {
		...
		haxe_Log.trace(">>" + targetSection + "<< " + this.comp.props.match.params.section,{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 184, className : "view.shared.io.FormApi", methodName : "callMethod"});
		if(targetSection != null && targetSection != this.comp.props.match.params.section) {
			...
			haxe_Log.trace(this.comp.props.location.state,{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 188, className : "view.shared.io.FormApi", methodName : "callMethod"});
			if(method == "restore" && this.comp.props.location.state != null && this.comp.props.location.state.activeContactUrl != null) {
	...
	,render: function(content) {
		if(this.sM.section != null) {
			haxe_Log.trace(this.sM.section + ":" + this.comp.props.match.params.section,{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 275, className : "view.shared.io.FormApi", methodName : "render"});
		...
		var tmp1 = view_shared_Menu._renderWrapper;
		var tmp2 = Object.assign({ },this.sM,this.comp.props,{ className : "menu", itemHandler : $bind(this,this.itemHandler)});
		return React.createElement(tmp,{ className : "columns"},content,React.createElement(tmp1,tmp2));
	}
	,renderField: function(name,k,state) {
		var formField = state.fields.h[name];
		if(k == 0) {
			haxe_Log.trace(state.handleChange,{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 291, className : "view.shared.io.FormApi", methodName : "renderField"});
		}
		...
		if(formField.type == "Hidden") {
			...
			return [React.createElement(react_ReactType.fromString("label"),{ key : shared_Utils.genKey(k++,{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 301, className : "view.shared.io.FormApi", methodName : "renderField"})},formField.label),field];
		}
	}
	,renderElements: function(cState) {
		haxe_Log.trace(Lambda.empty(cState.data),{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 306, className : "view.shared.io.FormApi", methodName : "renderElements"});
		if(Lambda.empty(cState.data)) {
			return null;
		}
		var fields = haxe_ds_StringMap.keysIterator(cState.fields.h);
		var elements = [];
		var k = 0;
		var field = fields;
		while(field.hasNext()) {
			...
			var tmp = react_ReactType.fromString("div");
			var tmp1 = shared_Utils.genKey(k++,{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 315, className : "view.shared.io.FormApi", methodName : "renderElements"});
	...
	,storeFormState: function(field,val) {
		...
		var actualState = App.store.getState().formStates.h[this.comp.state.formStateKey];
	...
	,createElementsArray: function() {
		...
		this.addFormColumns();
		var fields = haxe_ds_StringMap.keysIterator(this._fstate.fields.h);
		var pID = "";
		var name = fields;
		while(name.hasNext()) {
			var name1 = name.next();
		...
		while(_g < _g1.length) {
			var dR = _g1[_g];
			++_g;
			fields = haxe_ds_StringMap.keysIterator(this._fstate.fields.h);
			var name = fields;
			while(name.hasNext()) {
				var name1 = name.next();
	...
	,renderColumns: function() {
		var fields = haxe_ds_StringMap.keysIterator(this.formColElements.h);
		var cols = [];
		var col = 0;
		var name = fields;
		while(name.hasNext()) {
			var name1 = name.next();
			cols.push(React.createElement(react_ReactType.fromString("div"),{ key : shared_Utils.genKey(name1 + "_" + col++,{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 401, className : "view.shared.io.FormApi", methodName : "renderColumns"}), className : "col", 'data-name' : name1},this.renderRows(name1)));
		}
		return cols;
	}
	...
	,renderRowCell: function(fF,k) {
		...
		var _g = fF.type;
		if(_g == null) {
			return React.createElement(react_ReactType.fromString("input"),{ key : shared_Utils.genKey(k++,{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 447, className : "view.shared.io.FormApi", methodName : "renderRowCell"}), name : model, type : "hidden"});
		} else {
			switch(_g) {
			case "Checkbox":
				haxe_Log.trace(fF.value,{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 435, className : "view.shared.io.FormApi", methodName : "renderRowCell"});
				return React.createElement(react_ReactType.fromString("input"),{ key : shared_Utils.genKey(k++,{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 436, className : "view.shared.io.FormApi", methodName : "renderRowCell"}), name : model, disabled : fF.disabled});
			case "Hidden":
				if(fF.primary) {
					return null;
				} else {
					return React.createElement(react_ReactType.fromString("inputl"),{ key : shared_Utils.genKey(k++,{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 439, className : "view.shared.io.FormApi", methodName : "renderRowCell"}), name : model, type : "hidden"});
				}
				break;
			case "Select":
	...
	,renderRows: function(name) {
		...
		var k = 0;
		var tmp = react_ReactType.fromString("div");
		var tmp1 = { key : shared_Utils.genKey(k++,{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 458, className : "view.shared.io.FormApi", methodName : "renderRows"}), className : "form-table-cell", style : { minHeight : "0px", height : "0px", overflow : "hidden", padding : "0px 0.3rem"}};
		...
		while(_g < _g1.length) {
			var fF = _g1[_g];
			++_g;
			elements.push(React.createElement(react_ReactType.fromString("div"),{ key : shared_Utils.genKey(k++,{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 467, className : "view.shared.io.FormApi", methodName : "renderRows"}), className : "form-table-cell"},this.renderRowCell(fF,k++)));
		}
		return elements;
	}
	...
	,renderModalScreen: function(content) {
		haxe_Log.trace(App.modalBox,{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 544, className : "view.shared.io.FormApi", methodName : "renderModalScreen"});
	...
	,adjustModalFormColumns: function() {
		haxe_Log.trace(react_ReactRef.get_current(this.modalFormTableHeader),{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 571, className : "view.shared.io.FormApi", methodName : "adjustModalFormColumns"});
		haxe_Log.trace(react_ReactRef.get_current(this.modalFormTableBody).children,{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 573, className : "view.shared.io.FormApi", methodName : "adjustModalFormColumns"});
		...
		haxe_Log.trace(bodyCols,{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 576, className : "view.shared.io.FormApi", methodName : "adjustModalFormColumns"});
		if(bodyCols == null) {
			return;
		}
		var i = 0;
	...
	,closeWait: function() {
		...
		haxe_Log.trace("Done waiting",{ fileName : "src/view/shared/io/FormApi.hx", lineNumber : 592, className : "view.shared.io.FormApi", methodName : "closeWait"});
	}
	,renderWait: function() {
...
var view_accounting_Imports = function(props) {
	React_Component.call(this,props);
	this.dataDisplay = model_imports_ReDebitModel.dataDisplay;
	haxe_Log.trace("..." + Std.string(Reflect.fields(props)),{ fileName : "src/view/accounting/Imports.hx", lineNumber : 93, className : "view.accounting.Imports", methodName : "new"});
	this.baseForm = new view_shared_io_BaseForm(this);
	view_accounting_Imports.menuItems[0].handler = $bind(this,this.importReturnDebit);
	this.state = App.initEState({ sideMenu : view_shared_io_FormApi.initSideMenu2(this,[{ dataClassPath : "admin.ImportCamt", label : "Import RüLa's", section : "Import", items : view_accounting_Imports.menuItems}],{ section : props.match.params.section == null ? "Import" : props.match.params.section, sameWidth : true})},this);
};
...
view_accounting_Imports.mapDispatchToProps = function(dispatch) {
	return { load : function(param) {
		return dispatch(redux_Action.map(view_accounting_Imports.upload(param)));
...
view_accounting_Imports.upload = function(param) {
	haxe_Log.trace(param.action,{ fileName : "src/view/accounting/Imports.hx", lineNumber : 193, className : "view.accounting.Imports", methodName : "upload"});
	return redux_thunk_Thunk.Action(function(dispatch,getState) {
		haxe_Log.trace(param,{ fileName : "src/view/accounting/Imports.hx", lineNumber : 195, className : "view.accounting.Imports", methodName : "upload"});
		var dbData = shared_DbDataTools.create();
		return new Promise(function(resolve,reject) {
			if(!param.dbUser.online) {
				dispatch(redux_Action.map(action_AppAction.User(action_UserAction.LoginError({ dbUser : param.dbUser, lastError : "Du musst dich neu anmelden!"}))));
				haxe_Log.trace("LoginError",{ fileName : "src/view/accounting/Imports.hx", lineNumber : 206, className : "view.accounting.Imports", methodName : "upload"});
				resolve(null);
			}
			var bL = loader_BinaryLoader.dbQuery("" + Std.string(App.config.api),param,function(data) {
				haxe_Log.trace(data,{ fileName : "src/view/accounting/Imports.hx", lineNumber : 215, className : "view.accounting.Imports", methodName : "upload"});
				if(data.dataErrors != null) {
					haxe_Log.trace(data.dataErrors == null ? "null" : haxe_ds_StringMap.stringify(data.dataErrors.h),{ fileName : "src/view/accounting/Imports.hx", lineNumber : 217, className : "view.accounting.Imports", methodName : "upload"});
				}
				if(data.dataInfo != null && Object.prototype.hasOwnProperty.call(data.dataInfo.h,"dataSource")) {
					haxe_Log.trace(new haxe_Unserializer(data.dataInfo.h["dataSource"]).unserialize(),{ fileName : "src/view/accounting/Imports.hx", lineNumber : 219, className : "view.accounting.Imports", methodName : "upload"});
				}
				if(Object.prototype.hasOwnProperty.call(data.dataErrors.h,"lastError")) {
					dispatch(redux_Action.map(action_AppAction.User(action_UserAction.LoginError({ lastError : data.dataErrors.h["lastError"]}))));
					resolve(null);
			...
			haxe_Log.trace(bL,{ fileName : "src/view/accounting/Imports.hx", lineNumber : 237, className : "view.accounting.Imports", methodName : "upload"});
		});
	});
};
...
view_accounting_Imports.prototype = $extend(React_Component.prototype,{
	...
	,dbMetaData: null
	,'delete': function(ev) {
		haxe_Log.trace(this.state.selectedRows.length,{ fileName : "src/view/accounting/Imports.hx", lineNumber : 138, className : "view.accounting.Imports", methodName : "delete"});
		var data = this.state.formApi.selectedRowsMap(this.state);
		haxe_Log.trace(data,{ fileName : "src/view/accounting/Imports.hx", lineNumber : 140, className : "view.accounting.Imports", methodName : "delete"});
	}
	,importReturnDebit: function(_) {
		...
		var iPromise = new Promise(function(resolve,reject) {
			...
			haxe_Log.trace(_gthis.props.userState.dbUser.first_name + "::" + finput.files[0],{ fileName : "src/view/accounting/Imports.hx", lineNumber : 147, className : "view.accounting.Imports", methodName : "importReturnDebit"});
			var uFile = js_Boot.__cast(finput.files[0] , Blob);
			haxe_Log.trace(uFile,{ fileName : "src/view/accounting/Imports.hx", lineNumber : 150, className : "view.accounting.Imports", methodName : "importReturnDebit"});
			var fd = new FormData();
			...
			xhr.onerror = function(e) {
				haxe_Log.trace(e,{ fileName : "src/view/accounting/Imports.hx", lineNumber : 158, className : "view.accounting.Imports", methodName : "importReturnDebit"});
				haxe_Log.trace(e.type,{ fileName : "src/view/accounting/Imports.hx", lineNumber : 159, className : "view.accounting.Imports", methodName : "importReturnDebit"});
				reject({ error : e});
			};
			xhr.withCredentials = true;
			xhr.onload = function(e) {
				haxe_Log.trace(xhr.status,{ fileName : "src/view/accounting/Imports.hx", lineNumber : 164, className : "view.accounting.Imports", methodName : "importReturnDebit"});
				if(xhr.status != 200) {
					haxe_Log.trace(xhr.statusText,{ fileName : "src/view/accounting/Imports.hx", lineNumber : 166, className : "view.accounting.Imports", methodName : "importReturnDebit"});
					reject({ error : xhr.statusText});
				}
				haxe_Log.trace(xhr.response.length,{ fileName : "src/view/accounting/Imports.hx", lineNumber : 169, className : "view.accounting.Imports", methodName : "importReturnDebit"});
		...
		iPromise.then(function(r) {
			haxe_Log.trace(r,{ fileName : "src/view/accounting/Imports.hx", lineNumber : 178, className : "view.accounting.Imports", methodName : "importReturnDebit"});
			var rD = JSON.parse(r);
			var dd = JSON.parse(r);
			haxe_Log.trace(rD,{ fileName : "src/view/accounting/Imports.hx", lineNumber : 181, className : "view.accounting.Imports", methodName : "importReturnDebit"});
			var dT = [];
			var _g = 0;
			var _g1 = dd.rlData;
			while(_g < _g1.length) {
			...
			_gthis.setState({ dataTable : dT, loading : false});
		},function(r) {
			haxe_Log.trace(r,{ fileName : "src/view/accounting/Imports.hx", lineNumber : 187, className : "view.accounting.Imports", methodName : "importReturnDebit"});
		});
	}
	,doImport: function(dbQueryParam) {
		var _gthis = this;
		...
		p.then(function(data) {
			...
			haxe_Log.trace("" + offset + " < " + Std.string(data.dataInfo.h["maxImport"]),{ fileName : "src/view/accounting/Imports.hx", lineNumber : 264, className : "view.accounting.Imports", methodName : "doImport"});
			if(offset < data.dataInfo.h["maxImport"]) {
				haxe_Log.trace("next loop:" + (data.dataInfo == null ? "null" : haxe_ds_StringMap.stringify(data.dataInfo.h)),{ fileName : "src/view/accounting/Imports.hx", lineNumber : 267, className : "view.accounting.Imports", methodName : "doImport"});
				return _gthis.doImport(data.dataInfo);
			} else {
	...
	,render: function() {
		haxe_Log.trace(this.props.match.params.section,{ fileName : "src/view/accounting/Imports.hx", lineNumber : 287, className : "view.accounting.Imports", methodName : "render"});
	...
	,renderResults: function() {
		haxe_Log.trace(this.props.match.params.action + ":" + Std.string(this.state.dataTable != null),{ fileName : "src/view/accounting/Imports.hx", lineNumber : 298, className : "view.accounting.Imports", methodName : "renderResults"});
		haxe_Log.trace(this.state.loading,{ fileName : "src/view/accounting/Imports.hx", lineNumber : 299, className : "view.accounting.Imports", methodName : "renderResults"});
		if(this.state.loading) {
			return this.state.formApi.renderWait();
		}
		haxe_Log.trace("###########loading:" + Std.string(this.state.loading),{ fileName : "src/view/accounting/Imports.hx", lineNumber : 302, className : "view.accounting.Imports", methodName : "renderResults"});
		...
		if(_g == null) {
			...
			case "importClientList":
				haxe_Log.trace(this.state.actualState,{ fileName : "src/view/accounting/Imports.hx", lineNumber : 313, className : "view.accounting.Imports", methodName : "renderResults"});
...
view_dashboard_DB.prototype = $extend(React_Component.prototype,{
	...
	,createFieldList: function(ev) {
		...
		this.state.formApi.requests.push(haxe_ds_Either.Left(view_shared_io_Loader.load("" + Std.string(App.config.api),{ id : this.props.userState.dbUser.id, jwt : this.props.userState.dbUser.jwt, classPath : "tools.DB", action : "createFieldList", update : "1"},function(data) {
			haxe_Log.trace(data == null ? "null" : haxe_ds_StringMap.stringify(data.h),{ fileName : "src/view/dashboard/DB.hx", lineNumber : 88, className : "view.dashboard.DB", methodName : "createFieldList"});
			if(Object.prototype.hasOwnProperty.call(data.h,"error")) {
				haxe_Log.trace(data.h["error"],{ fileName : "src/view/dashboard/DB.hx", lineNumber : 92, className : "view.dashboard.DB", methodName : "createFieldList"});
				return;
			}
	...
	,editTableFields: function(ev) {
		...
		haxe_Log.trace(this.dataAccess.h["editTableFields"].view.h["table_name"],{ fileName : "src/view/dashboard/DB.hx", lineNumber : 115, className : "view.dashboard.DB", methodName : "editTableFields"});
		haxe_Log.trace(data[0].h["id"] + "<",{ fileName : "src/view/dashboard/DB.hx", lineNumber : 116, className : "view.dashboard.DB", methodName : "editTableFields"});
	}
	...
	,renderResults: function() {
		if(this.state.dataTable != null) {
			...
			case "editTableFields":
				return null;
			case "showFieldList":
				haxe_Log.trace(Std.string(this.state.dataTable[29].h["id"]) + "<<<",{ fileName : "src/view/dashboard/DB.hx", lineNumber : 266, className : "view.dashboard.DB", methodName : "renderResults"});
	...
	,render: function() {
		if(this.state.values != null) {
			haxe_Log.trace(this.state.values == null ? "null" : haxe_ds_StringMap.stringify(this.state.values.h),{ fileName : "src/view/dashboard/DB.hx", lineNumber : 283, className : "view.dashboard.DB", methodName : "render"});
		}
...
var view_dashboard_DBSync = function(props) {
	...
	haxe_Log.trace("..." + Std.string(Reflect.fields(props)),{ fileName : "src/view/dashboard/DBSync.hx", lineNumber : 76, className : "view.dashboard.DBSync", methodName : "new"});
	...
	haxe_Log.trace(this.state.loading,{ fileName : "src/view/dashboard/DBSync.hx", lineNumber : 89, className : "view.dashboard.DBSync", methodName : "new"});
};
...
view_dashboard_DBSync.prototype = $extend(React_Component.prototype,{
	...
	,dbMetaData: null
	,createFieldList: function(ev) {
		haxe_Log.trace("hi :)",{ fileName : "src/view/dashboard/DBSync.hx", lineNumber : 109, className : "view.dashboard.DBSync", methodName : "createFieldList"});
	}
	,editTableFields: function(ev) {
		haxe_Log.trace(this.state.selectedRows.length,{ fileName : "src/view/dashboard/DBSync.hx", lineNumber : 137, className : "view.dashboard.DBSync", methodName : "editTableFields"});
	}
	,initStateFromDataTable: function(dt) {
		var iS = { };
		var _g = 0;
		while(_g < dt.length) {
			...
			while(k.hasNext()) {
				var k1 = k.next();
				haxe_Log.trace(k1,{ fileName : "src/view/dashboard/DBSync.hx", lineNumber : 148, className : "view.dashboard.DBSync", methodName : "initStateFromDataTable"});
		...
		haxe_Log.trace(iS,{ fileName : "src/view/dashboard/DBSync.hx", lineNumber : 158, className : "view.dashboard.DBSync", methodName : "initStateFromDataTable"});
		return iS;
	}
	,saveTableFields: function(vA) {
		haxe_Log.trace(vA,{ fileName : "src/view/dashboard/DBSync.hx", lineNumber : 164, className : "view.dashboard.DBSync", methodName : "saveTableFields"});
	}
	,importAccounts: function(_) {
		haxe_Log.trace(this.props.userState.dbUser.first_name,{ fileName : "src/view/dashboard/DBSync.hx", lineNumber : 193, className : "view.dashboard.DBSync", methodName : "importAccounts"});
		this.setState({ loading : true});
		this.doSyncAll({ classPath : "admin.SyncExternalAccounts", action : "syncAll", extDB : true, filter : { mandator : "1"}, limit : 1000, offset : 0, table : "accounts", dbUser : this.props.userState.dbUser, devIP : App.devIP, maxImport : 4000});
	}
	,doSyncAll: function(dbQueryParam) {
		var _gthis = this;
		var p = this.props.load(dbQueryParam);
		p.then(function(data) {
			if(data.dataInfo.h["offset"] == null) {
			...
			var offset = Std.parseInt(data.dataInfo.h["offset"]);
			App.store.dispatch(redux_Action.map(action_AppAction.Status(action_StatusAction.Update({ cssClass : " ", text : "" + offset + " " + dbQueryParam.classPath + " von " + Std.string(data.dataInfo.h["maxImport"]) + " aktualisiert"}))));
			haxe_Log.trace("" + offset + " < " + Std.string(data.dataInfo.h["maxImport"]),{ fileName : "src/view/dashboard/DBSync.hx", lineNumber : 231, className : "view.dashboard.DBSync", methodName : "doSyncAll"});
			if(offset < data.dataInfo.h["maxImport"]) {
				haxe_Log.trace("next loop:" + (data.dataInfo == null ? "null" : haxe_ds_StringMap.stringify(data.dataInfo.h)),{ fileName : "src/view/dashboard/DBSync.hx", lineNumber : 234, className : "view.dashboard.DBSync", methodName : "doSyncAll"});
	...
	,importAll: function(_) {
		haxe_Log.trace(this.props.userState.dbUser.first_name,{ fileName : "src/view/dashboard/DBSync.hx", lineNumber : 254, className : "view.dashboard.DBSync", methodName : "importAll"});
		App.store.dispatch(action_async_LivePBXSync.syncAll({ limit : 1000, maxImport : 4000, userState : this.props.userState, offset : 0, classPath : "admin.SyncExternal", action : "syncAll"}));
	}
	,importAllBookingRequests: function(_) {
		haxe_Log.trace(this.props.userState.dbUser.first_name,{ fileName : "src/view/dashboard/DBSync.hx", lineNumber : 267, className : "view.dashboard.DBSync", methodName : "importAllBookingRequests"});
		App.store.dispatch(action_async_LivePBXSync.syncAll({ limit : 50000, maxImport : 50000, userState : this.props.userState, offset : 100000, table : "bank_transfers", classPath : "admin.SyncExternalBookings", action : "syncAll"}));
	}
	...
	,importContacts: function() {
		haxe_Log.trace(this.props.userState.dbUser.first_name,{ fileName : "src/view/dashboard/DBSync.hx", lineNumber : 306, className : "view.dashboard.DBSync", methodName : "importContacts"});
	...
	,syncUserList: function(_) {
		var _gthis = this;
		haxe_Log.trace(App.config.api,{ fileName : "src/view/dashboard/DBSync.hx", lineNumber : 356, className : "view.dashboard.DBSync", methodName : "syncUserList"});
		loader_BinaryLoader.create("" + Std.string(App.config.api),{ id : this.props.userState.dbUser.id, jwt : this.props.userState.dbUser.jwt, fields : "id,table_name,field_name,disabled,element,required,use_as_index", classPath : "admin.SyncExternal", action : "syncUserDetails", devIP : App.devIP},function(data) {
			haxe_Log.trace(data.dataRows.length,{ fileName : "src/view/dashboard/DBSync.hx", lineNumber : 372, className : "view.dashboard.DBSync", methodName : "syncUserList"});
			if(data.dataRows.length > 0) {
	...
	,proxy_showUserList: function(_) {
		var _gthis = this;
		haxe_Log.trace(App.config.api,{ fileName : "src/view/dashboard/DBSync.hx", lineNumber : 382, className : "view.dashboard.DBSync", methodName : "proxy_showUserList"});
		loader_BinaryLoader.create("https://pitverwaltung.de/sync/proxy.php",{ id : this.props.userState.dbUser.id, jwt : this.props.userState.dbUser.jwt, fields : "id,table_name,field_name,disabled,element,required,use_as_index", classPath : "admin.SyncExternal", action : "syncUserDetails", target : "syncUsers.php", devIP : App.devIP},function(data) {
			haxe_Log.trace(data.dataRows.length,{ fileName : "src/view/dashboard/DBSync.hx", lineNumber : 400, className : "view.dashboard.DBSync", methodName : "proxy_showUserList"});
			if(data.dataRows.length > 0) {
				_gthis.setState({ dataTable : data.dataRows});
			}
		});
	...
	,componentDidMount: function() {
		if(this.props.userState != null) {
			haxe_Log.trace("yeah: " + this.props.userState.dbUser.first_name,{ fileName : "src/view/dashboard/DBSync.hx", lineNumber : 417, className : "view.dashboard.DBSync", methodName : "componentDidMount"});
		}
	}
	,go: function(aState) {
		haxe_Log.trace(Reflect.fields(aState),{ fileName : "src/view/dashboard/DBSync.hx", lineNumber : 422, className : "view.dashboard.DBSync", methodName : "go"});
		...
		case "insert":
			...
			while(_g < _g1.length) {
				var f = _g1[_g];
				++_g;
				haxe_Log.trace("" + f + " =>" + Std.string(Reflect.field(aState,f)) + "<=",{ fileName : "src/view/dashboard/DBSync.hx", lineNumber : 436, className : "view.dashboard.DBSync", methodName : "go"});
	...
	,render: function() {
		haxe_Log.trace(this.props.match.params.section,{ fileName : "src/view/dashboard/DBSync.hx", lineNumber : 456, className : "view.dashboard.DBSync", methodName : "render"});
		var tmp = this.state.formApi;
		var tmp1 = react_ReactType.fromComp(React_Fragment);
		var tmp2 = react_ReactType.fromString("form");
		var tmp3 = this.renderResults();
	...
	,renderResults: function() {
		haxe_Log.trace(this.props.match.params.action + ":" + Std.string(this.state.dataTable != null),{ fileName : "src/view/dashboard/DBSync.hx", lineNumber : 467, className : "view.dashboard.DBSync", methodName : "renderResults"});
		haxe_Log.trace(this.state.loading,{ fileName : "src/view/dashboard/DBSync.hx", lineNumber : 468, className : "view.dashboard.DBSync", methodName : "renderResults"});
		if(this.state.loading) {
			return this.state.formApi.renderWait();
		}
		haxe_Log.trace("###########loading:" + Std.string(this.state.loading),{ fileName : "src/view/dashboard/DBSync.hx", lineNumber : 471, className : "view.dashboard.DBSync", methodName : "renderResults"});
		switch(this.props.match.params.action) {
		case "importClientList":
			haxe_Log.trace(this.state.actualState,{ fileName : "src/view/dashboard/DBSync.hx", lineNumber : 482, className : "view.dashboard.DBSync", methodName : "renderResults"});
			if(this.state.actualState == null) {
				return this.state.formApi.renderWait();
			} else {
				return this.state.formBuilder.renderForm({ mHandlers : this.state.mHandlers, fields : this.formFields, model : "importClientList", title : "Stammdaten Import"},this.state.actualState);
	...
	,updateMenu: function(viewClassPath) {
		var sideMenu = this.state.sideMenu;
		haxe_Log.trace(sideMenu.section,{ fileName : "src/view/dashboard/DBSync.hx", lineNumber : 516, className : "view.dashboard.DBSync", methodName : "updateMenu"});
		var _g = 0;
...
view_dashboard_Roles.prototype = $extend(React_Component.prototype,{
	...
	,render: function() {
		...
		if(sM.menuBlocks != null) {
			haxe_Log.trace(haxe_ds_StringMap.keysIterator(sM.menuBlocks.h).next() + ":" + this.props.match.params.section,{ fileName : "src/view/dashboard/Roles.hx", lineNumber : 168, className : "view.dashboard.Roles", methodName : "render"});
		}
		var tmp = react_ReactType.fromString("div");
...
var view_dashboard_Setup = function(props) {
	...
	this.state = App.initEState({ sideMenu : view_shared_io_FormApi.initSideMenu2(this,[{ dataClassPath : "tools.DB", label : "DB Design", section : "DB", items : view_dashboard_DB.menuItems},{ dataClassPath : "admin.SyncExternal", label : "DB Abgleich", section : "DBSync", items : view_dashboard_DBSync.menuItems}],{ section : props.match.params.section == null ? "DBSync" : props.match.params.section, sameWidth : true})},this);
...
var view_data_Accounts = function(props) {
	React_Component.call(this,props);
	haxe_Log.trace(Reflect.fields(props),{ fileName : "src/view/data/Accounts.hx", lineNumber : 41, className : "view.data.Accounts", methodName : "new"});
	haxe_Log.trace(props.match.params.section,{ fileName : "src/view/data/Accounts.hx", lineNumber : 42, className : "view.data.Accounts", methodName : "new"});
	...
	haxe_Log.trace(Reflect.fields(props),{ fileName : "src/view/data/Accounts.hx", lineNumber : 69, className : "view.data.Accounts", methodName : "new"});
};
...
view_data_Accounts.prototype = $extend(React_Component.prototype,{
	componentDidCatch: function(error,info) {
		...
		haxe_Log.trace(error,{ fileName : "src/view/data/Accounts.hx", lineNumber : 91, className : "view.data.Accounts", methodName : "componentDidCatch"});
	}
	,componentDidMount: function() {
		this.setState({ mounted : true});
		if(this.props.match.params.section == null) {
			...
			haxe_Log.trace(this.props.history.location.pathname,{ fileName : "src/view/data/Accounts.hx", lineNumber : 102, className : "view.data.Accounts", methodName : "componentDidMount"});
			haxe_Log.trace("setting section to:List",{ fileName : "src/view/data/Accounts.hx", lineNumber : 103, className : "view.data.Accounts", methodName : "componentDidMount"});
		}
		haxe_Log.trace("",{ fileName : "src/view/data/Accounts.hx", lineNumber : 105, className : "view.data.Accounts", methodName : "componentDidMount"});
	}
	,render: function() {
		haxe_Log.trace(this.props.match.params.section,{ fileName : "src/view/data/Accounts.hx", lineNumber : 128, className : "view.data.Accounts", methodName : "render"});
		switch(this.props.match.params.section) {
		case "Edit":
...
var view_data_Contacts = function(props) {
	...
	if(this._trace) {
		haxe_Log.trace("..." + Std.string(Reflect.fields(props)),{ fileName : "src/view/data/Contacts.hx", lineNumber : 75, className : "view.data.Contacts", methodName : "new"});
	}
	if(this._trace) {
		haxe_Log.trace(props.match.params,{ fileName : "src/view/data/Contacts.hx", lineNumber : 76, className : "view.data.Contacts", methodName : "new"});
	}
	...
	if(props.match.params.section == null) {
		...
		if(props.dataStore.contactData.iterator().hasNext()) {
			if(this._trace) {
				haxe_Log.trace(shared_Utils.keysList(props.dataStore.contactData.keys()),{ fileName : "src/view/data/Contacts.hx", lineNumber : 87, className : "view.data.Contacts", methodName : "new"});
			}
		}
...
view_data_Contacts.mapDispatchToProps = function(dispatch) {
	if(view_data_Contacts._strace) {
		haxe_Log.trace("ok",{ fileName : "src/view/data/Contacts.hx", lineNumber : 114, className : "view.data.Contacts", methodName : "mapDispatchToProps"});
	}
	return { storeData : function(id,action) {
		...
		if(view_data_Contacts._strace) {
			haxe_Log.trace("select:" + id + " selectType:" + selectType,{ fileName : "src/view/data/Contacts.hx", lineNumber : 127, className : "view.data.Contacts", methodName : "mapDispatchToProps"});
		}
		dispatch(redux_Action.map(action_async_LiveDataAccess.select({ id : id, data : data, match : match, selectType : selectType})));
	}};
};
view_data_Contacts.mapStateToProps = function(aState) {
	if(view_data_Contacts._strace) {
		haxe_Log.trace(Reflect.fields(aState),{ fileName : "src/view/data/Contacts.hx", lineNumber : 137, className : "view.data.Contacts", methodName : "mapStateToProps"});
	}
	if(aState.dataStore.contactData != null) {
		if(view_data_Contacts._strace) {
			haxe_Log.trace(aState.dataStore.contactData.keys().next(),{ fileName : "src/view/data/Contacts.hx", lineNumber : 139, className : "view.data.Contacts", methodName : "mapStateToProps"});
		}
	}
	if(aState.dataStore.contactsDbData != null) {
		if(view_data_Contacts._strace) {
			var tmp = aState.dataStore.contactsDbData.dataRows[0];
			haxe_Log.trace(tmp == null ? "null" : haxe_ds_StringMap.stringify(tmp.h),{ fileName : "src/view/data/Contacts.hx", lineNumber : 141, className : "view.data.Contacts", methodName : "mapStateToProps"});
		} else {
			if(view_data_Contacts._strace) {
				haxe_Log.trace(aState.dataStore,{ fileName : "src/view/data/Contacts.hx", lineNumber : 144, className : "view.data.Contacts", methodName : "mapStateToProps"});
			}
			if(view_data_Contacts._strace) {
				haxe_Log.trace(Reflect.fields(aState.dataStore),{ fileName : "src/view/data/Contacts.hx", lineNumber : 145, className : "view.data.Contacts", methodName : "mapStateToProps"});
			}
		}
	}
	if(view_data_Contacts._strace) {
		haxe_Log.trace(App.store.getState().dataStore.contactsDbData,{ fileName : "src/view/data/Contacts.hx", lineNumber : 147, className : "view.data.Contacts", methodName : "mapStateToProps"});
	}
	var bState = { dataStore : aState.dataStore, userState : aState.userState};
	if(view_data_Contacts._strace) {
		haxe_Log.trace(bState.dataStore.contactData,{ fileName : "src/view/data/Contacts.hx", lineNumber : 154, className : "view.data.Contacts", methodName : "mapStateToProps"});
	}
	return bState;
};
...
view_data_Contacts.prototype = $extend(React_Component.prototype,{
	...
	,componentDidCatch: function(error,info) {
		try {
			...
			var ex = haxe_Exception.caught(_g).unwrap();
			if(this._trace) {
				haxe_Log.trace(ex,{ fileName : "src/view/data/Contacts.hx", lineNumber : 106, className : "view.data.Contacts", methodName : "componentDidCatch"});
			}
		}
		if(this._trace) {
			haxe_Log.trace(error,{ fileName : "src/view/data/Contacts.hx", lineNumber : 108, className : "view.data.Contacts", methodName : "componentDidCatch"});
		}
		me_cunity_debug_Out.dumpStack(haxe_CallStack.callStack(),{ fileName : "src/view/data/Contacts.hx", lineNumber : 109, className : "view.data.Contacts", methodName : "componentDidCatch"});
	}
	,componentDidMount: function() {
		if(this._trace) {
			haxe_Log.trace(this.props.location.pathname,{ fileName : "src/view/data/Contacts.hx", lineNumber : 160, className : "view.data.Contacts", methodName : "componentDidMount"});
		}
	}
	,render: function() {
		if(this._trace) {
			haxe_Log.trace(this.props.match.params.section,{ fileName : "src/view/data/Contacts.hx", lineNumber : 170, className : "view.data.Contacts", methodName : "render"});
		}
		if(this._trace) {
			haxe_Log.trace(this.props.match.params.action,{ fileName : "src/view/data/Contacts.hx", lineNumber : 171, className : "view.data.Contacts", methodName : "render"});
		}
		switch(this.props.match.params.section) {
		case "Edit":
...
var view_data_Deals = function(props) {
	...
	this.state = { clean : true, hasError : false, mounted : false, loading : true, sideMenu : view_shared_io_FormApi.initSideMenu2(this,[{ dataClassPath : "data.deals.List", label : "Abschlüsse", section : "List", items : view_data_deals_List.menuItems},{ dataClassPath : "data.deals.Edit", label : "Abschlüsse", section : "Edit", items : view_data_deals_Edit.menuItems}],{ section : props.match.params.section == null ? "List" : props.match.params.section, sameWidth : true})};
...
view_data_QC.mapDispatchToProps = function(dispatch) {
	...
	return { storeData : function(id,action) {
		...
		haxe_Log.trace("select:" + id + " selectType:" + selectType,{ fileName : "src/view/data/QC.hx", lineNumber : 118, className : "view.data.QC", methodName : "mapDispatchToProps"});
		dispatch(redux_Action.map(action_async_LiveDataAccess.select({ id : id, data : data, match : match, selectType : selectType})));
...
view_data_QC.mapStateToProps = function(aState) {
	haxe_Log.trace(Reflect.fields(aState),{ fileName : "src/view/data/QC.hx", lineNumber : 139, className : "view.data.QC", methodName : "mapStateToProps"});
	if(aState.dataStore.contactData != null) {
		haxe_Log.trace(aState.dataStore.contactData.keys().next(),{ fileName : "src/view/data/QC.hx", lineNumber : 141, className : "view.data.QC", methodName : "mapStateToProps"});
	}
	if(aState.dataStore.contactsDbData != null) {
		var tmp = aState.dataStore.contactsDbData.dataRows[0];
		haxe_Log.trace(tmp == null ? "null" : haxe_ds_StringMap.stringify(tmp.h),{ fileName : "src/view/data/QC.hx", lineNumber : 143, className : "view.data.QC", methodName : "mapStateToProps"});
	} else {
		haxe_Log.trace(aState.dataStore,{ fileName : "src/view/data/QC.hx", lineNumber : 146, className : "view.data.QC", methodName : "mapStateToProps"});
		haxe_Log.trace(Reflect.fields(aState.dataStore),{ fileName : "src/view/data/QC.hx", lineNumber : 147, className : "view.data.QC", methodName : "mapStateToProps"});
	}
	haxe_Log.trace(App.store.getState().dataStore.contactsDbData,{ fileName : "src/view/data/QC.hx", lineNumber : 149, className : "view.data.QC", methodName : "mapStateToProps"});
	var bState = { dataStore : aState.dataStore, userState : aState.userState};
	haxe_Log.trace(bState.dataStore.contactData,{ fileName : "src/view/data/QC.hx", lineNumber : 156, className : "view.data.QC", methodName : "mapStateToProps"});
	return bState;
};
...
view_data_QC.prototype = $extend(React_Component.prototype,{
	...
	,componentDidMount: function() {
		haxe_Log.trace(this.props.location.pathname,{ fileName : "src/view/data/QC.hx", lineNumber : 162, className : "view.data.QC", methodName : "componentDidMount"});
	}
	,render: function() {
		haxe_Log.trace(this.props.match.params.section,{ fileName : "src/view/data/QC.hx", lineNumber : 172, className : "view.data.QC", methodName : "render"});
		haxe_Log.trace(this.props.match.params.action,{ fileName : "src/view/data/QC.hx", lineNumber : 173, className : "view.data.QC", methodName : "render"});
		switch(this.props.match.params.section) {
		case "Edit":
			return React.createElement(view_data_contacts_Edit._renderWrapper,Object.assign({ },this.props,{ parentComponent : this, formApi : this.state.formApi, fullWidth : true, sideMenu : this.state.sideMenu}));
		case "List":
...
var view_data_accounts_Edit = function(props) {
	...
	if(props.match.params.id == null && new EReg("edit(/)*$","").match(props.match.params.action)) {
		haxe_Log.trace("nothing selected - redirect",{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 80, className : "view.data.accounts.Edit", methodName : "new"});
		var baseUrl = props.match.path.split(":section")[0];
		props.history.push("" + baseUrl + "List/get");
		return;
	}
	...
	haxe_Log.trace(props.dataStore.contactActData,{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 97, className : "view.data.accounts.Edit", methodName : "new"});
	haxe_Log.trace(props.dataStore.contactData,{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 98, className : "view.data.accounts.Edit", methodName : "new"});
	if(this.initialState.id != null && props.dataStore.contactData.h.hasOwnProperty(this.initialState.id)) {
		this.initialState = this.loadContactData(this.initialState.id);
		haxe_Log.trace(this.actualState,{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 103, className : "view.data.accounts.Edit", methodName : "new"});
		this.actualState = view_shared_io_Observer.run(this.actualState,function(newState) {
			_gthis.actualState = newState;
			haxe_Log.trace(_gthis.actualState,{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 107, className : "view.data.accounts.Edit", methodName : "new"});
		});
	} else {
		haxe_Log.trace(this.actualState,{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 112, className : "view.data.accounts.Edit", methodName : "new"});
	}
	this.state = App.initEState({ dataTable : [], formBuilder : new view_shared_FormBuilder(this), initialState : this.initialState, loading : false, selectedRows : [], sideMenu : view_shared_io_FormApi.initSideMenu(this,{ dataClassPath : "data.Contacts", label : "Bearbeiten", section : "Edit", items : view_data_accounts_Edit.menuItems},{ section : props.match.params.section == null ? "Edit" : props.match.params.section, sameWidth : true}), values : new haxe_ds_StringMap()},this);
	haxe_Log.trace(this.state.initialState.id,{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 137, className : "view.data.accounts.Edit", methodName : "new"});
};
...
view_data_accounts_Edit.mapStateToProps = function(aState) {
	haxe_Log.trace(aState,{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 162, className : "view.data.accounts.Edit", methodName : "mapStateToProps"});
	return { userState : aState.userState};
};
...
view_data_accounts_Edit.prototype = $extend(React_Component.prototype,{
	...
	,loadContactData: function(id) {
		haxe_Log.trace("loading:" + id,{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 142, className : "view.data.accounts.Edit", methodName : "loadContactData"});
		return null;
	}
	,'delete': function(ev) {
		haxe_Log.trace(this.state.selectedRows.length,{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 170, className : "view.data.accounts.Edit", methodName : "delete"});
		var data = this.state.formApi.selectedRowsMap(this.state);
	}
	,componentDidMount: function() {
		var _gthis = this;
		...
		if(sessContacts != null) {
			haxe_Log.trace(JSON.parse(sessContacts),{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 180, className : "view.data.accounts.Edit", methodName : "componentDidMount"});
			this.actualState = JSON.parse(sessContacts);
			haxe_Log.trace(this.actualState,{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 182, className : "view.data.accounts.Edit", methodName : "componentDidMount"});
			this.forceUpdate();
		} else if(this.initialState.id != null && !App.store.getState().dataStore.contactData.h.hasOwnProperty(this.initialState.id)) {
			App.store.dispatch(redux_Action.map(action_async_DBAccess.get({ action : "get", classPath : "data.Contacts", table : "contacts", filter : "id|" + Std.string(this.initialState.id), userState : App.store.getState().userState})));
		} else if(this.actualState == null) {
			this.actualState = react_ReactUtil.copy(this.initialState);
			this.actualState = view_shared_io_Observer.run(this.actualState,function(newState) {
				_gthis.actualState = newState;
				haxe_Log.trace(_gthis.actualState,{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 204, className : "view.data.accounts.Edit", methodName : "componentDidMount"});
			});
		}
		if(react_ReactRef.get_current(this.formRef) != null) {
			...
			react_ReactRef.get_current(this.formRef).addEventListener("mouseup",function(ev) {
				haxe_Log.trace(ev.target.value,{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 216, className : "view.data.accounts.Edit", methodName : "componentDidMount"});
			});
		}
	}
	,shouldComponentUpdate: function(nextProps,nextState) {
		haxe_Log.trace("propsChanged:" + Std.string(nextProps != this.props),{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 223, className : "view.data.accounts.Edit", methodName : "shouldComponentUpdate"});
		haxe_Log.trace("stateChanged:" + Std.string(nextState != this.state),{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 224, className : "view.data.accounts.Edit", methodName : "shouldComponentUpdate"});
	...
	,componentWillUnmount: function() {
		...
		_g.h[key] = _g1;
		var actData = _g;
		haxe_Log.trace(actData,{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 244, className : "view.data.accounts.Edit", methodName : "componentWillUnmount"});
		App.store.dispatch(redux_Action.map(action_DataAction.SelectActContacts(actData)));
	}
	,sessionStore: function() {
		haxe_Log.trace(this.actualState,{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 249, className : "view.data.accounts.Edit", methodName : "sessionStore"});
	...
	,doChange: function(name,value) {
		haxe_Log.trace("" + name + ": " + value,{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 255, className : "view.data.accounts.Edit", methodName : "doChange"});
		if(name != null && name != "") {
	...
	,handleChange: function(e) {
		...
		if(el.name != "" && el.name != null) {
			haxe_Log.trace(">>" + Std.string(el.name) + "=>" + Std.string(el.value) + "<<",{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 268, className : "view.data.accounts.Edit", methodName : "handleChange"});
			this.actualState[el.name] = el.value;
			haxe_Log.trace(this.actualState.last_name,{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 271, className : "view.data.accounts.Edit", methodName : "handleChange"});
		}
	}
	,mHandlers: function(event) {
		event.preventDefault();
		haxe_Log.trace(this.state.initialState.id,{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 286, className : "view.data.accounts.Edit", methodName : "mHandlers"});
		...
		while(k.hasNext()) {
			...
			try {
				...
				haxe_Log.trace(ex,{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 321, className : "view.data.accounts.Edit", methodName : "mHandlers"});
			}
		}
		haxe_Log.trace(this.actualState,{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 325, className : "view.data.accounts.Edit", methodName : "mHandlers"});
		this.go(this.actualState);
	}
	,go: function(aState) {
		haxe_Log.trace(Reflect.fields(aState),{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 332, className : "view.data.accounts.Edit", methodName : "go"});
		var dbaProps = { action : this.props.match.params.action, classPath : "data.Contacts", dataSource : null, table : "contacts", userState : this.props.userState};
		switch(this.props.match.params.action) {
		case "delete":case "get":
			var _g = new haxe_ds_StringMap();
			var _g1 = new haxe_ds_StringMap();
		...
		case "insert":
			...
			while(_g < _g1.length) {
				var f = _g1[_g];
				++_g;
				haxe_Log.trace("" + f + " =>" + Std.string(Reflect.field(aState,f)) + "<=",{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 346, className : "view.data.accounts.Edit", methodName : "go"});
				if(Reflect.field(aState,f) == "") {
					Reflect.deleteField(aState,f);
				}
			}
	...
	,renderResults: function() {
		haxe_Log.trace(this.props.match.params.section + "/" + this.props.match.params.action + " state.dataTable:" + Std.string(this.state.dataTable != null),{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 386, className : "view.data.accounts.Edit", methodName : "renderResults"});
		haxe_Log.trace("########### action:" + this.props.match.params.action,{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 388, className : "view.data.accounts.Edit", methodName : "renderResults"});
		switch(this.props.match.params.action) {
		case "insert":
			haxe_Log.trace(this.actualState,{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 410, className : "view.data.accounts.Edit", methodName : "renderResults"});
			...
			return tmp.renderForm({ mHandlers : tmp1, fields : _g, model : "contact", ref : this.formRef, title : "Kontakt - Neue Stammdaten"},this.actualState);
		case "update":
			haxe_Log.trace(this.actualState,{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 394, className : "view.data.accounts.Edit", methodName : "renderResults"});
			if(this.actualState == null) {
				...
				return tmp.renderForm({ mHandlers : tmp1, fields : _g, model : "contact", ref : this.formRef, title : "Kontakt - Bearbeite Stammdaten"},this.actualState);
			}
			break;
		default:
			return null;
	...
	,render: function() {
		haxe_Log.trace(this.props.match.params.action,{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 427, className : "view.data.accounts.Edit", methodName : "render"});
		switch(this.props.match.params.action) {
		case "insert":
	...
	,updateMenu: function(viewClassPath) {
		var sideMenu = this.state.sideMenu;
		haxe_Log.trace(sideMenu.section,{ fileName : "src/view/data/accounts/Edit.hx", lineNumber : 450, className : "view.data.accounts.Edit", methodName : "updateMenu"});
		var _g = 0;
...
var view_data_accounts_List = function(props) {
	...
	haxe_Log.trace("..." + Std.string(Reflect.fields(props)),{ fileName : "src/view/data/accounts/List.hx", lineNumber : 47, className : "view.data.accounts.List", methodName : "new"});
	...
	haxe_Log.trace(this.state.loading,{ fileName : "src/view/data/accounts/List.hx", lineNumber : 67, className : "view.data.accounts.List", methodName : "new"});
	if(props.match.params.action == null) {
		var baseUrl = props.match.path.split(":section")[0];
		haxe_Log.trace("redirecting to " + baseUrl + "List/get",{ fileName : "src/view/data/accounts/List.hx", lineNumber : 72, className : "view.data.accounts.List", methodName : "new"});
		props.history.push("" + baseUrl + "List/get");
		this.get(null);
	} else {
		haxe_Log.trace(props.match.params,{ fileName : "src/view/data/accounts/List.hx", lineNumber : 79, className : "view.data.accounts.List", methodName : "new"});
	}
	haxe_Log.trace(this.state.loading,{ fileName : "src/view/data/accounts/List.hx", lineNumber : 81, className : "view.data.accounts.List", methodName : "new"});
};
...
view_data_accounts_List.mapStateToProps = function(aState) {
	haxe_Log.trace(aState.userState,{ fileName : "src/view/data/accounts/List.hx", lineNumber : 92, className : "view.data.accounts.List", methodName : "mapStateToProps"});
	return { userState : aState.userState};
};
...
view_data_accounts_List.prototype = $extend(React_Component.prototype,{
	...
	,dbMetaData: null
	,'delete': function(ev) {
		haxe_Log.trace(this.state.selectedRows.length,{ fileName : "src/view/data/accounts/List.hx", lineNumber : 100, className : "view.data.accounts.List", methodName : "delete"});
		var data = this.state.formApi.selectedRowsMap(this.state);
	}
	,get: function(ev) {
		var _gthis = this;
		haxe_Log.trace("hi :)",{ fileName : "src/view/data/accounts/List.hx", lineNumber : 106, className : "view.data.accounts.List", methodName : "get"});
		var offset = 0;
		this.setState({ loading : true});
		if(ev != null && ev.page != null) {
			offset = this.props.limit * ev.page | 0;
		}
		haxe_Log.trace(this.props.userState,{ fileName : "src/view/data/accounts/List.hx", lineNumber : 114, className : "view.data.accounts.List", methodName : "get"});
		...
		p.then(function(data) {
			haxe_Log.trace(data.dataRows.length,{ fileName : "src/view/data/accounts/List.hx", lineNumber : 128, className : "view.data.accounts.List", methodName : "get"});
			_gthis.setState({ loading : false, dataTable : data.dataRows});
		});
	}
	,edit: function(ev) {
		haxe_Log.trace(this.state.selectedRows.length,{ fileName : "src/view/data/accounts/List.hx", lineNumber : 135, className : "view.data.accounts.List", methodName : "edit"});
	}
	,initStateFromDataTable: function(dt) {
		var iS = { };
		var _g = 0;
		while(_g < dt.length) {
			...
			while(k.hasNext()) {
				var k1 = k.next();
				haxe_Log.trace(k1,{ fileName : "src/view/data/accounts/List.hx", lineNumber : 146, className : "view.data.accounts.List", methodName : "initStateFromDataTable"});
		...
		haxe_Log.trace(iS,{ fileName : "src/view/data/accounts/List.hx", lineNumber : 156, className : "view.data.accounts.List", methodName : "initStateFromDataTable"});
		return iS;
	}
	,componentDidMount: function() {
		var _g = new haxe_ds_StringMap();
	...
	,renderResults: function() {
		haxe_Log.trace(this.props.match.params.section + ":" + Std.string(this.state.dataTable != null),{ fileName : "src/view/data/accounts/List.hx", lineNumber : 186, className : "view.data.accounts.List", methodName : "renderResults"});
		haxe_Log.trace(this.state.loading,{ fileName : "src/view/data/accounts/List.hx", lineNumber : 188, className : "view.data.accounts.List", methodName : "renderResults"});
		if(this.state.loading) {
			return this.state.formApi.renderWait();
		}
		haxe_Log.trace("###########loading:" + Std.string(this.state.loading),{ fileName : "src/view/data/accounts/List.hx", lineNumber : 191, className : "view.data.accounts.List", methodName : "renderResults"});
		switch(this.props.match.params.action) {
		case "delete":
			return null;
		case "get":
			return React.createElement(react_ReactType.fromComp(view_table_Table),Object.assign({ },this.props,{ id : "fieldsList", data : this.state.dataTable, dataState : this.dataDisplay.h["accountsList"], renderPager : ($_=this.baseForm,$bind($_,$_.renderPager)), parentComponent : this, className : "is-striped is-hoverable", fullWidth : true}));
		case "insert":
			haxe_Log.trace(this.dataDisplay.h["fieldsList"],{ fileName : "src/view/data/accounts/List.hx", lineNumber : 207, className : "view.data.accounts.List", methodName : "renderResults"});
			haxe_Log.trace(Std.string(this.state.dataTable[29].h["id"]) + "<<<",{ fileName : "src/view/data/accounts/List.hx", lineNumber : 208, className : "view.data.accounts.List", methodName : "renderResults"});
			return React.createElement(react_ReactType.fromComp(view_table_Table),Object.assign({ },this.props,{ id : "fieldsList", data : this.state.dataTable, dataState : this.dataDisplay.h["fieldsList"], className : "is-striped is-hoverable", fullWidth : true}));
		case "update":
			return React.createElement(react_ReactType.fromComp(view_table_Table),Object.assign({ },this.props,{ id : "fieldsList", data : this.state.dataTable, dataState : this.dataDisplay.h["clientList"], className : "is-striped is-hoverable", fullWidth : true}));
		default:
			return null;
		}
	}
	,render: function() {
		haxe_Log.trace(this.props.match.params.section,{ fileName : "src/view/data/accounts/List.hx", lineNumber : 225, className : "view.data.accounts.List", methodName : "render"});
		var tmp = this.state.formApi;
		var tmp1 = react_ReactType.fromComp(React_Fragment);
		var tmp2 = react_ReactType.fromString("form");
		var tmp3 = this.renderResults();
	...
	,updateMenu: function(viewClassPath) {
		var sideMenu = this.state.sideMenu;
		haxe_Log.trace(sideMenu.section,{ fileName : "src/view/data/accounts/List.hx", lineNumber : 237, className : "view.data.accounts.List", methodName : "updateMenu"});
		var _g = 0;
		var _g1 = sideMenu.menuBlocks.h["Contact"].items;
		while(_g < _g1.length) {
			var mI = _g1[_g];
...
var view_data_contacts_Edit = function(props) {
	...
	React_Component.call(this,props);
	this.baseForm = new view_shared_io_BaseForm(this);
	haxe_Log.trace(props.match.params,{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 91, className : "view.data.contacts.Edit", methodName : "new"});
	if(props.match.params.id == null && new EReg("open(/)*$","").match(props.match.params.action)) {
		haxe_Log.trace("nothing selected - redirect",{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 96, className : "view.data.contacts.Edit", methodName : "new"});
		var baseUrl = props.match.path.split(":section")[0];
		props.history.push("" + baseUrl + "List/get");
		return;
	}
	this.dataAccess = model_contacts_ContactsModel.dataAccess;
	this.fieldNames = this.baseForm.initFieldNames(haxe_ds_StringMap.keysIterator(this.dataAccess.h["open"].view.h));
	this.dataDisplay = model_contacts_ContactsModel.dataDisplay;
	if(props.dataStore.contactData != null) {
		haxe_Log.trace(props.dataStore.contactData.keys().next(),{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 106, className : "view.data.contacts.Edit", methodName : "new"});
	}
	this.state = App.initEState({ actualState : null, initialData : null, loading : false, mHandlers : view_data_contacts_Edit.menuItems, selectedRows : [], sideMenu : view_shared_io_FormApi.initSideMenu(this,{ dataClassPath : "data.Contacts", label : "Bearbeiten", section : "Edit", items : view_data_contacts_Edit.menuItems},{ section : props.match.params.section == null ? "Edit" : props.match.params.section, sameWidth : true}), values : new haxe_ds_StringMap()},this);
	haxe_Log.trace(this.state.initialData,{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 132, className : "view.data.contacts.Edit", methodName : "new"});
};
...
view_data_contacts_Edit.mapDispatchToProps = function(dispatch) {
	haxe_Log.trace("here we should be ready to load",{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 469, className : "view.data.contacts.Edit", methodName : "mapDispatchToProps"});
	return { load : function(param) {
		return dispatch(redux_Action.map(action_async_CRUD.read(param)));
	}};
};
...
view_data_contacts_Edit.prototype = $extend(React_Component.prototype,{
	...
	,loadContactData: function(id) {
		var _gthis = this;
		haxe_Log.trace("loading:" + id,{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 145, className : "view.data.contacts.Edit", methodName : "loadContactData"});
		if(id == null) {
			return;
		}
		...
		p.then(function(data) {
			haxe_Log.trace(data.dataRows.length,{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 163, className : "view.data.contacts.Edit", methodName : "loadContactData"});
			if(data.dataRows.length == 1) {
				var data1 = data.dataRows[0];
				haxe_Log.trace(data1 == null ? "null" : haxe_ds_StringMap.stringify(data1.h),{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 167, className : "view.data.contacts.Edit", methodName : "loadContactData"});
				var contact = new model_Contact(data1);
				haxe_Log.trace(contact.id,{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 170, className : "view.data.contacts.Edit", methodName : "loadContactData"});
				_gthis.setState({ loading : false, actualState : contact, initialData : react_ReactUtil.copy(contact)});
				haxe_Log.trace(_gthis.state.actualState.id + ":" + _gthis.state.actualState.fieldsInitalized.join(","),{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 172, className : "view.data.contacts.Edit", methodName : "loadContactData"});
				haxe_Log.trace(_gthis.props.location.pathname + ":" + _gthis.state.actualState.date_of_birth,{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 174, className : "view.data.contacts.Edit", methodName : "loadContactData"});
	...
	,'delete': function(ev) {
		haxe_Log.trace(this.state.selectedRows.length,{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 190, className : "view.data.contacts.Edit", methodName : "delete"});
		var data = this.state.formApi.selectedRowsMap(this.state);
	}
	,update2: function() {
	...
	,componentDidMount: function() {
		haxe_Log.trace("mounted:" + Std.string(this.mounted),{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 202, className : "view.data.contacts.Edit", methodName : "componentDidMount"});
		this.mounted = true;
	...
	,mHandlers3: function(event) {
		event.preventDefault();
		var target = js_Boot.__cast(event.target , HTMLInputElement);
		haxe_Log.trace(target.value,{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 233, className : "view.data.contacts.Edit", methodName : "mHandlers3"});
		var dataSet = target.dataset;
		haxe_Log.trace(dataSet.action,{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 235, className : "view.data.contacts.Edit", methodName : "mHandlers3"});
		haxe_Log.trace(this.state.initialData.id,{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 240, className : "view.data.contacts.Edit", methodName : "mHandlers3"});
	}
	,update: function() {
		if(this.state.actualState != null) {
			haxe_Log.trace(this.state.actualState.fieldsModified.length,{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 290, className : "view.data.contacts.Edit", methodName : "update"});
		}
		...
		haxe_Log.trace(this.props.match.params.action,{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 320, className : "view.data.contacts.Edit", methodName : "update"});
		switch(this.props.match.params.action) {
		case "delete":case "get":
			var _g = new haxe_ds_StringMap();
			var _g1 = new haxe_ds_StringMap();
		...
		case "insert":
			...
			while(_g < _g1.length) {
				var f = _g1[_g];
				++_g;
				haxe_Log.trace("" + f + " =>" + Std.string(Reflect.field(aState,f)) + "<=",{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 327, className : "view.data.contacts.Edit", methodName : "update"});
				if(Reflect.field(aState,f) == "") {
					Reflect.deleteField(aState,f);
				}
			}
			break;
		case "update":
			haxe_Log.trace("" + Std.string(this.state.initialData.id) + " :: creation_date: " + Std.string(aState.creation_date) + " " + Std.string(this.state.initialData.creation_date),{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 347, className : "view.data.contacts.Edit", methodName : "update"});
			if(this.state.actualState != null) {
				haxe_Log.trace(Std.string(this.state.actualState.modified()) + (":" + Std.string(this.state.actualState.fieldsModified)),{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 351, className : "view.data.contacts.Edit", methodName : "update"});
			}
			haxe_Log.trace(this.state.actualState.id,{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 363, className : "view.data.contacts.Edit", methodName : "update"});
			if(!this.state.actualState.modified()) {
				haxe_Log.trace("nothing modified",{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 367, className : "view.data.contacts.Edit", methodName : "update"});
				return;
			}
			haxe_Log.trace(this.state.actualState.allModified(),{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 370, className : "view.data.contacts.Edit", methodName : "update"});
			var _g = new haxe_ds_StringMap();
			var _g1 = new haxe_ds_StringMap();
			...
			_g.h["contacts"] = _g1;
			dbaProps_dataSource = _g;
			haxe_Log.trace(dbaProps_dataSource.h["contacts"].h["filter"],{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 377, className : "view.data.contacts.Edit", methodName : "update"});
			break;
		}
		App.store.dispatch(redux_Action.map(action_async_CRUD.update(dbQ)));
	}
	,renderResults: function() {
		haxe_Log.trace(this.props.match.params.section + "/" + this.props.match.params.action + " state.dataTable:" + Std.string(this.state.actualState != null),{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 387, className : "view.data.contacts.Edit", methodName : "renderResults"});
		haxe_Log.trace("########### action:" + this.props.match.params.action,{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 389, className : "view.data.contacts.Edit", methodName : "renderResults"});
		switch(this.props.match.params.action) {
		case "insert":
			haxe_Log.trace(this.state.actualState,{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 411, className : "view.data.contacts.Edit", methodName : "renderResults"});
			var tmp = this.state.formBuilder;
			var tmp1 = this.state.mHandlers;
			var _g = new haxe_ds_StringMap();
			...
			return tmp.renderForm({ mHandlers : tmp1, fields : _g, model : "contact", ref : this.formRef, title : "Kontakt - Neue Stammdaten"},this.state.actualState);
		case "open":case "update":
			haxe_Log.trace(this.state.actualState.id,{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 395, className : "view.data.contacts.Edit", methodName : "renderResults"});
			if(this.state.actualState == null) {
				return this.state.formApi.renderWait();
			} else {
				var tmp = this.state.formBuilder;
				...
				return tmp.renderForm({ mHandlers : tmp1, fields : _g, model : "contact", ref : this.formRef, title : "Kontakt - Bearbeite Stammdaten"},this.state.actualState);
			}
			break;
		default:
			return null;
	...
	,render: function() {
		haxe_Log.trace(this.props.match.params.action,{ fileName : "src/view/data/contacts/Edit.hx", lineNumber : 428, className : "view.data.contacts.Edit", methodName : "render"});
...
var view_data_contacts_List = function(props) {
	...
	this.baseForm = new view_shared_io_BaseForm(this);
	this.dataDisplay = model_contacts_ContactsModel.dataDisplay;
	haxe_Log.trace("..." + Std.string(Reflect.fields(props)),{ fileName : "src/view/data/contacts/List.hx", lineNumber : 64, className : "view.data.contacts.List", methodName : "new"});
	this.state = App.initEState({ dataTable : [], loading : false, contactData : new haxe_ds_IntMap(), selectedRows : [], sideMenu : view_shared_io_FormApi.initSideMenu(this,{ dataClassPath : "data.Contacts", label : "Liste", section : "List", items : view_data_contacts_List.menuItems},{ section : props.match.params.section == null ? "List" : props.match.params.section, sameWidth : true}), values : new haxe_ds_StringMap()},this);
	if(props.match.params.section == null || props.match.params.action == null) {
		var baseUrl = props.match.path.split(":section")[0];
		haxe_Log.trace("redirecting to " + baseUrl + "List/get",{ fileName : "src/view/data/contacts/List.hx", lineNumber : 87, className : "view.data.contacts.List", methodName : "new"});
		props.history.push("" + baseUrl + "List/get");
		this.get(null);
	} else {
		haxe_Log.trace(props.match.params,{ fileName : "src/view/data/contacts/List.hx", lineNumber : 94, className : "view.data.contacts.List", methodName : "new"});
	}
	haxe_Log.trace(this.state.loading,{ fileName : "src/view/data/contacts/List.hx", lineNumber : 96, className : "view.data.contacts.List", methodName : "new"});
};
...
view_data_contacts_List.mapStateToProps = function(aState) {
	haxe_Log.trace("never",{ fileName : "src/view/data/contacts/List.hx", lineNumber : 101, className : "view.data.contacts.List", methodName : "mapStateToProps"});
	return { userState : aState.userState};
};
...
view_data_contacts_List.prototype = $extend(React_Component.prototype,{
	...
	,get: function(ev) {
		...
		haxe_Log.trace(this.props.userState,{ fileName : "src/view/data/contacts/List.hx", lineNumber : 121, className : "view.data.contacts.List", methodName : "get"});
	...
	,edit: function(ev) {
		haxe_Log.trace(this.state.selectedRows.length,{ fileName : "src/view/data/contacts/List.hx", lineNumber : 146, className : "view.data.contacts.List", methodName : "edit"});
		haxe_Log.trace(Reflect.fields(ev),{ fileName : "src/view/data/contacts/List.hx", lineNumber : 147, className : "view.data.contacts.List", methodName : "edit"});
	}
	,restore: function() {
		var _gthis = this;
		haxe_Log.trace(Reflect.fields(this.props.dataStore),{ fileName : "src/view/data/contacts/List.hx", lineNumber : 151, className : "view.data.contacts.List", methodName : "restore"});
		if(this.props.dataStore != null && this.props.dataStore.contactsDbData != null) {
			this.setState({ dataTable : this.props.dataStore.contactsDbData.dataRows, dataCount : Std.parseInt(this.props.dataStore.contactsDbData.dataInfo.h["count"]), pageCount : Math.ceil(Std.parseInt(this.props.dataStore.contactsDbData.dataInfo.h["count"]) / this.props.limit)},function() {
				haxe_Log.trace(_gthis.state.dataTable,{ fileName : "src/view/data/contacts/List.hx", lineNumber : 161, className : "view.data.contacts.List", methodName : "restore"});
	...
	,selectionClear: function() {
		...
		haxe_Log.trace(this.state.dataTable.length,{ fileName : "src/view/data/contacts/List.hx", lineNumber : 182, className : "view.data.contacts.List", methodName : "selectionClear"});
		this.props.select(0,null,match,"UnselectAll");
		var trs = window.document.querySelectorAll(".tabComponentForm tr");
		haxe_Log.trace(trs.length,{ fileName : "src/view/data/contacts/List.hx", lineNumber : 187, className : "view.data.contacts.List", methodName : "selectionClear"});
		var _g = 0;
		var _g1 = trs.length;
		while(_g < _g1) {
			var i = _g++;
			...
			if(tre.classList.contains("is-selected")) {
				haxe_Log.trace("unselect:" + tre.dataset.id,{ fileName : "src/view/data/contacts/List.hx", lineNumber : 191, className : "view.data.contacts.List", methodName : "selectionClear"});
	...
	,componentDidMount: function() {
		...
		this.dataAccess = _g;
		if(this.props.userState != null) {
			haxe_Log.trace("yeah: " + this.props.userState.dbUser.first_name,{ fileName : "src/view/data/contacts/List.hx", lineNumber : 210, className : "view.data.contacts.List", methodName : "componentDidMount"});
		}
		haxe_Log.trace(this.props.match.params.action,{ fileName : "src/view/data/contacts/List.hx", lineNumber : 211, className : "view.data.contacts.List", methodName : "componentDidMount"});
		this.state.formApi.doAction();
	}
	,renderResults: function() {
		haxe_Log.trace(this.props.match.params.section + (":" + this.props.match.params.action + "::") + Std.string(this.state.dataTable != null),{ fileName : "src/view/data/contacts/List.hx", lineNumber : 218, className : "view.data.contacts.List", methodName : "renderResults"});
		var pState = this.props.parentComponent.state;
		haxe_Log.trace(this.state.dataTable.length,{ fileName : "src/view/data/contacts/List.hx", lineNumber : 221, className : "view.data.contacts.List", methodName : "renderResults"});
		if(this.props.dataStore.contactsDbData != null) {
			var tmp = this.props.dataStore.contactsDbData.dataRows[0];
			haxe_Log.trace(tmp == null ? "null" : haxe_ds_StringMap.stringify(tmp.h),{ fileName : "src/view/data/contacts/List.hx", lineNumber : 223, className : "view.data.contacts.List", methodName : "renderResults"});
		} else {
			haxe_Log.trace(this.props.dataStore.contactsDbData,{ fileName : "src/view/data/contacts/List.hx", lineNumber : 224, className : "view.data.contacts.List", methodName : "renderResults"});
		}
		haxe_Log.trace(this.state.loading,{ fileName : "src/view/data/contacts/List.hx", lineNumber : 225, className : "view.data.contacts.List", methodName : "renderResults"});
		if(this.state.dataTable.length == 0) {
			return this.state.formApi.renderWait();
		}
		if(this.props.match.params.action == "get") {
			var tmp = react_ReactType.fromString("form");
			var tmp1 = react_ReactType.fromComp(view_table_Table);
			var tmp2 = Object.assign({ },this.props,{ id : "fieldsList", data : this.state.dataTable, parentComponent : this, dataState : this.dataDisplay.h["contactList"], renderPager : ($_=this.baseForm,$bind($_,$_.renderPager)), className : "is-striped is-hoverable", fullWidth : true});
			return React.createElement(tmp,{ className : "tabComponentForm"},React.createElement(tmp1,tmp2));
		} else {
			return null;
		}
	}
	,getCellData: function(cP) {
		haxe_Log.trace(cP,{ fileName : "src/view/data/contacts/List.hx", lineNumber : 246, className : "view.data.contacts.List", methodName : "getCellData"});
	}
	,render: function() {
		haxe_Log.trace(this.props.match.params.section,{ fileName : "src/view/data/contacts/List.hx", lineNumber : 253, className : "view.data.contacts.List", methodName : "render"});
		return this.state.formApi.render(this.renderResults());
	}
	,componentWillUnmount: function() {
		haxe_Log.trace("...",{ fileName : "src/view/data/contacts/List.hx", lineNumber : 260, className : "view.data.contacts.List", methodName : "componentWillUnmount"});
	}
	,updateMenu: function(viewClassPath) {
		var sideMenu = this.state.sideMenu;
		haxe_Log.trace(sideMenu.section,{ fileName : "src/view/data/contacts/List.hx", lineNumber : 266, className : "view.data.contacts.List", methodName : "updateMenu"});
		var _g = 0;
...
view_data_deals_Edit.prototype = $extend(React_Component.prototype,{
	...
	,update: function() {
		...
		haxe_Log.trace("" + this.props.match.params.action + ": " + Std.string(this.state.initialData.id) + " :: creation_date: " + Std.string(aState.creation_date) + " " + Std.string(this.state.initialData.creation_date),{ fileName : "src/view/data/deals/Edit.hx", lineNumber : 223, className : "view.data.deals.Edit", methodName : "update"});
		if(this.state.actualState != null) {
			haxe_Log.trace(Std.string(this.state.actualState.modified()) + (":" + Std.string(this.state.actualState.fieldsModified)),{ fileName : "src/view/data/deals/Edit.hx", lineNumber : 226, className : "view.data.deals.Edit", methodName : "update"});
		}
		haxe_Log.trace(this.state.actualState.id,{ fileName : "src/view/data/deals/Edit.hx", lineNumber : 229, className : "view.data.deals.Edit", methodName : "update"});
		if(!this.state.actualState.modified()) {
			...
			haxe_Log.trace("nothing modified",{ fileName : "src/view/data/deals/Edit.hx", lineNumber : 238, className : "view.data.deals.Edit", methodName : "update"});
			return;
		}
		haxe_Log.trace(this.state.actualState.allModified(),{ fileName : "src/view/data/deals/Edit.hx", lineNumber : 241, className : "view.data.deals.Edit", methodName : "update"});
		App.store.dispatch(redux_Action.map(action_async_CRUD.update(dbQ)));
	}
	,initStateFromDataTable: function(dt) {
		var iS = { };
		...
		while(_g < dt.length) {
			...
			while(k.hasNext()) {
				var k1 = k.next();
				haxe_Log.trace(k1,{ fileName : "src/view/data/deals/Edit.hx", lineNumber : 254, className : "view.data.deals.Edit", methodName : "initStateFromDataTable"});
				if(this.dataDisplay.h["fieldsList"].columns.h[k1].cellFormat == view_shared_Format.formatBool) {
					rS[k1] = dR.h[k1] == "Y";
				} else {
					rS[k1] = dR.h[k1];
		...
		haxe_Log.trace(iS,{ fileName : "src/view/data/deals/Edit.hx", lineNumber : 264, className : "view.data.deals.Edit", methodName : "initStateFromDataTable"});
		return iS;
	}
	,componentDidMount: function() {
		haxe_Log.trace("mounted:" + "true",{ fileName : "src/view/data/deals/Edit.hx", lineNumber : 270, className : "view.data.deals.Edit", methodName : "componentDidMount"});
		this.loadDealData(Std.parseInt(this.props.match.params.id));
	}
	,loadDealData: function(id) {
		var _gthis = this;
		haxe_Log.trace("loading:" + id,{ fileName : "src/view/data/deals/Edit.hx", lineNumber : 300, className : "view.data.deals.Edit", methodName : "loadDealData"});
		if(id == null) {
			return;
		}
		var p = this.props.load({ classPath : "data.Deals", action : "get", filter : { id : id, mandator : 1}, resolveMessage : { success : "Abschluß " + id + " wurde geladen", failure : "Abschluß " + id + " konnte nicht geladen werden"}, table : "deals", dbUser : this.props.userState.dbUser, devIP : App.devIP});
		p.then(function(data) {
			haxe_Log.trace(data.dataRows.length,{ fileName : "src/view/data/deals/Edit.hx", lineNumber : 318, className : "view.data.deals.Edit", methodName : "loadDealData"});
			if(data.dataRows.length == 1) {
				var data1 = data.dataRows[0];
				haxe_Log.trace(data1 == null ? "null" : haxe_ds_StringMap.stringify(data1.h),{ fileName : "src/view/data/deals/Edit.hx", lineNumber : 322, className : "view.data.deals.Edit", methodName : "loadDealData"});
				var deal = new model_Deal(data1);
				haxe_Log.trace(deal.id,{ fileName : "src/view/data/deals/Edit.hx", lineNumber : 325, className : "view.data.deals.Edit", methodName : "loadDealData"});
				_gthis.setState({ loading : false, actualState : deal, initialData : react_ReactUtil.copy(deal)});
				haxe_Log.trace(_gthis.state.actualState.id + ":" + _gthis.state.actualState.fieldsInitalized.join(","),{ fileName : "src/view/data/deals/Edit.hx", lineNumber : 327, className : "view.data.deals.Edit", methodName : "loadDealData"});
				haxe_Log.trace(_gthis.props.location.pathname + ":" + _gthis.state.actualState.amount,{ fileName : "src/view/data/deals/Edit.hx", lineNumber : 329, className : "view.data.deals.Edit", methodName : "loadDealData"});
				var _gthis1 = _gthis.props.history;
				var tmp = StringTools.replace(_gthis.props.location.pathname,"open","update");
				_gthis1.replace(tmp);
			}
	...
	,renderResults: function() {
		haxe_Log.trace(this.props.match.params.section + ":" + Std.string(this.state.dataTable != null),{ fileName : "src/view/data/deals/Edit.hx", lineNumber : 337, className : "view.data.deals.Edit", methodName : "renderResults"});
		haxe_Log.trace(Std.string(this.state.loading) + ":" + this.props.match.params.action,{ fileName : "src/view/data/deals/Edit.hx", lineNumber : 339, className : "view.data.deals.Edit", methodName : "renderResults"});
		if(this.state.loading) {
			return this.state.formApi.renderWait();
		}
		haxe_Log.trace("###########loading:" + Std.string(this.state.loading),{ fileName : "src/view/data/deals/Edit.hx", lineNumber : 342, className : "view.data.deals.Edit", methodName : "renderResults"});
		switch(this.props.match.params.action) {
		case "delete":
			return null;
		case "insert":
			haxe_Log.trace(this.dataDisplay.h["fieldsList"],{ fileName : "src/view/data/deals/Edit.hx", lineNumber : 368, className : "view.data.deals.Edit", methodName : "renderResults"});
			haxe_Log.trace(Std.string(this.state.dataTable[29].h["id"]) + "<<<",{ fileName : "src/view/data/deals/Edit.hx", lineNumber : 369, className : "view.data.deals.Edit", methodName : "renderResults"});
			return React.createElement(react_ReactType.fromComp(view_table_Table),Object.assign({ },this.props,{ id : "fieldsList", data : this.state.dataTable, dataState : this.dataDisplay.h["fieldsList"], className : "is-striped is-hoverable", fullWidth : true}));
		case "open":case "update":
			haxe_Log.trace(this.state.actualState,{ fileName : "src/view/data/deals/Edit.hx", lineNumber : 352, className : "view.data.deals.Edit", methodName : "renderResults"});
			if(this.state.actualState == null) {
				return this.state.formApi.renderWait();
			} else {
				var tmp = this.state.formBuilder;
				...
				return tmp.renderForm({ mHandlers : tmp1, fields : _g, model : "deal", title : "Bearbeite Abschluß"},this.state.actualState);
			}
			break;
		default:
			return null;
	...
	,render: function() {
		haxe_Log.trace(this.props.match.params.section,{ fileName : "src/view/data/deals/Edit.hx", lineNumber : 386, className : "view.data.deals.Edit", methodName : "render"});
		var tmp = this.state.formApi;
		var tmp1 = react_ReactType.fromComp(React_Fragment);
		var tmp2 = react_ReactType.fromString("form");
		var tmp3 = this.renderResults();
	...
	,updateMenu: function(viewClassPath) {
		var sideMenu = this.state.sideMenu;
		haxe_Log.trace(sideMenu.section,{ fileName : "src/view/data/deals/Edit.hx", lineNumber : 398, className : "view.data.deals.Edit", methodName : "updateMenu"});
		var _g = 0;
		var _g1 = sideMenu.menuBlocks.h["Contact"].items;
		while(_g < _g1.length) {
			var mI = _g1[_g];
...
var view_data_deals_List = function(props) {
	...
	this.state = App.initEState({ dataTable : [], loading : false, dealsData : new haxe_ds_IntMap(), selectedRows : [], sideMenu : view_shared_io_FormApi.initSideMenu(this,{ dataClassPath : "data.Deals", label : "Liste", section : "List", items : view_data_deals_List.menuItems},{ section : props.match.params.section == null ? "List" : props.match.params.section, sameWidth : true}), values : new haxe_ds_StringMap()},this);
	if(props.match.params.action == null) {
		var baseUrl = props.match.path.split(":section")[0];
...
view_data_deals_List.prototype = $extend(React_Component.prototype,{
	...
	,get: function(ev) {
		...
		var p = this.props.load({ classPath : "data.Deals", action : "get", filter : this.props.match.params.id != null ? { id : this.props.match.params.id, mandator : "1"} : { mandator : "1"}, limit : this.props.limit, offset : offset > 0 ? offset : 0, table : "deals", resolveMessage : { success : "Abschlußliste wurde geladen", failure : "Abschlußliste konnte nicht geladen werden"}, dbUser : this.props.userState.dbUser, devIP : App.devIP});
		p.then(function(data) {
			haxe_Log.trace(data.dataRows.length,{ fileName : "src/view/data/deals/List.hx", lineNumber : 142, className : "view.data.deals.List", methodName : "get"});
			_gthis.setState({ loading : false, dataTable : data.dataRows});
		});
	}
	,edit: function(ev) {
		haxe_Log.trace(this.state.selectedRows.length,{ fileName : "src/view/data/deals/List.hx", lineNumber : 149, className : "view.data.deals.List", methodName : "edit"});
	}
	,selectionClear: function() {
		var match = react_ReactUtil.copy(this.props.match);
		match.params.action = "get";
		haxe_Log.trace(this.state.dataTable.length,{ fileName : "src/view/data/deals/List.hx", lineNumber : 155, className : "view.data.deals.List", methodName : "selectionClear"});
		this.props.select(1,null,match,"UnselectAll");
		var trs = window.document.querySelectorAll(".tabComponentForm tr");
		haxe_Log.trace(trs.length,{ fileName : "src/view/data/deals/List.hx", lineNumber : 160, className : "view.data.deals.List", methodName : "selectionClear"});
		var _g = 0;
		var _g1 = trs.length;
		while(_g < _g1) {
			var i = _g++;
			var tre = js_Boot.__cast(trs.item(i) , HTMLTableRowElement);
			if(tre.classList.contains("is-selected")) {
				haxe_Log.trace("unselect:" + tre.dataset.id,{ fileName : "src/view/data/deals/List.hx", lineNumber : 164, className : "view.data.deals.List", methodName : "selectionClear"});
				tre.classList.remove("is-selected");
			}
		}
		window.document.querySelector("[class=\"grid-container-inner\"]").scrollTop = 0;
	...
	,componentDidMount: function() {
		...
		this.dataAccess = _g;
		if(this.props.userState.dbUser != null) {
			haxe_Log.trace("yeah: " + this.props.userState.dbUser.first_name,{ fileName : "src/view/data/deals/List.hx", lineNumber : 183, className : "view.data.deals.List", methodName : "componentDidMount"});
		}
		this.state.formApi.doAction();
	}
	,renderResults: function() {
		haxe_Log.trace(this.props.match.params.section + ":" + Std.string(this.state.dataTable != null),{ fileName : "src/view/data/deals/List.hx", lineNumber : 201, className : "view.data.deals.List", methodName : "renderResults"});
		haxe_Log.trace(this.state.loading,{ fileName : "src/view/data/deals/List.hx", lineNumber : 203, className : "view.data.deals.List", methodName : "renderResults"});
		if(this.state.loading) {
			return this.state.formApi.renderWait();
		}
		haxe_Log.trace("###########loading:" + Std.string(this.state.loading),{ fileName : "src/view/data/deals/List.hx", lineNumber : 206, className : "view.data.deals.List", methodName : "renderResults"});
		switch(this.props.match.params.action) {
		case "delete":
			return null;
		case "get":
			var tmp = react_ReactType.fromString("form");
			var tmp1 = react_ReactType.fromComp(view_table_Table);
			var tmp2 = Object.assign({ },this.props,{ id : "fieldsList", data : this.state.dataTable, parentComponent : this, dataState : this.dataDisplay.h["dealsList"], renderPager : ($_=this.baseForm,$bind($_,$_.renderPager)), className : "is-striped is-hoverable", fullWidth : true});
			return React.createElement(tmp,{ className : "tabComponentForm"},React.createElement(tmp1,tmp2));
		default:
			return null;
		}
	...
	,render: function() {
		haxe_Log.trace(this.props.match.params.section,{ fileName : "src/view/data/deals/List.hx", lineNumber : 234, className : "view.data.deals.List", methodName : "render"});
		return this.state.formApi.render(this.renderResults());
	}
	,updateMenu: function(viewClassPath) {
		var sideMenu = this.state.sideMenu;
		haxe_Log.trace(sideMenu.section,{ fileName : "src/view/data/deals/List.hx", lineNumber : 243, className : "view.data.deals.List", methodName : "updateMenu"});
		var _g = 0;
		var _g1 = sideMenu.menuBlocks.h["List"].items;
		while(_g < _g1.length) {
			var mI = _g1[_g];
...
var view_shared_FormBuilder = function(rc) {
	this.comp = rc;
	haxe_Log.trace(this.comp.handleChange,{ fileName : "src/view/shared/FormBuilder.hx", lineNumber : 56, className : "view.shared.FormBuilder", methodName : "new"});
	this.requests = [];
...
view_shared_FormBuilder.prototype = {
	...
	,renderSelect: function(name,options) {
		var si = 1;
		var _g = [];
		var _g1 = haxe_ds_StringMap.kvIterator(options.h);
		while(_g1.hasNext()) {
			var _g2 = _g1.next();
			var value = _g2.key;
			var label = _g2.value;
	...
	,renderRadio: function(name,options,actValue) {
		...
		while(_g1.hasNext()) {
			...
			haxe_Log.trace("" + check + " " + actValue + " " + value,{ fileName : "src/view/shared/FormBuilder.hx", lineNumber : 108, className : "view.shared.FormBuilder", methodName : "renderRadio"});
			var tmp = react_ReactType.fromComp(React_Fragment);
	...
	,renderFormInputElements: function(fields,initialData,compOnChange) {
		var ki = 0;
		var _g = [];
		var _g1 = haxe_ds_StringMap.kvIterator(fields.h);
		while(_g1.hasNext()) {
			var _g2 = _g1.next();
			var name = _g2.key;
			var field = _g2.value;
			...
			if(name == "date_of_birth") {
				haxe_Log.trace(field.type + (" " + name + ":") + Std.string(value),{ fileName : "src/view/shared/FormBuilder.hx", lineNumber : 125, className : "view.shared.FormBuilder", methodName : "renderFormInputElements"});
			}
			if(name == "date_of_birth") {
				haxe_Log.trace(field.type + (" " + name + ":") + Std.string(value),{ fileName : "src/view/shared/FormBuilder.hx", lineNumber : 126, className : "view.shared.FormBuilder", methodName : "renderFormInputElements"});
			}
			haxe_Log.trace(field.type,{ fileName : "src/view/shared/FormBuilder.hx", lineNumber : 127, className : "view.shared.FormBuilder", methodName : "renderFormInputElements"});
			var _g3 = field.type;
			var tmp;
			if(_g3 == null) {
				...
				case "Button":
					...
					break;
				case "Checkbox":
					haxe_Log.trace(field.type + (" " + name + ":") + Std.string(value),{ fileName : "src/view/shared/FormBuilder.hx", lineNumber : 138, className : "view.shared.FormBuilder", methodName : "renderFormInputElements"});
					var checked;
					switch(value) {
				...
				case "NFormat":
					var nfP = { decimalScale : 2, decimalSeparator : ",", fixedDecimalScale : true, isNumericString : true, name : name, onChange : $bind(this,this.onChange), onValueChange : function(values) {
						haxe_Log.trace(values,{ fileName : "src/view/shared/FormBuilder.hx", lineNumber : 224, className : "view.shared.FormBuilder", methodName : "renderFormInputElements"});
					}, removeFormatting : function(fV) {
						haxe_Log.trace(Std.string(parseFloat(fV)),{ fileName : "src/view/shared/FormBuilder.hx", lineNumber : 228, className : "view.shared.FormBuilder", methodName : "renderFormInputElements"});
					...
					break;
				case "Radio":
					haxe_Log.trace(field.type + (" " + name + ":") + Std.string(value),{ fileName : "src/view/shared/FormBuilder.hx", lineNumber : 156, className : "view.shared.FormBuilder", methodName : "renderFormInputElements"});
	...
	,renderForm: function(props,initialState) {
		haxe_Log.trace(props.fields == null ? "null" : haxe_ds_StringMap.stringify(props.fields.h),{ fileName : "src/view/shared/FormBuilder.hx", lineNumber : 286, className : "view.shared.FormBuilder", methodName : "renderForm"});
		var sK = 0;
		var tmp = react_ReactType.fromString("form");
		var tmp1 = { name : props.model, className : "tabComponentForm formField"};
		var tmp2 = react_ReactType.fromString("div");
		...
		var _g = [];
		var _g1 = 0;
		var _g2 = props.mHandlers;
		while(_g1 < _g2.length) {
			var mI = _g2[_g1];
			++_g1;
			_g.push(this.renderButton(mI,++sK));
		}
		return React.createElement(tmp,tmp1,React.createElement(tmp2,{ className : "grid_box", role : "table", 'aria-label' : "Destinations"},tmp3,tmp4,React.createElement(tmp5,{ className : "g_footer"},_g)));
	}
	,renderButton: function(mItem,i) {
		if(mItem.onlySm) {
			return null;
		}
		var mHandler = this.comp.state.formApi.itemHandler;
		return React.createElement(react_ReactType.fromComp(bulma_$components_Button),{ key : i++, onClick : $bind(this,this.itemHandler), 'data-action' : mItem.action, 'data-section' : mItem.section, disabled : mItem.disabled, type : "button"},mItem.label);
	}
	,itemHandler: function(e) {
		e.preventDefault();
		var action = (js_Boot.__cast(e.target , HTMLElement)).getAttribute("data-action");
		haxe_Log.trace(action,{ fileName : "src/view/shared/FormBuilder.hx", lineNumber : 316, className : "view.shared.FormBuilder", methodName : "itemHandler"});
	...
	,onChange: function(ev) {
		haxe_Log.trace(ev.target.type,{ fileName : "src/view/shared/FormBuilder.hx", lineNumber : 329, className : "view.shared.FormBuilder", methodName : "onChange"});
		switch(ev.target.type) {
		case "checkbox":
			haxe_Log.trace("" + Std.string(ev.target.name) + ":" + Std.string(ev.target.value) + ":" + Std.string(ev.target.checked),{ fileName : "src/view/shared/FormBuilder.hx", lineNumber : 333, className : "view.shared.FormBuilder", methodName : "onChange"});
			var tmp;
			...
			this.comp.baseForm.doChange(ev.target.name,tmp);
			haxe_Log.trace("" + Std.string(ev.target.name) + ":" + Std.string(ev.target.value) + ":" + Std.string(ev.target.checked),{ fileName : "src/view/shared/FormBuilder.hx", lineNumber : 343, className : "view.shared.FormBuilder", methodName : "onChange"});
			break;
		case "select-multiple":case "select-one":
			this.comp.baseForm.doChange(ev.target.name,ev.target.value);
			break;
		default:
			this.comp.baseForm.doChange(ev.target.name,ev.target.value);
		}
...
view_shared_Menu.mapDispatchToProps = function(dispatch) {
	return { switchSection : function(url) {
		haxe_Log.trace(url,{ fileName : "src/view/shared/Menu.hx", lineNumber : 55, className : "view.shared.Menu", methodName : "mapDispatchToProps"});
...
view_shared_Menu.prototype = $extend(React_Component.prototype,{
	...
	,renderPanels: function() {
		...
		Lambda.iter(this.props.menuBlocks,function(block) {
			var panels1 = panels;
			var tmp = react_ReactType.fromString("div");
			var tmp1 = { key : i, className : "panel", style : style};
	...
	,renderItems: function(items) {
		...
		while(_g < _g1) {
			...
			haxe_Log.trace(type,{ fileName : "src/view/shared/Menu.hx", lineNumber : 160, className : "view.shared.Menu", methodName : "renderItems"});
			var tmp;
			if(type == "Upload") {
				var tmp1 = react_ReactType.fromString("div");
				var tmp2 = React.createElement(react_ReactType.fromString("input"),{ id : item.formField.name, type : "file", name : item.formField.name, className : "fileinput"});
	...
	,render: function() {
		haxe_Log.trace(Reflect.fields(this.props),{ fileName : "src/view/shared/Menu.hx", lineNumber : 201, className : "view.shared.Menu", methodName : "render"});
		if(this.props.menuBlocks == null) {
			return null;
		}
		haxe_Log.trace(($_=haxe_ds_StringMap.keysIterator(this.props.menuBlocks.h),$bind($_,$_.next)),{ fileName : "src/view/shared/Menu.hx", lineNumber : 204, className : "view.shared.Menu", methodName : "render"});
	...
	,switchContent: function(reactEventSource) {
		...
		haxe_Log.trace("state.section:" + this.state.section + " section:" + section,{ fileName : "src/view/shared/Menu.hx", lineNumber : 231, className : "view.shared.Menu", methodName : "switchContent"});
		if(section != this.props.section) {
			var basePath = this.props.match.path.split("/:")[0];
			haxe_Log.trace(this.props.location.pathname,{ fileName : "src/view/shared/Menu.hx", lineNumber : 237, className : "view.shared.Menu", methodName : "switchContent"});
			this.props.history.push("" + basePath + "/" + section);
			haxe_Log.trace(this.props.history.location.pathname,{ fileName : "src/view/shared/Menu.hx", lineNumber : 240, className : "view.shared.Menu", methodName : "switchContent"});
		}
	}
	,layout: function() {
		var i = 0;
		...
		haxe_Log.trace(this.aW,{ fileName : "src/view/shared/Menu.hx", lineNumber : 250, className : "view.shared.Menu", methodName : "layout"});
		if(this.state.sameWidth == null) {
			this.setState({ sameWidth : this.aW},function() {
				haxe_Log.trace("what's up?",{ fileName : "src/view/shared/Menu.hx", lineNumber : 253, className : "view.shared.Menu", methodName : "layout"});
			});
		}
	}
	,componentDidMount: function() {
		if(this.props.sameWidth && this.state.sameWidth == null) {
			haxe_Log.trace(react_ReactRef.get_current(this.menuRef).offsetWidth,{ fileName : "src/view/shared/Menu.hx", lineNumber : 262, className : "view.shared.Menu", methodName : "componentDidMount"});
			this.layout();
			haxe_Log.trace(react_ReactRef.get_current(this.menuRef).offsetWidth,{ fileName : "src/view/shared/Menu.hx", lineNumber : 264, className : "view.shared.Menu", methodName : "componentDidMount"});
		}
	}
	,componentDidUpdate: function(prevProps,prevState) {
	}
...
view_shared_TabLink.prototype = $extend(React_Component.prototype,{
	render: function() {
		haxe_Log.trace(Type.typeof(this.props.to),{ fileName : "src/view/shared/TabLink.hx", lineNumber : 21, className : "view.shared.TabLink", methodName : "render"});
...
view_shared_io_BaseForm.prototype = {
	...
	,compareStates: function() {
		var dObj = js_Boot.__cast(this.comp.state.actualState , model_ORM);
		var _g = 0;
		var _g1 = Reflect.fields(dObj);
		while(_g < _g1.length) {
			var f = _g1[_g];
			++_g;
			haxe_Log.trace("" + f + ":" + Std.string(Reflect.field(this.comp.state.actualState,f)) + "<==>" + Std.string(Reflect.field(this.comp.state.initialState,f)) + "<",{ fileName : "src/view/shared/io/BaseForm.hx", lineNumber : 44, className : "view.shared.io.BaseForm", methodName : "compareStates"});
		}
	}
	,doChange: function(name,value) {
		haxe_Log.trace("" + name + ": " + value,{ fileName : "src/view/shared/io/BaseForm.hx", lineNumber : 49, className : "view.shared.io.BaseForm", methodName : "doChange"});
		if(name != null && name != "") {
			Reflect.setProperty(this.comp.state.actualState,name,value);
		}
		haxe_Log.trace(Reflect.field(this.comp.state.actualState,name),{ fileName : "src/view/shared/io/BaseForm.hx", lineNumber : 53, className : "view.shared.io.BaseForm", methodName : "doChange"});
	}
	,handleChange: function(e) {
		var el = e.target;
		haxe_Log.trace(Type.typeof(el),{ fileName : "src/view/shared/io/BaseForm.hx", lineNumber : 61, className : "view.shared.io.BaseForm", methodName : "handleChange"});
		if(el.name != "" && el.name != null) {
			haxe_Log.trace(">>" + Std.string(el.name) + "=>" + Std.string(el.value) + "<<",{ fileName : "src/view/shared/io/BaseForm.hx", lineNumber : 65, className : "view.shared.io.BaseForm", methodName : "handleChange"});
			this.comp.state.actualState[el.name] = el.value;
			haxe_Log.trace(Reflect.field(this.comp.state.actualState,el.name),{ fileName : "src/view/shared/io/BaseForm.hx", lineNumber : 68, className : "view.shared.io.BaseForm", methodName : "handleChange"});
		}
	}
	...
	,sessionStore: function(classPath) {
		haxe_Log.trace(this.comp.state.actualState,{ fileName : "src/view/shared/io/BaseForm.hx", lineNumber : 125, className : "view.shared.io.BaseForm", methodName : "sessionStore"});
		window.sessionStorage.setItem(classPath,JSON.stringify(this.comp.state.actualState));
		window.removeEventListener("beforeunload",$bind(this,this.sessionStore));
	}
	...
	,renderPager: function() {
		haxe_Log.trace("pageCount=" + this.comp.state.pageCount,{ fileName : "src/view/shared/io/BaseForm.hx", lineNumber : 153, className : "view.shared.io.BaseForm", methodName : "renderPager"});
		var tmp = react_ReactType.fromString("div");
		var tmp1 = react_ReactType.fromString("nav");
		return React.createElement(tmp,{ className : "paginationContainer"},React.createElement(tmp1,{ },React.createElement(react_ReactType.fromComp(react_ReactPaginate),{ previousLabel : "<", breakLinkClassName : "pagination-link", pageLinkClassName : "pagination-link", nextLinkClassName : "pagination-next", previousLinkClassName : "pagination-previous", nextLabel : ">", breakLabel : "...", breakClassName : "break-me", pageCount : this.comp.state.pageCount, marginPagesDisplayed : 2, pageRangeDisplayed : 5, onPageChange : $bind(this,this.onPageChange), containerClassName : "pagination  is-small", subContainerClassName : "pages pagination", activeLinkClassName : "is-current"})));
	}
	,onPageChange: function(data) {
		haxe_Log.trace("" + this.comp.props.match.params.action + ":" + data.selected,{ fileName : "src/view/shared/io/BaseForm.hx", lineNumber : 177, className : "view.shared.io.BaseForm", methodName : "onPageChange"});
...
view_shared_io_User.prototype = $extend(React_Component.prototype,{
	...
	,componentDidUpdate: function(prevProps,prevState) {
		haxe_Log.trace(App.store.getState().userState.dbUser.first_name,{ fileName : "src/view/shared/io/User.hx", lineNumber : 171, className : "view.shared.io.User", methodName : "componentDidUpdate"});
		if(this.autoFocus != null) {
			react_ReactRef.get_current(this.autoFocus).focus();
		}
	}
	,changePassword: function(ev) {
		haxe_Log.trace(this.state.values == null ? "null" : haxe_ds_StringMap.stringify(this.state.values.h),{ fileName : "src/view/shared/io/User.hx", lineNumber : 179, className : "view.shared.io.User", methodName : "changePassword"});
		...
		haxe_Log.trace(App.store.getState().userState,{ fileName : "src/view/shared/io/User.hx", lineNumber : 196, className : "view.shared.io.User", methodName : "changePassword"});
	}
	,edit: function(ev) {
		var _gthis = this;
		...
		this.props.formApi.requests.push(haxe_ds_Either.Left(view_shared_io_Loader.loadData("" + Std.string(App.config.api),{ id : this.props.userState.dbUser.id, jwt : this.props.userState.dbUser.jwt, classPath : "auth.User", action : "update", filter : "id|" + this.props.userState.dbUser.id, dataSource : haxe_Serializer.run(this.dataAccess.h["update"].source)},function(data) {
			...
			if(Object.prototype.hasOwnProperty.call(data[0].h,"ERROR")) {
				haxe_Log.trace(data[0].h["ERROR"],{ fileName : "src/view/shared/io/User.hx", lineNumber : 220, className : "view.shared.io.User", methodName : "edit"});
				return;
			}
	...
	,save: function(evt) {
		evt.preventDefault();
		haxe_Log.trace(this.state.data == null ? "null" : haxe_ds_StringMap.stringify(this.state.data.h),{ fileName : "src/view/shared/io/User.hx", lineNumber : 237, className : "view.shared.io.User", methodName : "save"});
		haxe_Log.trace(this.state.values == null ? "null" : haxe_ds_StringMap.stringify(this.state.values.h),{ fileName : "src/view/shared/io/User.hx", lineNumber : 238, className : "view.shared.io.User", methodName : "save"});
		var skeys = [];
		var k = haxe_ds_StringMap.keysIterator(this.dataAccess.h["update"].view.h);
		while(k.hasNext()) {
			var k1 = k.next();
		...
		haxe_Log.trace(tmp == null ? "null" : haxe_ds_StringMap.stringify(tmp.h),{ fileName : "src/view/shared/io/User.hx", lineNumber : 249, className : "view.shared.io.User", methodName : "save"});
		...
		haxe_Log.trace(tmp == null ? "null" : haxe_ds_StringMap.stringify(tmp.h),{ fileName : "src/view/shared/io/User.hx", lineNumber : 251, className : "view.shared.io.User", methodName : "save"});
	...
	,renderContent: function() {
		haxe_Log.trace(this.props.match.params.action,{ fileName : "src/view/shared/io/User.hx", lineNumber : 294, className : "view.shared.io.User", methodName : "renderContent"});
		switch(this.props.match.params.action) {
		case "changePassword":
			var tmp = react_ReactType.fromComp(React_Fragment);
	...
	,renderErrors: function(name) {
		haxe_Log.trace(name + ":" + Std.string(Object.prototype.hasOwnProperty.call(this.state.errors.h,name)),{ fileName : "src/view/shared/io/User.hx", lineNumber : 324, className : "view.shared.io.User", methodName : "renderErrors"});
	...
	,render: function() {
		if(this.state.values != null) {
			haxe_Log.trace(this.state.values == null ? "null" : haxe_ds_StringMap.stringify(this.state.values.h),{ fileName : "src/view/shared/io/User.hx", lineNumber : 337, className : "view.shared.io.User", methodName : "render"});
		}
		var tmp = react_ReactType.fromString("div");
		var tmp1 = react_ReactType.fromString("form");
...
view_stats_History.mapStateToProps = function(aState) {
	...
	if(aState.dataStore.contactsDbData != null) {
		var tmp = aState.dataStore.contactsDbData.dataRows[0];
		haxe_Log.trace(tmp == null ? "null" : haxe_ds_StringMap.stringify(tmp.h),{ fileName : "src/view/stats/History.hx", lineNumber : 116, className : "view.stats.History", methodName : "mapStateToProps"});
	} else {
...
view_stats_History.prototype = $extend(React_Component.prototype,{
	...
	,componentDidCatch: function(error,info) {
		try {
			...
			var ex = haxe_Exception.caught(_g).unwrap();
			haxe_Log.trace(ex,{ fileName : "src/view/stats/History.hx", lineNumber : 87, className : "view.stats.History", methodName : "componentDidCatch"});
		}
...
view_stats_Performance.prototype = $extend(React_Component.prototype,{
	render: function() {
		haxe_Log.trace(this.props.match.params.action,{ fileName : "src/view/stats/Performance.hx", lineNumber : 27, className : "view.stats.Performance", methodName : "render"});
		if(this.props.match.params.section == "Charts") {
			return React.createElement(react_ReactType.fromComp(view_stats_history_Charts),Object.assign({ },this.props,{ limit : 100, parentComponent : this, formApi : this.state.formApi, fullWidth : true, sideMenu : this.state.sideMenu}));
		} else {
			return null;
...
view_stats_Preview.prototype = $extend(React_Component.prototype,{
	render: function() {
		haxe_Log.trace(this.props.match.params.action,{ fileName : "src/view/stats/Preview.hx", lineNumber : 50, className : "view.stats.Preview", methodName : "render"});
		if(this.props.match.params.section == "Charts") {
			return React.createElement(react_ReactType.fromComp(view_stats_history_Charts),Object.assign({ },this.props,{ limit : 100, parentComponent : this, formApi : this.state.formApi, fullWidth : true, sideMenu : this.state.sideMenu}));
		} else {
			return null;
...
var view_stats_history_Charts = function(props) {
	...
	haxe_Log.trace("..." + Std.string(Reflect.fields(props)),{ fileName : "src/view/stats/history/Charts.hx", lineNumber : 131, className : "view.stats.history.Charts", methodName : "new"});
	this.state = App.initEState({ dataTable : [], loading : false, selectedRows : [], sideMenu : view_shared_io_FormApi.initSideMenu(this,{ dataClassPath : "reports.History", label : "Charts", section : "Charts", items : view_stats_history_Charts.menuItems},{ section : props.match.params.section == null ? "Chart" : props.match.params.section, sameWidth : true}), values : new haxe_ds_StringMap()},this);
	if(props.match.params.section == null || props.match.params.action == null) {
		var baseUrl = props.match.path.split(":section")[0];
		haxe_Log.trace("redirecting to " + baseUrl + "Charts/get",{ fileName : "src/view/stats/history/Charts.hx", lineNumber : 154, className : "view.stats.history.Charts", methodName : "new"});
		props.history.push("" + baseUrl + "Charts/get");
		this.get(null);
	} else {
		this.state.formApi.doAction();
	}
	haxe_Log.trace(this.state.loading,{ fileName : "src/view/stats/history/Charts.hx", lineNumber : 162, className : "view.stats.history.Charts", methodName : "new"});
};
...
view_stats_history_Charts.mapStateToProps = function(aState) {
	haxe_Log.trace("never",{ fileName : "src/view/stats/history/Charts.hx", lineNumber : 167, className : "view.stats.history.Charts", methodName : "mapStateToProps"});
	return { userState : aState.userState};
};
...
view_stats_history_Charts.prototype = $extend(React_Component.prototype,{
	...
	,get: function(ev) {
		var _gthis = this;
		haxe_Log.trace("hi " + Std.string(ev),{ fileName : "src/view/stats/history/Charts.hx", lineNumber : 175, className : "view.stats.history.Charts", methodName : "get"});
		var offset = 0;
		if(ev != null && ev.page != null) {
			offset = this.props.limit * ev.page | 0;
		}
		var params = { dbUser : this.props.userState.dbUser, classPath : "stats.History", action : "get", filter : this.props.filter == null ? "termin<date_trunc('month', CURRENT_DATE)" : this.props.filter, devIP : App.devIP, limit : this.props.limit, offset : offset > 0 ? offset : 0, order : "termin", table : "bank_transfers"};
		loader_BinaryLoader.dbQuery("" + Std.string(App.config.api),params,function(data) {
			haxe_Log.trace(data.dataInfo == null ? "null" : haxe_ds_StringMap.stringify(data.dataInfo.h),{ fileName : "src/view/stats/history/Charts.hx", lineNumber : 198, className : "view.stats.history.Charts", methodName : "get"});
			haxe_Log.trace(data.dataParams == null ? "null" : haxe_ds_StringMap.stringify(data.dataParams.h),{ fileName : "src/view/stats/history/Charts.hx", lineNumber : 199, className : "view.stats.history.Charts", methodName : "get"});
			haxe_Log.trace(data.dataRows.length,{ fileName : "src/view/stats/history/Charts.hx", lineNumber : 200, className : "view.stats.history.Charts", methodName : "get"});
			if(data.dataRows.length > 0) {
				if(!haxe_ds_StringMap.keysIterator(data.dataErrors.h).hasNext()) {
					...
					haxe_Log.trace(_gthis.chartBox,{ fileName : "src/view/stats/history/Charts.hx", lineNumber : 215, className : "view.stats.history.Charts", methodName : "get"});
					if(_gthis.chartBox != null) {
						_gthis.draw();
					}
				} else {
	...
	,componentDidMount: function() {
		...
		this.dataAccess = _g;
		if(this.props.userState.dbUser != null) {
			haxe_Log.trace("yeah: " + this.props.userState.dbUser.first_name,{ fileName : "src/view/stats/history/Charts.hx", lineNumber : 238, className : "view.stats.history.Charts", methodName : "componentDidMount"});
		}
		haxe_Log.trace(this.props.match.params.action,{ fileName : "src/view/stats/history/Charts.hx", lineNumber : 239, className : "view.stats.history.Charts", methodName : "componentDidMount"});
		if(this.chartBox == null) {
			this.chartBox = window.document.querySelector(".chartBox");
		}
		haxe_Log.trace(this.chartBox,{ fileName : "src/view/stats/history/Charts.hx", lineNumber : 244, className : "view.stats.history.Charts", methodName : "componentDidMount"});
		if(this.chartBox != null) {
			this.draw();
		}
	}
	,draw: function() {
		if(this.state.dataTable != null && this.state.dataTable.length > 0) {
			...
			haxe_Log.trace("" + maxCount + " => " + maxSum + " " + cW + ": " + cRatio + " " + sRatio + " " + this.state.dataTable.length + " svg: " + Std.string(this.svg != null ? this.svg : null),{ fileName : "src/view/stats/history/Charts.hx", lineNumber : 277, className : "view.stats.history.Charts", methodName : "draw"});
			var tmp = this.state.dataTable[0];
			haxe_Log.trace(tmp == null ? "null" : haxe_ds_StringMap.stringify(tmp.h),{ fileName : "src/view/stats/history/Charts.hx", lineNumber : 278, className : "view.stats.history.Charts", methodName : "draw"});
			var iW = iX - 2;
			if(this.svg != null) {
				return;
			}
			...
			haxe_Log.trace(stop1.classList.value,{ fileName : "src/view/stats/history/Charts.hx", lineNumber : 309, className : "view.stats.history.Charts", methodName : "draw"});
			haxe_Log.trace(stop1.nextElementSibling.classList.value,{ fileName : "src/view/stats/history/Charts.hx", lineNumber : 310, className : "view.stats.history.Charts", methodName : "draw"});
			haxe_Log.trace(this.svg,{ fileName : "src/view/stats/history/Charts.hx", lineNumber : 318, className : "view.stats.history.Charts", methodName : "draw"});
	...
	,drawLegend: function(top,h,lW,iW,iX) {
		haxe_Log.trace(this.svg,{ fileName : "src/view/stats/history/Charts.hx", lineNumber : 344, className : "view.stats.history.Charts", methodName : "drawLegend"});
		haxe_Log.trace("top:" + top + " height:" + h + " width:" + lW,{ fileName : "src/view/stats/history/Charts.hx", lineNumber : 345, className : "view.stats.history.Charts", methodName : "drawLegend"});
	...
	,renderResults: function() {
		haxe_Log.trace(this.props.match.params.section + (":" + this.props.match.params.action + "::") + Std.string(this.state.dataTable != null),{ fileName : "src/view/stats/history/Charts.hx", lineNumber : 416, className : "view.stats.history.Charts", methodName : "renderResults"});
		if(this.state.dataTable.length == 0) {
			return this.state.formApi.renderWait();
		}
		if(this.props.match.params.action == "get") {
	...
	,getCellData: function(cP) {
		haxe_Log.trace(cP,{ fileName : "src/view/stats/history/Charts.hx", lineNumber : 436, className : "view.stats.history.Charts", methodName : "getCellData"});
	}
	,render: function() {
		haxe_Log.trace(this.props.match.params.section,{ fileName : "src/view/stats/history/Charts.hx", lineNumber : 443, className : "view.stats.history.Charts", methodName : "render"});
		return this.state.formApi.render(this.renderResults());
	}
	,componentWillUnmount: function() {
		haxe_Log.trace("...",{ fileName : "src/view/stats/history/Charts.hx", lineNumber : 450, className : "view.stats.history.Charts", methodName : "componentWillUnmount"});
	}
...
var view_table_Table = function(props) {
	...
	if(this._trace) {
		haxe_Log.trace(Reflect.fields(props),{ fileName : "src/view/table/Table.hx", lineNumber : 175, className : "view.table.Table", methodName : "new"});
	}
	if(this._trace) {
		haxe_Log.trace(this.fieldNames,{ fileName : "src/view/table/Table.hx", lineNumber : 177, className : "view.table.Table", methodName : "new"});
	}
...
view_table_Table.prototype = $extend(React_Component.prototype,{
	...
	,render: function() {
		if(this.props.data != null) {
			if(this._trace) {
				haxe_Log.trace(this.props.data.length,{ fileName : "src/view/table/Table.hx", lineNumber : 184, className : "view.table.Table", methodName : "render"});
			}
		}
		if(this._trace) {
			haxe_Log.trace(this.props.className,{ fileName : "src/view/table/Table.hx", lineNumber : 185, className : "view.table.Table", methodName : "render"});
		}
		...
		var tmp7 = React.createElement(tmp1,{ className : "header-background"},React.createElement(tmp2,{ className : "table head"},React.createElement(tmp3,{ },React.createElement(tmp4,tmp5,tmp6))));
		var tmp1 = react_ReactType.fromString("div");
		var tmp2 = react_ReactType.fromString("table");
		var tmp3 = { ref : this.tableRef, className : "table " + this.props.className};
		...
		return React.createElement(tmp,{ className : "fixed-grid-container"},tmp7,tmp6,this.props.renderPager());
	}
	,renderHeaderRow: function() {
		...
		var headerRow = [];
		var field = haxe_ds_StringMap.keysIterator(this.props.dataState.columns.h);
		while(field.hasNext()) {
			var field1 = field.next();
			var hC = this.props.dataState.columns.h[field1];
			if(hC.show == false) {
				continue;
			}
			var tmp = react_ReactType.fromString("th");
			var tmp1 = react_ReactType.fromString("div");
			headerRow.push(React.createElement(tmp,{ key : field1},React.createElement(tmp1,{ className : "th-box " + (hC.headerClassName != null ? hC.headerClassName : hC.className)},hC.label != null ? hC.label : hC.name,React.createElement(react_ReactType.fromString("span"),{ className : "sort-box fa fa-sort"}))));
		}
		if(this._trace) {
			haxe_Log.trace(headerRow.length,{ fileName : "src/view/table/Table.hx", lineNumber : 256, className : "view.table.Table", methodName : "renderHeaderRow"});
		}
		return headerRow;
	}
	,renderHeaderDisplay: function() {
		...
		while(field.hasNext()) {
			...
			var tmp = react_ReactType.fromString("th");
			var tmp1 = react_ReactType.fromString("div");
			headerRow.push(React.createElement(tmp,{ key : field1},React.createElement(tmp1,{ className : "th-box " + (hC.headerClassName != null ? hC.headerClassName : hC.className)},hC.label != null ? hC.label : hC.name,React.createElement(react_ReactType.fromString("span"),{ className : "sort-box fa " + sortClass}))));
		}
		return headerRow;
	}
	,renderRows: function(dRows) {
		...
		while(_g < dRows.length) {
			...
			dRs.push(React.createElement(react_ReactType.fromComp(view_table_Tr),{ key : dR.h["id"], columns : this.props.dataState.columns, data : dR, firstTableRow : fRRef, fieldNames : this.fieldNames, row : row++, parentComponent : this.props.parentComponent}));
		}
		if(this._trace) {
			haxe_Log.trace(dRs.length,{ fileName : "src/view/table/Table.hx", lineNumber : 303, className : "view.table.Table", methodName : "renderRows"});
		}
		return dRs;
	}
	,select: function(mEv,tr) {
		if(this._trace) {
			haxe_Log.trace(mEv.altKey,{ fileName : "src/view/table/Table.hx", lineNumber : 309, className : "view.table.Table", methodName : "select"});
		}
		if(this._trace) {
			haxe_Log.trace(mEv.currentTarget,{ fileName : "src/view/table/Table.hx", lineNumber : 310, className : "view.table.Table", methodName : "select"});
		}
	...
	,selectAltGroup: function(altGroupPos,cRow) {
		...
		while(_g < _g1) {
			...
			if(this._trace) {
				haxe_Log.trace(row.cells.item(altGroupPos).nodeValue + "==" + groupName,{ fileName : "src/view/table/Table.hx", lineNumber : 368, className : "view.table.Table", methodName : "selectAltGroup"});
			}
	...
	,layOut: function() {
		var _gthis = this;
		if(this._trace) {
			haxe_Log.trace("firstCall: " + Std.string(this.headerUpdated) + " " + Std.string(this.tHeadRef) + ": " + Std.string(this.tHeadRef != null && react_ReactRef.get_current(this.tHeadRef) != null),{ fileName : "src/view/table/Table.hx", lineNumber : 406, className : "view.table.Table", methodName : "layOut"});
		}
		if(this.tHeadRef == null || react_ReactRef.get_current(this.tHeadRef) == null) {
			if(this._trace) {
				haxe_Log.trace("" + Std.string(this.tHeadRef) + ": " + Std.string(this.tHeadRef != null && react_ReactRef.get_current(this.tHeadRef) != null),{ fileName : "src/view/table/Table.hx", lineNumber : 410, className : "view.table.Table", methodName : "layOut"});
			}
			if(this._timer != null) {
				return;
			}
			...
			this._timer = App.await(250,function() {
				...
				if(_gthis._trace) {
					haxe_Log.trace(_max,{ fileName : "src/view/table/Table.hx", lineNumber : 418, className : "view.table.Table", methodName : "layOut"});
				}
		...
		var hasScrollbar = react_ReactRef.get_current(this.tableRef).parentElement.offsetHeight < react_ReactRef.get_current(this.tableRef).parentElement.offsetHeight - react_ReactRef.get_current(this.tHeadRef).offsetHeight;
		var freeWidth = react_ReactRef.get_current(this.tableRef).parentElement.offsetWidth - react_ReactRef.get_current(this.tableRef).offsetWidth - (hasScrollbar ? scrollBarWidth : 0);
		...
		if(this._trace) {
			haxe_Log.trace("firstRowRef.current.offsetWidth:" + react_ReactRef.get_current(this.firstRowRef).offsetWidth + " scrollBarWidth:" + scrollBarWidth,{ fileName : "src/view/table/Table.hx", lineNumber : 434, className : "view.table.Table", methodName : "layOut"});
		}
		...
		if(firstSelectedRow != null) {
			if(this._trace) {
				haxe_Log.trace(firstSelectedRow.offsetTop,{ fileName : "src/view/table/Table.hx", lineNumber : 493, className : "view.table.Table", methodName : "layOut"});
			}
	...
	,componentDidMount: function() {
		...
		window.requestAnimationFrame(function(t) {
			if(_gthis._trace) {
				haxe_Log.trace(t,{ fileName : "src/view/table/Table.hx", lineNumber : 503, className : "view.table.Table", methodName : "componentDidMount"});
			}
			_gthis.layOut();
		});
	}
	,componentDidUpdate: function(prevProps,prevState) {
		if(this._trace) {
			haxe_Log.trace(Std.string(this.headerUpdated) + ":" + Std.string(this.tHeadRef),{ fileName : "src/view/table/Table.hx", lineNumber : 510, className : "view.table.Table", methodName : "componentDidUpdate"});
		}
	...
	,componentWillUnmount: function() {
		if(this._trace) {
			haxe_Log.trace("leaving...",{ fileName : "src/view/table/Table.hx", lineNumber : 524, className : "view.table.Table", methodName : "componentWillUnmount"});
		}
		if(this._timer != null) {
			this._timer.stop();
		}
	...
	,showDims: function(ref) {
		...
		while(_g < cells.length) {
			...
			++_g;
			if(this._trace) {
				haxe_Log.trace(cell.getBoundingClientRect().toJSON(),{ fileName : "src/view/table/Table.hx", lineNumber : 544, className : "view.table.Table", methodName : "showDims"});
			}
			s += cell.getBoundingClientRect().width;
		}
		if(this._trace) {
			haxe_Log.trace(" sum:" + s,{ fileName : "src/view/table/Table.hx", lineNumber : 547, className : "view.table.Table", methodName : "showDims"});
		}
	}
	,nodeDims: function(n) {
		var i = 0;
		...
		while(_g < cells.length) {
			...
			if(this._trace) {
				haxe_Log.trace(dRect,{ fileName : "src/view/table/Table.hx", lineNumber : 558, className : "view.table.Table", methodName : "nodeDims"});
			}
			s += (js_Boot.__cast(cell , HTMLElement)).getBoundingClientRect().width;
		}
		if(this._trace) {
			haxe_Log.trace(" sum:" + s,{ fileName : "src/view/table/Table.hx", lineNumber : 562, className : "view.table.Table", methodName : "nodeDims"});
		}
	}
...
var view_table_Tr = function(props) {
	...
	if(props.parentComponent.props.location.hash.indexOf(this.id) > -1) {
		this.select({ select : true});
	}
};
...
view_table_Tr.prototype = $extend(React_Component.prototype,{
	...
	,renderCells: function(rdMap) {
		var _gthis = this;
		if(this.props.data == null) {
			haxe_Log.trace("oops...",{ fileName : "src/view/table/Tr.hx", lineNumber : 100, className : "view.table.Tr", methodName : "renderCells"});
			return null;
		}
		...
		while(_g < _g1) {
			...
			if(columnDataState == null && !reported) {
				haxe_Log.trace(fN,{ fileName : "src/view/table/Tr.hx", lineNumber : 114, className : "view.table.Tr", methodName : "renderCells"});
				reported = true;
			}
	...
	,render: function() {
		if(this.props.row == 0) {
			...
			this.selected = this.props.parentComponent.props.location.hash.indexOf(this.id) > -1;
		}
		...
		return React.createElement(react_ReactType.fromString("tr"),{ ref : this.ref, className : cl, 'data-id' : this.props.data.h["id"], 'data-row' : this.props.row, title : this.props.data.h["id"], onClick : $bind(this,this.select)},this.renderCells(this.props.data));
	}
	,select: function(mEvOrID) {
		haxe_Log.trace("" + Std.string(this.props.data.h["id"]) + " selected:" + Std.string(this.selected),{ fileName : "src/view/table/Tr.hx", lineNumber : 175, className : "view.table.Tr", methodName : "select"});
		haxe_Log.trace(Reflect.fields(this.props),{ fileName : "src/view/table/Tr.hx", lineNumber : 176, className : "view.table.Tr", methodName : "select"});
		if(mEvOrID.select == null) {
			try {
				var evt = mEvOrID;
				var tEl = js_Boot.__cast(mEvOrID.target , HTMLElement);
				haxe_Log.trace(tEl.closest("table"),{ fileName : "src/view/table/Tr.hx", lineNumber : 184, className : "view.table.Tr", methodName : "select"});
			} catch( _g ) {
				var ex = haxe_Exception.caught(_g).unwrap();
				haxe_Log.trace(ex,{ fileName : "src/view/table/Tr.hx", lineNumber : 195, className : "view.table.Tr", methodName : "select"});
			}
		}
		if(this.props.parentComponent != null) {
			if(!this.selected) {
				haxe_Log.trace(this.props.parentComponent.props.select,{ fileName : "src/view/table/Tr.hx", lineNumber : 203, className : "view.table.Tr", methodName : "select"});
			} else {
		...
		haxe_Log.trace("selected:" + Std.string(this.selected),{ fileName : "src/view/table/Tr.hx", lineNumber : 214, className : "view.table.Tr", methodName : "select"});
	}
...
model_ORM.dsep = ",";
model_Account.__meta__ = { fields : { contact : { dataType : ["bigint"]}, bank_name : { dataType : ["character varying(64)"]}, bic : { dataType : ["character varying(11)"]}, account : { dataType : ["character varying(32)"]}, blz : { dataType : ["character varying(12)"]}, iban : { dataType : ["character varying(32)"]}, creditor : { dataType : ["bigint"]}, sign_date : { dataType : ["date"]}, state : { dataType : ["accounts_state"]}, creation_date : { dataType : ["timestamp without time zone"]}, edited_by : { dataType : ["bigint"]}, last_locktime : { dataType : ["timestamp(0) without time zone"]}}};
model_Account.__rtti = "<class path=\"model.Account\" params=\"\">\n\t<extends path=\"model.ORM\"/>\n\t<contact public=\"1\" set=\"accessor\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"bigint\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</contact>\n\t<set_contact set=\"method\" line=\"41\"><f a=\"contact\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n</f></set_contact>\n\t<bank_name public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(64)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</bank_name>\n\t<set_bank_name set=\"method\" line=\"51\"><f a=\"bank_name\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_bank_name>\n\t<bic public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(11)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</bic>\n\t<set_bic set=\"method\" line=\"61\"><f a=\"bic\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_bic>\n\t<account public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(32)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</account>\n\t<set_account set=\"method\" line=\"71\"><f a=\"account\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_account>\n\t<blz public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(12)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</blz>\n\t<set_blz set=\"method\" line=\"81\"><f a=\"blz\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_blz>\n\t<iban public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(32)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</iban>\n\t<set_iban set=\"method\" line=\"91\"><f a=\"iban\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_iban>\n\t<creditor public=\"1\" set=\"accessor\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"bigint\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</creditor>\n\t<set_creditor set=\"method\" line=\"101\"><f a=\"creditor\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n</f></set_creditor>\n\t<sign_date public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"date\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</sign_date>\n\t<set_sign_date set=\"method\" line=\"111\"><f a=\"sign_date\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_sign_date>\n\t<state public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"accounts_state\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</state>\n\t<set_state set=\"method\" line=\"121\"><f a=\"state\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_state>\n\t<creation_date public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"timestamp without time zone\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</creation_date>\n\t<set_creation_date set=\"method\" line=\"131\"><f a=\"creation_date\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_creation_date>\n\t<edited_by public=\"1\" set=\"accessor\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"bigint\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</edited_by>\n\t<set_edited_by set=\"method\" line=\"141\"><f a=\"edited_by\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n</f></set_edited_by>\n\t<last_locktime public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"timestamp(0) without time zone\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</last_locktime>\n\t<set_last_locktime set=\"method\" line=\"151\"><f a=\"last_locktime\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_last_locktime>\n\t<new public=\"1\" set=\"method\" line=\"23\"><f a=\"data\">\n\t<t path=\"Map\">\n\t\t<c path=\"String\"/>\n\t\t<c path=\"String\"/>\n\t</t>\n\t<x path=\"Void\"/>\n</f></new>\n\t<meta>\n\t\t<m n=\":build\"><e>react.jsx.JsxStaticMacro.build()</e></m>\n\t\t<m n=\":rtti\"/>\n\t</meta>\n</class>";
...
model_BankTransfer.__rtti = "<class path=\"model.BankTransfer\" params=\"\">\n\t<extends path=\"model.ORM\"/>\n\t<ag_name public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(64)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</ag_name>\n\t<set_ag_name set=\"method\" line=\"51\"><f a=\"ag_name\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_ag_name>\n\t<ag_konto_or_iban public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(32)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</ag_konto_or_iban>\n\t<set_ag_konto_or_iban set=\"method\" line=\"61\"><f a=\"ag_konto_or_iban\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_ag_konto_or_iban>\n\t<ag_blz_or_bic public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(11)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</ag_blz_or_bic>\n\t<set_ag_blz_or_bic set=\"method\" line=\"71\"><f a=\"ag_blz_or_bic\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_ag_blz_or_bic>\n\t<zahlpfl_name public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(21)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</zahlpfl_name>\n\t<set_zahlpfl_name set=\"method\" line=\"81\"><f a=\"zahlpfl_name\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_zahlpfl_name>\n\t<zahlpfl_name2 public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(32)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</zahlpfl_name2>\n\t<set_zahlpfl_name2 set=\"method\" line=\"91\"><f a=\"zahlpfl_name2\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_zahlpfl_name2>\n\t<zahlpfl_strasse public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(32)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</zahlpfl_strasse>\n\t<set_zahlpfl_strasse set=\"method\" line=\"101\"><f a=\"zahlpfl_strasse\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_zahlpfl_strasse>\n\t<zahlpfl_name_ort public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(32)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</zahlpfl_name_ort>\n\t<set_zahlpfl_name_ort set=\"method\" line=\"111\"><f a=\"zahlpfl_name_ort\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_zahlpfl_name_ort>\n\t<zahlpfl_name_kto_or_iban public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(22)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</zahlpfl_name_kto_or_iban>\n\t<set_zahlpfl_name_kto_or_iban set=\"method\" line=\"121\"><f a=\"zahlpfl_name_kto_or_iban\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_zahlpfl_name_kto_or_iban>\n\t<zahlpfl_name_blz_or_bic public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(11)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</zahlpfl_name_blz_or_bic>\n\t<set_zahlpfl_name_blz_or_bic set=\"method\" line=\"131\"><f a=\"zahlpfl_name_blz_or_bic\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_zahlpfl_name_blz_or_bic>\n\t<betrag public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"double precision\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</betrag>\n\t<set_betrag set=\"method\" line=\"141\"><f a=\"betrag\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_betrag>\n\t<currency public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(32)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</currency>\n\t<set_currency set=\"method\" line=\"151\"><f a=\"currency\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_currency>\n\t<zahlart public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(5)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</zahlart>\n\t<set_zahlart set=\"method\" line=\"161\"><f a=\"zahlart\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_zahlart>\n\t<termin public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"date\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</termin>\n\t<set_termin set=\"method\" line=\"171\"><f a=\"termin\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_termin>\n\t<vwz1 public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(22)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</vwz1>\n\t<set_vwz1 set=\"method\" line=\"181\"><f a=\"vwz1\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_vwz1>\n\t<vwz2 public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(256)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</vwz2>\n\t<set_vwz2 set=\"method\" line=\"191\"><f a=\"vwz2\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_vwz2>\n\t<vwz3 public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(64)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</vwz3>\n\t<set_vwz3 set=\"method\" line=\"201\"><f a=\"vwz3\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_vwz3>\n\t<vwz4 public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(32)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</vwz4>\n\t<set_vwz4 set=\"method\" line=\"211\"><f a=\"vwz4\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_vwz4>\n\t<vwz5 public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(32)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</vwz5>\n\t<set_vwz5 set=\"method\" line=\"221\"><f a=\"vwz5\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_vwz5>\n\t<vwz6 public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(32)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</vwz6>\n\t<set_vwz6 set=\"method\" line=\"231\"><f a=\"vwz6\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_vwz6>\n\t<vwz7 public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(32)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</vwz7>\n\t<set_vwz7 set=\"method\" line=\"241\"><f a=\"vwz7\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_vwz7>\n\t<vwz8 public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(32)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</vwz8>\n\t<set_vwz8 set=\"method\" line=\"251\"><f a=\"vwz8\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_vwz8>\n\t<vwz9 public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(32)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</vwz9>\n\t<set_vwz9 set=\"method\" line=\"261\"><f a=\"vwz9\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_vwz9>\n\t<ba_id public=\"1\" set=\"accessor\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"bigint\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</ba_id>\n\t<set_ba_id set=\"method\" line=\"271\"><f a=\"ba_id\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n</f></set_ba_id>\n\t<tracking_status public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"bank_transfers_tracking_status\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</tracking_status>\n\t<set_tracking_status set=\"method\" line=\"281\"><f a=\"tracking_status\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_tracking_status>\n\t<anforderungs_datum public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"date\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</anforderungs_datum>\n\t<set_anforderungs_datum set=\"method\" line=\"291\"><f a=\"anforderungs_datum\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_anforderungs_datum>\n\t<rueck_datum public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"date\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</rueck_datum>\n\t<set_rueck_datum set=\"method\" line=\"301\"><f a=\"rueck_datum\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_rueck_datum>\n\t<cycle public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(32)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</cycle>\n\t<set_cycle set=\"method\" line=\"311\"><f a=\"cycle\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_cycle>\n\t<ref_id public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(32)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</ref_id>\n\t<set_ref_id set=\"method\" line=\"321\"><f a=\"ref_id\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_ref_id>\n\t<mandat_id public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(11)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</mandat_id>\n\t<set_mandat_id set=\"method\" line=\"331\"><f a=\"mandat_id\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_mandat_id>\n\t<mandat_datum public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"date\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</mandat_datum>\n\t<set_mandat_datum set=\"method\" line=\"341\"><f a=\"mandat_datum\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_mandat_datum>\n\t<ag_creditor_id public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(32)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</ag_creditor_id>\n\t<set_ag_creditor_id set=\"method\" line=\"351\"><f a=\"ag_creditor_id\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_ag_creditor_id>\n\t<sequenz public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(4)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</sequenz>\n\t<set_sequenz set=\"method\" line=\"361\"><f a=\"sequenz\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_sequenz>\n\t<super_ag_name public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(32)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</super_ag_name>\n\t<set_super_ag_name set=\"method\" line=\"371\"><f a=\"super_ag_name\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_super_ag_name>\n\t<new public=\"1\" set=\"method\" line=\"43\"><f a=\"data\">\n\t<t path=\"Map\">\n\t\t<c path=\"String\"/>\n\t\t<c path=\"String\"/>\n\t</t>\n\t<x path=\"Void\"/>\n</f></new>\n\t<meta>\n\t\t<m n=\":build\"><e>react.jsx.JsxStaticMacro.build()</e></m>\n\t\t<m n=\":rtti\"/>\n\t</meta>\n</class>";
model_Contact.__meta__ = { fields : { mandator : { dataType : ["bigint"]}, creation_date : { dataType : ["timestamp(0) without time zone"]}, state : { dataType : ["character varying(64)"]}, use_email : { dataType : ["boolean"]}, company_name : { dataType : ["character varying(64)"]}, co_field : { dataType : ["character varying(100)"]}, phone_code : { dataType : ["character varying(10)"]}, phone_number : { dataType : ["character varying(18)"]}, fax : { dataType : ["character varying(18)"]}, title : { dataType : ["character varying(64)"]}, title_pro : { dataType : ["character varying(64)"]}, first_name : { dataType : ["character varying(32)"]}, last_name : { dataType : ["character varying(32)"]}, address : { dataType : ["character varying(64)"]}, address_2 : { dataType : ["character varying(64)"]}, city : { dataType : ["character varying(50)"]}, postal_code : { dataType : ["character varying(10)"]}, country_code : { dataType : ["character varying(3)"]}, gender : { dataType : ["character varying(64)"]}, date_of_birth : { dataType : ["date"]}, mobile : { dataType : ["character varying(19)"]}, email : { dataType : ["character varying(64)"]}, comments : { dataType : ["character varying(4096)"]}, edited_by : { dataType : ["bigint"]}, merged : { dataType : ["bigint[]"]}, last_locktime : { dataType : ["timestamp(0) without time zone"]}, owner : { dataType : ["bigint"]}}};
model_Contact.__rtti = "<class path=\"model.Contact\" params=\"\">\n\t<extends path=\"model.ORM\"/>\n\t<mandator public=\"1\" set=\"accessor\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"bigint\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</mandator>\n\t<set_mandator set=\"method\" line=\"56\"><f a=\"mandator\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n</f></set_mandator>\n\t<creation_date public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"timestamp(0) without time zone\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</creation_date>\n\t<set_creation_date set=\"method\" line=\"66\"><f a=\"creation_date\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_creation_date>\n\t<state public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(64)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</state>\n\t<set_state set=\"method\" line=\"76\"><f a=\"state\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_state>\n\t<use_email public=\"1\" set=\"accessor\">\n\t\t<x path=\"Bool\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"boolean\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</use_email>\n\t<set_use_email set=\"method\" line=\"86\"><f a=\"use_email\">\n\t<x path=\"Bool\"/>\n\t<x path=\"Bool\"/>\n</f></set_use_email>\n\t<company_name public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(64)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</company_name>\n\t<set_company_name set=\"method\" line=\"96\"><f a=\"company_name\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_company_name>\n\t<co_field public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(100)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</co_field>\n\t<set_co_field set=\"method\" line=\"106\"><f a=\"co_field\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_co_field>\n\t<phone_code public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(10)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</phone_code>\n\t<set_phone_code set=\"method\" line=\"116\"><f a=\"phone_code\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_phone_code>\n\t<phone_number public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(18)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</phone_number>\n\t<set_phone_number set=\"method\" line=\"126\"><f a=\"phone_number\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_phone_number>\n\t<fax public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(18)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</fax>\n\t<set_fax set=\"method\" line=\"136\"><f a=\"fax\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_fax>\n\t<title public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(64)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</title>\n\t<set_title set=\"method\" line=\"146\"><f a=\"title\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_title>\n\t<title_pro public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(64)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</title_pro>\n\t<set_title_pro set=\"method\" line=\"156\"><f a=\"title_pro\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_title_pro>\n\t<first_name public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(32)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</first_name>\n\t<set_first_name set=\"method\" line=\"166\"><f a=\"first_name\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_first_name>\n\t<last_name public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(32)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</last_name>\n\t<set_last_name set=\"method\" line=\"176\"><f a=\"last_name\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_last_name>\n\t<address public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(64)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</address>\n\t<set_address set=\"method\" line=\"186\"><f a=\"address\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_address>\n\t<address_2 public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(64)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</address_2>\n\t<set_address_2 set=\"method\" line=\"196\"><f a=\"address_2\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_address_2>\n\t<city public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(50)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</city>\n\t<set_city set=\"method\" line=\"206\"><f a=\"city\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_city>\n\t<postal_code public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(10)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</postal_code>\n\t<set_postal_code set=\"method\" line=\"216\"><f a=\"postal_code\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_postal_code>\n\t<country_code public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(3)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</country_code>\n\t<set_country_code set=\"method\" line=\"226\"><f a=\"country_code\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_country_code>\n\t<gender public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(64)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</gender>\n\t<set_gender set=\"method\" line=\"236\"><f a=\"gender\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_gender>\n\t<date_of_birth public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"date\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</date_of_birth>\n\t<set_date_of_birth set=\"method\" line=\"246\"><f a=\"date_of_birth\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_date_of_birth>\n\t<mobile public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(19)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</mobile>\n\t<set_mobile set=\"method\" line=\"256\"><f a=\"mobile\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_mobile>\n\t<email public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(64)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</email>\n\t<set_email set=\"method\" line=\"266\"><f a=\"email\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_email>\n\t<comments public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(4096)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</comments>\n\t<set_comments set=\"method\" line=\"276\"><f a=\"comments\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_comments>\n\t<edited_by public=\"1\" set=\"accessor\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"bigint\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</edited_by>\n\t<set_edited_by set=\"method\" line=\"286\"><f a=\"edited_by\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n</f></set_edited_by>\n\t<merged public=\"1\" set=\"accessor\">\n\t\t<c path=\"Array\"><x path=\"Int\"/></c>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"bigint[]\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</merged>\n\t<set_merged set=\"method\" line=\"296\"><f a=\"merged\">\n\t<c path=\"Array\"><x path=\"Int\"/></c>\n\t<c path=\"Array\"><x path=\"Int\"/></c>\n</f></set_merged>\n\t<last_locktime public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"timestamp(0) without time zone\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</last_locktime>\n\t<set_last_locktime set=\"method\" line=\"306\"><f a=\"last_locktime\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_last_locktime>\n\t<owner public=\"1\" set=\"accessor\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"bigint\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</owner>\n\t<set_owner set=\"method\" line=\"316\"><f a=\"owner\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n</f></set_owner>\n\t<new public=\"1\" set=\"method\" line=\"38\"><f a=\"data\">\n\t<t path=\"Map\">\n\t\t<c path=\"String\"/>\n\t\t<c path=\"String\"/>\n\t</t>\n\t<x path=\"Void\"/>\n</f></new>\n\t<meta>\n\t\t<m n=\":directlyUsed\"/>\n\t\t<m n=\":build\"><e>react.jsx.JsxStaticMacro.build()</e></m>\n\t\t<m n=\":rtti\"/>\n\t</meta>\n</class>";
model_Deal.__meta__ = { fields : { contact : { dataType : ["bigint"]}, creation_date : { dataType : ["timestamp(0) without time zone"]}, account : { dataType : ["bigint"]}, target_account : { dataType : ["bigint"]}, start_day : { dataType : ["character varying(2)"]}, start_date : { dataType : ["date"]}, cycle : { dataType : ["deals_cycle"]}, amount : { dataType : ["numeric(10,2)"]}, product : { dataType : ["bigint"]}, agent : { dataType : ["bigint"]}, project : { dataType : ["bigint"]}, status : { dataType : ["character varying(64)"]}, pay_method : { dataType : ["character varying(64)"]}, end_date : { dataType : ["date"]}, end_reason : { dataType : ["bigint"]}, repeat_date : { dataType : ["date"]}, edited_by : { dataType : ["bigint"]}, mandator : { dataType : ["bigint"]}, old_active : { dataType : ["boolean"]}, cycle_start_date : { dataType : ["date"]}, last_locktime : { dataType : ["timestamp(0) without time zone"]}}};
model_Deal.__rtti = "<class path=\"model.Deal\" params=\"\">\n\t<extends path=\"model.ORM\"/>\n\t<contact public=\"1\" set=\"accessor\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"bigint\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</contact>\n\t<set_contact set=\"method\" line=\"50\"><f a=\"contact\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n</f></set_contact>\n\t<creation_date public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"timestamp(0) without time zone\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</creation_date>\n\t<set_creation_date set=\"method\" line=\"60\"><f a=\"creation_date\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_creation_date>\n\t<account public=\"1\" set=\"accessor\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"bigint\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</account>\n\t<set_account set=\"method\" line=\"70\"><f a=\"account\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n</f></set_account>\n\t<target_account public=\"1\" set=\"accessor\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"bigint\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</target_account>\n\t<set_target_account set=\"method\" line=\"80\"><f a=\"target_account\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n</f></set_target_account>\n\t<start_day public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(2)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</start_day>\n\t<set_start_day set=\"method\" line=\"90\"><f a=\"start_day\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_start_day>\n\t<start_date public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"date\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</start_date>\n\t<set_start_date set=\"method\" line=\"100\"><f a=\"start_date\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_start_date>\n\t<cycle public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"deals_cycle\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</cycle>\n\t<set_cycle set=\"method\" line=\"110\"><f a=\"cycle\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_cycle>\n\t<amount public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"numeric(10,2)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</amount>\n\t<set_amount set=\"method\" line=\"120\"><f a=\"amount\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_amount>\n\t<product public=\"1\" set=\"accessor\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"bigint\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</product>\n\t<set_product set=\"method\" line=\"130\"><f a=\"product\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n</f></set_product>\n\t<agent public=\"1\" set=\"accessor\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"bigint\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</agent>\n\t<set_agent set=\"method\" line=\"140\"><f a=\"agent\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n</f></set_agent>\n\t<project public=\"1\" set=\"accessor\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"bigint\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</project>\n\t<set_project set=\"method\" line=\"150\"><f a=\"project\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n</f></set_project>\n\t<status public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(64)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</status>\n\t<set_status set=\"method\" line=\"160\"><f a=\"status\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_status>\n\t<pay_method public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"character varying(64)\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</pay_method>\n\t<set_pay_method set=\"method\" line=\"170\"><f a=\"pay_method\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_pay_method>\n\t<end_date public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"date\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</end_date>\n\t<set_end_date set=\"method\" line=\"180\"><f a=\"end_date\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_end_date>\n\t<end_reason public=\"1\" set=\"accessor\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"bigint\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</end_reason>\n\t<set_end_reason set=\"method\" line=\"190\"><f a=\"end_reason\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n</f></set_end_reason>\n\t<repeat_date public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"date\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</repeat_date>\n\t<set_repeat_date set=\"method\" line=\"200\"><f a=\"repeat_date\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_repeat_date>\n\t<edited_by public=\"1\" set=\"accessor\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"bigint\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</edited_by>\n\t<set_edited_by set=\"method\" line=\"210\"><f a=\"edited_by\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n</f></set_edited_by>\n\t<mandator public=\"1\" set=\"accessor\">\n\t\t<x path=\"Int\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"bigint\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</mandator>\n\t<set_mandator set=\"method\" line=\"220\"><f a=\"mandator\">\n\t<x path=\"Int\"/>\n\t<x path=\"Int\"/>\n</f></set_mandator>\n\t<old_active public=\"1\" set=\"accessor\">\n\t\t<x path=\"Bool\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"boolean\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</old_active>\n\t<set_old_active set=\"method\" line=\"230\"><f a=\"old_active\">\n\t<x path=\"Bool\"/>\n\t<x path=\"Bool\"/>\n</f></set_old_active>\n\t<cycle_start_date public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"date\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</cycle_start_date>\n\t<set_cycle_start_date set=\"method\" line=\"240\"><f a=\"cycle_start_date\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_cycle_start_date>\n\t<last_locktime public=\"1\" set=\"accessor\">\n\t\t<c path=\"String\"/>\n\t\t<meta>\n\t\t\t<m n=\"dataType\"><e>\"timestamp(0) without time zone\"</e></m>\n\t\t\t<m n=\":isVar\"/>\n\t\t</meta>\n\t</last_locktime>\n\t<set_last_locktime set=\"method\" line=\"250\"><f a=\"last_locktime\">\n\t<c path=\"String\"/>\n\t<c path=\"String\"/>\n</f></set_last_locktime>\n\t<new public=\"1\" set=\"method\" line=\"32\"><f a=\"data\">\n\t<t path=\"Map\">\n\t\t<c path=\"String\"/>\n\t\t<c path=\"String\"/>\n\t</t>\n\t<x path=\"Void\"/>\n</f></new>\n\t<meta>\n\t\t<m n=\":directlyUsed\"/>\n\t\t<m n=\":build\"><e>react.jsx.JsxStaticMacro.build()</e></m>\n\t\t<m n=\":rtti\"/>\n\t</meta>\n</class>";
...
model_deals_DealsModel.dataAccess = (function($this) {
	...
	var _g = new haxe_ds_StringMap();
	{
		...
		_g2.h["end_date"] = { label : "Start", type : "DatePicker", displayFormat : "d.m.Y"};
		_g2.h["repeat_date"] = { label : "Start", type : "DatePicker", displayFormat : "d.m.Y"};
		_g2.h["id"] = { type : "Hidden"};
		_g2.h["edited_by"] = { type : "Hidden"};
		_g2.h["mandator"] = { type : "Hidden"};
		_g.h["open"] = { source : _g1, view : _g2};
...
model_deals_DealsModel.listColumns = (function($this) {
	var $r;
	var _g = new haxe_ds_StringMap();
	_g.h["contact"] = { label : "Kontakt", show : true, useAsIndex : true};
...
model_imports_ReDebitModel.dataAccess = (function($this) {
	var $r;
	var _g = new haxe_ds_StringMap();
	{
		var _g1 = new haxe_ds_StringMap();
...
model_imports_ReDebitModel.listColumns = (function($this) {
	var $r;
	var _g = new haxe_ds_StringMap();
	_g.h["id"] = { label : "VertragsID", flexGrow : 0};
	_g.h["sepaCode"] = { label : "Sepa Code", flexGrow : 0};
	_g.h["iban"] = { label : "Iban"};
	_g.h["baID"] = { label : "Buchungsanforderung ID", flexGrow : 1};
	_g.h["amount"] = { label : "Betrag"};
	$r = _g;
	return $r;
}(this));
model_imports_ReDebitModel.dataDisplay = (function($this) {
	var $r;
	var _g = new haxe_ds_StringMap();
	_g.h["rDebitList"] = { columns : model_imports_ReDebitModel.listColumns};
	$r = _g;
	return $r;
}(this));
...
view_accounting_Imports.menuItems = [{ label : "Datei Rücklastschrift", action : "importReturnDebit", formField : { name : "returnDebitFile", submit : "Importieren", type : "Upload"}, handler : function(el) {
	var finput = window.document.getElementById("returnDebitFile");
	haxe_Log.trace(finput.files,{ fileName : "src/view/accounting/Imports.hx", lineNumber : 68, className : "view.accounting.Imports", methodName : "menuItems"});
	haxe_Log.trace(finput.files[0],{ fileName : "src/view/accounting/Imports.hx", lineNumber : 69, className : "view.accounting.Imports", methodName : "menuItems"});
	console.log(finput.files["returnDebitFile"]);
	haxe_Log.trace(finput.value,{ fileName : "src/view/accounting/Imports.hx", lineNumber : 71, className : "view.accounting.Imports", methodName : "menuItems"});
}}];
...
view_data_contacts_Edit.menuItems = [{ label : "Schließen", action : "close"},{ label : "Speichern + Schließen", action : "update", closeAfter : true},{ label : "Speichern", action : "update"},{ label : "Zurücksetzen", action : "reset", onlySm : true}];
...
view_data_contacts_List.menuItems = [{ label : "Bearbeiten", action : "open", section : "Edit"},{ label : "Neu", action : "insert", section : "Edit"},{ label : "Löschen", action : "delete"},{ label : "Auswahl aufheben", action : "selectionClear"}];
...
view_data_deals_Edit.menuItems = [{ label : "Schließen", action : "close"},{ label : "Speichern + Schließen", action : "update", closeAfter : true},{ label : "Speichern", action : "update"},{ label : "Zurücksetzen", action : "reset", onlySm : true}];
...
view_shared_Menu._renderWrapper = (redux_react_ReactRedux.connect(view_shared_Menu.mapStateToProps,view_shared_Menu.mapDispatchToProps))(react_ReactTypeOf.fromComp(view_shared_Menu));
