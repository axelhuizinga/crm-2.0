 ...
 * Haxe source file: /usr/share/haxe/std/php/_std/haxe/ds/ObjectMap.hx
 */
...
class ObjectMap implements IMap {
	...
	public function set ($key, $value) {
		#/usr/share/haxe/std/php/_std/haxe/ds/ObjectMap.hx:38: characters 3-40
		$id = spl_object_hash($key);
		#/usr/share/haxe/std/php/_std/haxe/ds/ObjectMap.hx:39: characters 3-18
		$this->_keys[$id] = $key;
		#/usr/share/haxe/std/php/_std/haxe/ds/ObjectMap.hx:40: characters 3-22
	...
	public function toString () {
		#/usr/share/haxe/std/php/_std/haxe/ds/ObjectMap.hx:81: characters 3-15
		$s = "{";
		#/usr/share/haxe/std/php/_std/haxe/ds/ObjectMap.hx:82: characters 3-19
		$it = new NativeIndexedArrayIterator(array_values($this->_keys));
		#/usr/share/haxe/std/php/_std/haxe/ds/ObjectMap.hx:83: characters 13-15
		$i = $it;
		while ($i->hasNext()) {
			#/usr/share/haxe/std/php/_std/haxe/ds/ObjectMap.hx:83: lines 83-89
			$i1 = $i->next();
			#/usr/share/haxe/std/php/_std/haxe/ds/ObjectMap.hx:84: characters 4-22
			$s = ($s??'null') . (\Std::string($i1)??'null');
			#/usr/share/haxe/std/php/_std/haxe/ds/ObjectMap.hx:85: characters 4-15
			$s = ($s??'null') . " => ";
			#/usr/share/haxe/std/php/_std/haxe/ds/ObjectMap.hx:86: characters 4-27
			$s = ($s??'null') . (\Std::string($this->get($i1))??'null');
			#/usr/share/haxe/std/php/_std/haxe/ds/ObjectMap.hx:87: lines 87-88
			if ($it->hasNext()) {
				#/usr/share/haxe/std/php/_std/haxe/ds/ObjectMap.hx:88: characters 5-14
				$s = ($s??'null') . ", ";
			}
		}
		#/usr/share/haxe/std/php/_std/haxe/ds/ObjectMap.hx:90: characters 3-17
		return ($s??'null') . "}";
	}
