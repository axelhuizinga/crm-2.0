...
class HxDynamicStr extends HxClosure {
	...
	public static function invoke ($str, $method, $args) {
		#/usr/share/haxe/std/php/Boot.hx:884: characters 3-34
		array_unshift($args, $str);
		#/usr/share/haxe/std/php/Boot.hx:885: characters 3-69
	...
	public static function wrap ($value) {
		#/usr/share/haxe/std/php/Boot.hx:876: lines 876-880
		if (is_string($value)) {
			#/usr/share/haxe/std/php/Boot.hx:877: characters 4-34
			return new HxDynamicStr($value);
		} else {
			#/usr/share/haxe/std/php/Boot.hx:879: characters 4-16
			return $value;
		}
	}
	...
	public function __construct ($str) {
		#/usr/share/haxe/std/php/Boot.hx:889: characters 3-19
	...
	public function __call ($method, $args) {
		#/usr/share/haxe/std/php/Boot.hx:905: characters 10-38
	...
	public function __get ($field) {
		#/usr/share/haxe/std/php/Boot.hx:894: lines 894-900
		if ($field === "length") {
			#/usr/share/haxe/std/php/Boot.hx:896: characters 5-36
			return mb_strlen($this->target);
		} else {
			#/usr/share/haxe/std/php/Boot.hx:898: characters 5-17
			$this->func = $field;
			#/usr/share/haxe/std/php/Boot.hx:899: characters 5-16
			return $this;
		}
	}
	...
	public function __invoke () {
		#/usr/share/haxe/std/php/Boot.hx:913: characters 10-54
		$str = $this->target;
		$method = $this->func;
		$args = func_get_args();
		array_unshift($args, $str);
	...
	public function callWith ($newThis, $args) {
		#/usr/share/haxe/std/php/Boot.hx:930: lines 930-932
		if ($newThis === null) {
			#/usr/share/haxe/std/php/Boot.hx:931: characters 4-20
			$newThis = $this->target;
		}
		#/usr/share/haxe/std/php/Boot.hx:933: characters 10-37
		$method = $this->func;
	...
	public function getCallback ($eThis = null) {
		#/usr/share/haxe/std/php/Boot.hx:920: lines 920-922
		if ($eThis === null) {
			#/usr/share/haxe/std/php/Boot.hx:921: characters 4-51
			return [$this, $this->func];
		}
		#/usr/share/haxe/std/php/Boot.hx:923: characters 3-69
