 ...
 * Haxe source file: /usr/share/haxe/std/haxe/http/HttpBase.hx
 */
...
class HttpBase {
	...
	public function setParameter ($name, $value) {
		#/usr/share/haxe/std/haxe/http/HttpBase.hx:113: characters 13-17
		$_g = 0;
		#/usr/share/haxe/std/haxe/http/HttpBase.hx:113: characters 17-30
		$_g1 = $this->params->length;
		#/usr/share/haxe/std/haxe/http/HttpBase.hx:113: lines 113-118
		while ($_g < $_g1) {
			#/usr/share/haxe/std/haxe/http/HttpBase.hx:113: characters 13-30
			$i = $_g++;
			#/usr/share/haxe/std/haxe/http/HttpBase.hx:114: lines 114-117
			if (($this->params->arr[$i] ?? null)->name === $name) {
				#/usr/share/haxe/std/haxe/http/HttpBase.hx:115: characters 5-43
				$this->params->offsetSet($i, new HxAnon([
					"name" => $name,
					"value" => $value,
				]));
				#/usr/share/haxe/std/haxe/http/HttpBase.hx:116: characters 5-11
				return;
			}
		}
		#/usr/share/haxe/std/haxe/http/HttpBase.hx:119: characters 3-42
		$_this = $this->params;
