...
class LiveData {
	...
	public static function loadORM(param:DBAccessProps, viewPath:String,?sType:SelectType = SelectType.One) {
	...
	public static function loadData(id:Int, param:DBAccessProps):Void
	{
		trace('loading:$id');
		if(id == null)
			return;
