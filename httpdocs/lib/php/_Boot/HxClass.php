...
class HxClass {
	...
	public function __construct ($phpClassName) {
		#/usr/share/haxe/std/php/Boot.hx:659: characters 3-35
	...
	public function __call ($method, $args) {
		#/usr/share/haxe/std/php/Boot.hx:667: characters 3-111
		$callback = ((($this->phpClassName === "String" ? HxString::class : $this->phpClassName))??'null') . "::" . ($method??'null');
		#/usr/share/haxe/std/php/Boot.hx:668: characters 3-53
	...
	public function __get ($property) {
		#/usr/share/haxe/std/php/Boot.hx:676: lines 676-684
		if (defined("" . ($this->phpClassName??'null') . "::" . ($property??'null'))) {
			#/usr/share/haxe/std/php/Boot.hx:677: characters 4-54
			return constant("" . ($this->phpClassName??'null') . "::" . ($property??'null'));
		} else if (Boot::hasGetter($this->phpClassName, $property)) {
			#/usr/share/haxe/std/php/Boot.hx:679: characters 29-41
			$tmp = $this->phpClassName;
			#/usr/share/haxe/std/php/Boot.hx:679: characters 4-59
			return $tmp::{"get_" . ($property??'null')}();
		} else if (method_exists($this->phpClassName, $property)) {
			#/usr/share/haxe/std/php/Boot.hx:681: characters 4-56
			return Boot::getStaticClosure($this->phpClassName, $property);
		} else {
			#/usr/share/haxe/std/php/Boot.hx:683: characters 33-45
			$tmp = $this->phpClassName;
			#/usr/share/haxe/std/php/Boot.hx:683: characters 4-56
			return $tmp::${$property};
		}
	}
	...
	public function __set ($property, $value) {
		#/usr/share/haxe/std/php/Boot.hx:692: lines 692-696
		if (Boot::hasSetter($this->phpClassName, $property)) {
			#/usr/share/haxe/std/php/Boot.hx:693: characters 22-34
			$tmp = $this->phpClassName;
			#/usr/share/haxe/std/php/Boot.hx:693: characters 4-59
			$tmp::{"set_" . ($property??'null')}($value);
		} else {
			#/usr/share/haxe/std/php/Boot.hx:695: characters 26-38
			$tmp = $this->phpClassName;
			#/usr/share/haxe/std/php/Boot.hx:695: characters 4-56
			$tmp::${$property} = $value;
		}
	}
}
