 ...
 * Haxe source file: /usr/share/haxe/std/php/_std/EReg.hx
 */
...
final class EReg {
	...
	public function matchedPos () {
		#/usr/share/haxe/std/php/_std/EReg.hx:107: characters 9-64
		$tmp = mb_strlen(substr($this->last, 0, $this->matches[0][1]));
		#/usr/share/haxe/std/php/_std/EReg.hx:106: lines 106-109
		return new HxAnon([
			"pos" => $tmp,
	...
	public function matchedRight () {
		#/usr/share/haxe/std/php/_std/EReg.hx:99: lines 99-100
		if (count($this->matches) === 0) {
			#/usr/share/haxe/std/php/_std/EReg.hx:100: characters 4-9
			throw HaxeException::thrown("No string matched");
		}
		#/usr/share/haxe/std/php/_std/EReg.hx:101: characters 3-68
		$x = $this->matches[0][1] + strlen($this->matches[0][0]);
		#/usr/share/haxe/std/php/_std/EReg.hx:102: characters 3-32
