 ...
 * Haxe source file: /usr/share/haxe/std/php/_std/Date.hx
 */
...
final class Date {
	...
	public static function fromPhpTime ($t) {
		#/usr/share/haxe/std/php/_std/Date.hx:112: characters 3-41
		$d = new Date(2000, 1, 1, 0, 0, 0);
		#/usr/share/haxe/std/php/_std/Date.hx:113: characters 3-12
		$d->__t = $t;
		#/usr/share/haxe/std/php/_std/Date.hx:114: characters 3-11
		return $d;
	}
	...
	public static function fromString ($s) {
		#/usr/share/haxe/std/php/_std/Date.hx:124: characters 11-19
		$__hx__switch = (mb_strlen($s));
		if ($__hx__switch === 8) {
			#/usr/share/haxe/std/php/_std/Date.hx:126: characters 5-26
			$k = HxString::split($s, ":");
			#/usr/share/haxe/std/php/_std/Date.hx:127: characters 5-115
			...
			#/usr/share/haxe/std/php/_std/Date.hx:129: characters 5-26
			$k = HxString::split($s, "-");
			#/usr/share/haxe/std/php/_std/Date.hx:130: characters 21-39
			$tmp = \Std::parseInt(($k->arr[0] ?? null));
			#/usr/share/haxe/std/php/_std/Date.hx:130: characters 41-63
			$tmp1 = \Std::parseInt(($k->arr[1] ?? null)) - 1;
			#/usr/share/haxe/std/php/_std/Date.hx:130: characters 5-93
			return new Date($tmp, $tmp1, \Std::parseInt(($k->arr[2] ?? null)), 0, 0, 0);
		} else if ($__hx__switch === 19) {
			#/usr/share/haxe/std/php/_std/Date.hx:132: characters 5-26
			$k = HxString::split($s, " ");
			#/usr/share/haxe/std/php/_std/Date.hx:133: characters 5-29
			$y = HxString::split(($k->arr[0] ?? null), "-");
			#/usr/share/haxe/std/php/_std/Date.hx:134: characters 5-29
			$t = HxString::split(($k->arr[1] ?? null), ":");
			#/usr/share/haxe/std/php/_std/Date.hx:135: characters 21-39
			$tmp = \Std::parseInt(($y->arr[0] ?? null));
			#/usr/share/haxe/std/php/_std/Date.hx:135: characters 41-63
			$tmp1 = \Std::parseInt(($y->arr[1] ?? null)) - 1;
			#/usr/share/haxe/std/php/_std/Date.hx:135: characters 65-83
			$tmp2 = \Std::parseInt(($y->arr[2] ?? null));
			#/usr/share/haxe/std/php/_std/Date.hx:135: characters 85-103
			$tmp3 = \Std::parseInt(($t->arr[0] ?? null));
			#/usr/share/haxe/std/php/_std/Date.hx:135: characters 105-123
			$tmp4 = \Std::parseInt(($t->arr[1] ?? null));
			#/usr/share/haxe/std/php/_std/Date.hx:135: characters 5-144
			return new Date($tmp, $tmp1, $tmp2, $tmp3, $tmp4, \Std::parseInt(($t->arr[2] ?? null)));
		} else {
			#/usr/share/haxe/std/php/_std/Date.hx:137: characters 5-10
	...
	public static function now () {
		#/usr/share/haxe/std/php/_std/Date.hx:108: characters 3-48
