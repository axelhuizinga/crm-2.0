...
var ReactHooksExample = function() { };
$hxClasses["ReactHooksExample"] = ReactHooksExample;
ReactHooksExample.__name__ = "ReactHooksExample";
ReactHooksExample.main = function() {
	var body = window.document.querySelector("main");
...
ReactHooksExample.TestHooks = function(props) {
	var text = React.useState(props.defaultText);
	var num = React.useState(222);
	var renderCountRef = React.useRef(1);
	...
	var tmp1 = React.createElement(react_ReactType.fromString("h3"),{ },"Haxe, React, Functional components, ReactHooks");
	var tmp2 = react_ReactType.fromString("div");
	var tmp3 = react_ReactType.fromString("input");
	var inputRef1 = inputRef;
	var tmp4 = react_HookState.get_value(text);
	var tmp5 = React.createElement(tmp2,{ },"text: ",React.createElement(tmp3,{ key : "input", ref : inputRef1, value : tmp4, onChange : function(e) {
		return react_HookState.set_value(text,e.target.value);
	}}),"\t");
	var tmp2 = react_ReactType.fromString("div");
	var tmp3 = React.createElement(react_ReactType.fromString("button"),{ onClick : function(e) {
		return react_HookState.set_value(num,react_HookState.get_value(num) + 1);
	}},"Inc num");
	var tmp4 = React.createElement(react_ReactType.fromString("button"),{ onClick : function(e) {
		return react_HookState.set_value(num,react_HookState.get_value(num) - 1);
	}},"Dec num");
	var tmp6 = react_ReactType.fromString("span");
	var tmp7 = React.createElement(tmp2,{ },tmp3,tmp4,React.createElement(tmp6,{ },"num: ",react_HookState.get_value(num)));
	var tmp2 = React.createElement(react_ReactType.fromString("p"),{ },"Render count: ",renderCountRef.current," ");
	return React.createElement(tmp,{ },tmp1,tmp5,tmp7,tmp2,React.createElement(react_ReactType.fromString("button"),{ onClick : function(e) {
...
react_HookState.get_value = function(this1) {
	return this1[0];
};
react_HookState.set_value = function(this1,param) {
	this1[0] = param;
	this1[1](param);
	return param;
};
...
var react_HookReduce = {};
react_HookReduce.__properties__ = {get_value:"get_value"};
react_HookReduce.get_value = function(this1) {
	return this1[0];
};
react_HookReduce.dispatch = function(this1,action) {
