...
class TJSON {
	...
	public static function encode ($obj, $style = null, $useCache = true) {
		#/opt/src/crm-2.0/server/.haxelib/tjson/1,4,0/tjson/TJSON.hx:22: lines 22-25
		if ($useCache === null) {
			$useCache = true;
		}
		#/opt/src/crm-2.0/server/.haxelib/tjson/1,4,0/tjson/TJSON.hx:23: characters 3-38
		$t = new TJSONEncoder($useCache);
		#/opt/src/crm-2.0/server/.haxelib/tjson/1,4,0/tjson/TJSON.hx:24: characters 3-31
	...
	public static function parse ($json, $fileName = "JSON Data", $stringProcessor = null) {
		#/opt/src/crm-2.0/server/.haxelib/tjson/1,4,0/tjson/TJSON.hx:12: lines 12-15
		if ($fileName === null) {
			$fileName = "JSON Data";
		}
		#/opt/src/crm-2.0/server/.haxelib/tjson/1,4,0/tjson/TJSON.hx:13: characters 9-66
		$t = new TJSONParser($json, $fileName, $stringProcessor);
		#/opt/src/crm-2.0/server/.haxelib/tjson/1,4,0/tjson/TJSON.hx:14: characters 3-21
		return $t->doParse();
	}
}
