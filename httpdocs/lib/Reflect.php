 ...
 * Haxe source file: /usr/share/haxe/std/php/_std/Reflect.hx
 */
...
class Reflect {
	...
	public static function callMethod ($o, $func, $args) {
		#/usr/share/haxe/std/php/_std/Reflect.hx:113: characters 3-69
	...
	public static function hasField ($o, $field) {
		#/usr/share/haxe/std/php/_std/Reflect.hx:34: lines 34-35
		if (!is_object($o)) {
			#/usr/share/haxe/std/php/_std/Reflect.hx:35: characters 4-16
			return false;
		}
		#/usr/share/haxe/std/php/_std/Reflect.hx:36: lines 36-37
		if (property_exists($o, $field)) {
			#/usr/share/haxe/std/php/_std/Reflect.hx:37: characters 4-15
			return true;
		}
		#/usr/share/haxe/std/php/_std/Reflect.hx:39: lines 39-44
		if (($o instanceof HxClass)) {
			#/usr/share/haxe/std/php/_std/Reflect.hx:40: characters 4-54
			$phpClassName = $o->phpClassName;
			#/usr/share/haxe/std/php/_std/Reflect.hx:41: lines 41-43
			if (!(property_exists($phpClassName, $field) || method_exists($phpClassName, $field))) {
				#/usr/share/haxe/std/php/_std/Reflect.hx:43: characters 8-47
		...
		#/usr/share/haxe/std/php/_std/Reflect.hx:46: characters 3-15
		return false;
	}
	...
	public static function isObject ($v) {
		#/usr/share/haxe/std/php/_std/Reflect.hx:146: lines 146-150
		if (($v instanceof HxEnum)) {
			#/usr/share/haxe/std/php/_std/Reflect.hx:147: characters 4-16
			return false;
		} else if (!is_object($v)) {
			#/usr/share/haxe/std/php/_std/Reflect.hx:149: characters 28-41
			return is_string($v);
		} else {
			#/usr/share/haxe/std/php/_std/Reflect.hx:149: characters 11-41
			return true;
		}
	}
