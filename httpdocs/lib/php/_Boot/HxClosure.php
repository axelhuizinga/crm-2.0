...
class HxClosure {
	...
	public function __construct ($target, $func) {
		#/usr/share/haxe/std/php/Boot.hx:977: characters 3-23
		$this->target = $target;
		#/usr/share/haxe/std/php/Boot.hx:978: characters 3-19
		$this->func = $func;
		#/usr/share/haxe/std/php/Boot.hx:980: lines 980-982
		if (is_null($target)) {
			#/usr/share/haxe/std/php/Boot.hx:981: characters 4-9
			throw Exception::thrown("Unable to create closure on `null`");
		}
		#/usr/share/haxe/std/php/Boot.hx:983: characters 3-104
	...
	public function __invoke () {
		#/usr/share/haxe/std/php/Boot.hx:991: characters 3-71
	...
	public function callWith ($newThis, $args) {
		#/usr/share/haxe/std/php/Boot.hx:1018: characters 3-65
	...
	public function equals ($closure) {
		#/usr/share/haxe/std/php/Boot.hx:1011: characters 10-60
		if (Boot::equal($this->target, $closure->target)) {
			#/usr/share/haxe/std/php/Boot.hx:1011: characters 39-59
	...
	public function getCallback ($eThis = null) {
		#/usr/share/haxe/std/php/Boot.hx:998: lines 998-1000
		if ($eThis === null) {
			#/usr/share/haxe/std/php/Boot.hx:999: characters 4-18
			$eThis = $this->target;
		}
		#/usr/share/haxe/std/php/Boot.hx:1001: lines 1001-1003
		if (($eThis instanceof HxAnon)) {
			#/usr/share/haxe/std/php/Boot.hx:1002: characters 4-36
			return $eThis->{$this->func};
		}
		#/usr/share/haxe/std/php/Boot.hx:1004: characters 3-39
		return [$eThis, $this->func];
	}
}
